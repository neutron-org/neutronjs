...
export const createRPCQueryClient = async ({ rpcEndpoint }: { rpcEndpoint: string | HttpEndpoint }) => {
  ...
  return {
    ...
    sdk: {
      auction: {
        v1: (await import("./auction/v1/query.rpc.Query.js")).createRpcQueryExtension(client),
      },
      mempool: {
        v1: (await import("./mempool/v1/query.rpc.Service.js")).createRpcQueryExtension(client),
      },
    },
  };
};

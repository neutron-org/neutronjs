    ...
    ibc: {
      ...
      core: {
        channel: {
          ...
          v2: (await import("./core/channel/v2/query.rpc.Query.js")).createRpcQueryExtension(client),
        },
        client: {
          v1: (await import("./core/client/v1/query.rpc.Query.js")).createRpcQueryExtension(client),
          v2: (await import("./core/client/v2/query.rpc.Query.js")).createRpcQueryExtension(client),
        },
        connection: {

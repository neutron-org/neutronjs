  ...
  ibc: {
    applications: {
      interchain_accounts: {
        ...
        host: {
          v1: new (await import("./applications/interchain_accounts/host/v1/tx.rpc.msg.js")).MsgClientImpl(
            rpc,
          ),
        },
      },
    ...
    core: {
      channel: {
        ...
        v2: new (await import("./core/channel/v2/tx.rpc.msg.js")).MsgClientImpl(rpc),
      },
      client: {
        v1: new (await import("./core/client/v1/tx.rpc.msg.js")).MsgClientImpl(rpc),
        v2: new (await import("./core/client/v2/tx.rpc.msg.js")).MsgClientImpl(rpc),
      },
      connection: {

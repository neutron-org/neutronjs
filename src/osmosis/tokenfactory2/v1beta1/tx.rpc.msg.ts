...
export class MsgClientImpl implements Msg {
  ...
  createDenom(request: MsgCreateDenom): Promise<MsgCreateDenomResponse> {
    ...
    const promise = this.rpc.request("osmosis.tokenfactory2.v1beta1.Msg", "CreateDenom", data);
    return promise.then((data) => MsgCreateDenomResponse.decode(new BinaryReader(data)));
  }
  mint(request: MsgMint): Promise<MsgMintResponse> {
    const data = MsgMint.encode(request).finish();
    const promise = this.rpc.request("osmosis.tokenfactory2.v1beta1.Msg", "Mint", data);
    return promise.then((data) => MsgMintResponse.decode(new BinaryReader(data)));
  }
  burn(request: MsgBurn): Promise<MsgBurnResponse> {
    const data = MsgBurn.encode(request).finish();
    const promise = this.rpc.request("osmosis.tokenfactory2.v1beta1.Msg", "Burn", data);
    return promise.then((data) => MsgBurnResponse.decode(new BinaryReader(data)));
  }
  changeAdmin(request: MsgChangeAdmin): Promise<MsgChangeAdminResponse> {
    const data = MsgChangeAdmin.encode(request).finish();
    const promise = this.rpc.request("osmosis.tokenfactory2.v1beta1.Msg", "ChangeAdmin", data);
  ...
  setDenomMetadata(request: MsgSetDenomMetadata): Promise<MsgSetDenomMetadataResponse> {
    ...
    const promise = this.rpc.request("osmosis.tokenfactory2.v1beta1.Msg", "SetDenomMetadata", data);
  ...
  setBeforeSendHook(request: MsgSetBeforeSendHook): Promise<MsgSetBeforeSendHookResponse> {
    ...
    const promise = this.rpc.request("osmosis.tokenfactory2.v1beta1.Msg", "SetBeforeSendHook", data);
  ...
  forceTransfer(request: MsgForceTransfer): Promise<MsgForceTransferResponse> {
    ...
    const promise = this.rpc.request("osmosis.tokenfactory2.v1beta1.Msg", "ForceTransfer", data);
    return promise.then((data) => MsgForceTransferResponse.decode(new BinaryReader(data)));
  }
  updateParams(request: MsgUpdateParams): Promise<MsgUpdateParamsResponse> {
    const data = MsgUpdateParams.encode(request).finish();
    const promise = this.rpc.request("osmosis.tokenfactory2.v1beta1.Msg", "UpdateParams", data);

 ...
 * @see proto service: neutron.coinfactory.v1beta1.Params
 */
export const getParams = buildQuery<QueryParamsRequest, QueryParamsResponse>({
  encode: QueryParamsRequest.encode,
  decode: QueryParamsResponse.decode,
  service: "neutron.coinfactory.v1beta1.Query",
  method: "Params",
});
/**
 ...
 * @package neutron.coinfactory.v1beta1
 * @see proto service: neutron.coinfactory.v1beta1.DenomAuthorityMetadata
 */
 ...
 * @package neutron.coinfactory.v1beta1
 * @see proto service: neutron.coinfactory.v1beta1.DenomsFromCreator
 */
 ...
 * @package neutron.coinfactory.v1beta1
 * @see proto service: neutron.coinfactory.v1beta1.BeforeSendHookAddress
 */
 ...
 * @name getFullDenom
 * @package neutron.coinfactory.v1beta1
 * @see proto service: neutron.coinfactory.v1beta1.FullDenom
 */

...
export class QueryClientImpl implements Query {
  ...
  params(request: QueryParamsRequest = {}): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("neutron.coinfactory.v1beta1.Query", "Params", data);
  ...
  denomAuthorityMetadata(
    ...
    const promise = this.rpc.request("neutron.coinfactory.v1beta1.Query", "DenomAuthorityMetadata", data);
  ...
  denomsFromCreator(request: QueryDenomsFromCreatorRequest): Promise<QueryDenomsFromCreatorResponse> {
    ...
    const promise = this.rpc.request("neutron.coinfactory.v1beta1.Query", "DenomsFromCreator", data);
  ...
  beforeSendHookAddress(
    ...
    const promise = this.rpc.request("neutron.coinfactory.v1beta1.Query", "BeforeSendHookAddress", data);
  ...
  fullDenom(request: QueryFullDenomRequest): Promise<QueryFullDenomResponse> {
    ...
    const promise = this.rpc.request("neutron.coinfactory.v1beta1.Query", "FullDenom", data);

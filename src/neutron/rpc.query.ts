...
export const createRPCQueryClient = async ({ rpcEndpoint }: { rpcEndpoint: string | HttpEndpoint }) => {
  ...
  return {
    cosmos: {
      ...
      base: {
        node: {
          v1beta1: (await import("../cosmos/base/node/v1beta1/query.rpc.Service.js")).createRpcQueryExtension(
            client,
          ),
        },
        tendermint: {
          v1beta1: (
            await import("../cosmos/base/tendermint/v1beta1/query.rpc.Service.js")
      ...
      distribution: {
        v1beta1: (await import("../cosmos/distribution/v1beta1/query.rpc.Query.js")).createRpcQueryExtension(
          client,
        ),
      },
      epochs: {
        v1beta1: (await import("../cosmos/epochs/v1beta1/query.rpc.Query.js")).createRpcQueryExtension(
          client,
        ),
      },
      evidence: {
        v1beta1: (await import("../cosmos/evidence/v1beta1/query.rpc.Query.js")).createRpcQueryExtension(
          client,
        ),
      },
      feegrant: {
        v1beta1: (await import("../cosmos/feegrant/v1beta1/query.rpc.Query.js")).createRpcQueryExtension(
          client,
        ),
      },
      gov: {
      ...
      params: {
        v1beta1: (await import("../cosmos/params/v1beta1/query.rpc.Query.js")).createRpcQueryExtension(
          client,
        ),
      },
      protocolpool: {
      ...
      slashing: {
        v1beta1: (await import("../cosmos/slashing/v1beta1/query.rpc.Query.js")).createRpcQueryExtension(
          client,
        ),
      },
      staking: {
        v1beta1: (await import("../cosmos/staking/v1beta1/query.rpc.Query.js")).createRpcQueryExtension(
          client,
        ),
      },
      tx: {
        v1beta1: (await import("../cosmos/tx/v1beta1/service.rpc.Service.js")).createRpcQueryExtension(
          client,
        ),
      },
      upgrade: {
        v1beta1: (await import("../cosmos/upgrade/v1beta1/query.rpc.Query.js")).createRpcQueryExtension(
          client,
        ),
      },
    },
    neutron: {
      coinfactory: {
        v1beta1: (await import("./coinfactory/v1beta1/query.rpc.Query.js")).createRpcQueryExtension(client),
      },
      contractmanager: (await import("./contractmanager/query.rpc.Query.js")).createRpcQueryExtension(client),
      cron: (await import("./cron/query.rpc.Query.js")).createRpcQueryExtension(client),
      dex: (await import("./dex/query.rpc.Query.js")).createRpcQueryExtension(client),
      dynamicfees: {
      ...
      interchainqueries: (await import("./interchainqueries/query.rpc.Query.js")).createRpcQueryExtension(
        client,
      ),
      interchaintxs: {

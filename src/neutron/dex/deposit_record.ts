...
export const DepositRecord = {
  ...
  toAmino(message: DepositRecord): DepositRecordAmino {
    ...
    obj.center_tick_index =
      message.centerTickIndex !== BigInt(0) ? message.centerTickIndex?.toString() : undefined;
    obj.lower_tick_index =
      message.lowerTickIndex !== BigInt(0) ? message.lowerTickIndex?.toString() : undefined;
    obj.upper_tick_index =
      message.upperTickIndex !== BigInt(0) ? message.upperTickIndex?.toString() : undefined;

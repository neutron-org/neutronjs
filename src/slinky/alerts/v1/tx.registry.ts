...
export const registry: ReadonlyArray<[string, GeneratedType]> = [
  ["/slinky.alerts.v1.MsgAlert", MsgAlert],
  ["/slinky.alerts.v1.MsgConclusion", MsgConclusion],
  ["/slinky.alerts.v1.MsgUpdateParams", MsgUpdateParams],
];
...
export const MessageComposer = {
  ...
  toJSON: {
    alert(value: MsgAlert) {
      return {
        typeUrl: "/slinky.alerts.v1.MsgAlert",
        value: MsgAlert.toJSON(value),
      };
    },
    conclusion(value: MsgConclusion) {
      return {
        typeUrl: "/slinky.alerts.v1.MsgConclusion",
        value: MsgConclusion.toJSON(value),
      };
    },
    updateParams(value: MsgUpdateParams) {
      return {
  ...
  fromJSON: {
    alert(value: any) {
      return {
        typeUrl: "/slinky.alerts.v1.MsgAlert",
        value: MsgAlert.fromJSON(value),
      };
    },
    conclusion(value: any) {
      return {
        typeUrl: "/slinky.alerts.v1.MsgConclusion",
        value: MsgConclusion.fromJSON(value),
      };
    },

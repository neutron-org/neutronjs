...
export const QuotePrice = {
  typeUrl: "/connect.oracle.v2.QuotePrice",
...
export const CurrencyPairState = {
  typeUrl: "/connect.oracle.v2.CurrencyPairState",
...
export const CurrencyPairGenesis = {
  typeUrl: "/connect.oracle.v2.CurrencyPairGenesis",
...
export const GenesisState = {
  typeUrl: "/connect.oracle.v2.GenesisState",

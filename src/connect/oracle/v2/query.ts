...
export const protobufPackage = "connect.oracle.v2";
...
export const GetAllCurrencyPairsRequest = {
  typeUrl: "/connect.oracle.v2.GetAllCurrencyPairsRequest",
...
export const GetPriceRequest = {
  typeUrl: "/connect.oracle.v2.GetPriceRequest",
  ...
  fromJSON(object: any): GetPriceRequest {
    ...
    if (isSet(object.currencyPair)) obj.currencyPair = String(object.currencyPair);
    return obj;
  },
...
export const GetPricesRequest = {
  typeUrl: "/connect.oracle.v2.GetPricesRequest",
...
export const GetPricesResponse = {
  typeUrl: "/connect.oracle.v2.GetPricesResponse",
...
export const GetCurrencyPairMappingResponse = {
  typeUrl: "/connect.oracle.v2.GetCurrencyPairMappingResponse",
  encode(

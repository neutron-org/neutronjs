...
export const Market = {
  typeUrl: "/connect.marketmap.v2.Market",
...
export const Ticker = {
  typeUrl: "/connect.marketmap.v2.Ticker",
...
export const ProviderConfig = {
  typeUrl: "/connect.marketmap.v2.ProviderConfig",
...
export const MarketMap = {
  typeUrl: "/connect.marketmap.v2.MarketMap",

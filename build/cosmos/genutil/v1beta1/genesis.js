...
exports.GenesisState = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.genTxs))
            obj.genTxs = object.genTxs.map((e) => (0, helpers_js_1.bytesFromBase64)(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
        if (message.genTxs) {
            obj.genTxs = message.genTxs.map((e) => (0, helpers_js_1.base64FromBytes)(e !== undefined ? e : new Uint8Array()));
        }
        else {
            obj.genTxs = [];
        }

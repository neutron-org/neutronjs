...
exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = exports.MsgVerifyInvariantResponse = exports.MsgVerifyInvariant = exports.protobufPackage = void 0;
//@ts-nocheck
/* eslint-disable */
...
exports.MsgVerifyInvariant = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.invariantModuleName))
            obj.invariantModuleName = String(object.invariantModuleName);
        if ((0, helpers_js_1.isSet)(object.invariantRoute))
...
function createBaseMsgUpdateParams() {
    return {
        authority: "",
        constantFee: coin_js_1.Coin.fromPartial({}),
    };
}
exports.MsgUpdateParams = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.constantFee !== undefined) {
            coin_js_1.Coin.encode(message.constantFee, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.constantFee))
            obj.constantFee = coin_js_1.Coin.fromJSON(object.constantFee);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.constantFee !== undefined &&
            (obj.constantFee = message.constantFee ? coin_js_1.Coin.toJSON(message.constantFee) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseMsgUpdateParams();
        ...
        if (object.constantFee !== undefined && object.constantFee !== null) {
            message.constantFee = coin_js_1.Coin.fromPartial(object.constantFee);
        }
        return message;
    },
};

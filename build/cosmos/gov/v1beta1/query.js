...
function createBaseQueryProposalResponse() {
    return {
        proposal: gov_js_1.Proposal.fromPartial({}),
    };
}
...
function createBaseQueryVoteResponse() {
    return {
        vote: gov_js_1.Vote.fromPartial({}),
    };
}
...
function createBaseQueryParamsResponse() {
    return {
        votingParams: gov_js_1.VotingParams.fromPartial({}),
        depositParams: gov_js_1.DepositParams.fromPartial({}),
        tallyParams: gov_js_1.TallyParams.fromPartial({}),
    };
}
...
function createBaseQueryDepositResponse() {
    return {
        deposit: gov_js_1.Deposit.fromPartial({}),
    };
}
...
function createBaseQueryTallyResultResponse() {
    return {
        tally: gov_js_1.TallyResult.fromPartial({}),
    };
}

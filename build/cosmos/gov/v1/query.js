...
exports.QueryConstitutionResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.constitution))
...
exports.QueryProposalResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.proposal))
            obj.proposal = gov_js_1.Proposal.fromJSON(object.proposal);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.proposal !== undefined &&
            (obj.proposal = message.proposal ? gov_js_1.Proposal.toJSON(message.proposal) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseQueryProposalResponse();
        if (object.proposal !== undefined && object.proposal !== null) {
            message.proposal = gov_js_1.Proposal.fromPartial(object.proposal);
        }
        return message;
    },
};
...
exports.QueryProposalsRequest = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.proposalStatus))
            obj.proposalStatus = (0, gov_js_1.proposalStatusFromJSON)(object.proposalStatus);
    ...
    toJSON(message) {
        ...
        message.proposalStatus !== undefined &&
            (obj.proposalStatus = (0, gov_js_1.proposalStatusToJSON)(message.proposalStatus));
...
exports.QueryVoteResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.vote))
            obj.vote = gov_js_1.Vote.fromJSON(object.vote);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.vote !== undefined && (obj.vote = message.vote ? gov_js_1.Vote.toJSON(message.vote) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseQueryVoteResponse();
        if (object.vote !== undefined && object.vote !== null) {
            message.vote = gov_js_1.Vote.fromPartial(object.vote);
        }
        return message;
    },
};
...
exports.QueryVotesResponse = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.votes))
            obj.votes = object.votes.map((e) => gov_js_1.Vote.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.pagination))
            obj.pagination = pagination_js_1.PageResponse.fromJSON(object.pagination);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        if (message.votes) {
            obj.votes = message.votes.map((e) => (e ? gov_js_1.Vote.toJSON(e) : undefined));
        }
        else {
            obj.votes = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseQueryVotesResponse();
        message.votes = object.votes?.map((e) => gov_js_1.Vote.fromPartial(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_js_1.PageResponse.fromPartial(object.pagination);
        }
        return message;
...
exports.QueryParamsRequest = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.paramsType))
...
exports.QueryParamsResponse = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.params !== undefined) {
            gov_js_1.Params.encode(message.params, writer.uint32(34).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.params = gov_js_1.Params.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.votingParams))
            obj.votingParams = gov_js_1.VotingParams.fromJSON(object.votingParams);
        if ((0, helpers_js_1.isSet)(object.depositParams))
            obj.depositParams = gov_js_1.DepositParams.fromJSON(object.depositParams);
        if ((0, helpers_js_1.isSet)(object.tallyParams))
            obj.tallyParams = gov_js_1.TallyParams.fromJSON(object.tallyParams);
        if ((0, helpers_js_1.isSet)(object.params))
            obj.params = gov_js_1.Params.fromJSON(object.params);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.votingParams !== undefined &&
            (obj.votingParams = message.votingParams ? gov_js_1.VotingParams.toJSON(message.votingParams) : undefined);
        message.depositParams !== undefined &&
            (obj.depositParams = message.depositParams ? gov_js_1.DepositParams.toJSON(message.depositParams) : undefined);
        message.tallyParams !== undefined &&
            (obj.tallyParams = message.tallyParams ? gov_js_1.TallyParams.toJSON(message.tallyParams) : undefined);
        message.params !== undefined && (obj.params = message.params ? gov_js_1.Params.toJSON(message.params) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseQueryParamsResponse();
        if (object.votingParams !== undefined && object.votingParams !== null) {
            message.votingParams = gov_js_1.VotingParams.fromPartial(object.votingParams);
        }
        if (object.depositParams !== undefined && object.depositParams !== null) {
            message.depositParams = gov_js_1.DepositParams.fromPartial(object.depositParams);
        }
        if (object.tallyParams !== undefined && object.tallyParams !== null) {
            message.tallyParams = gov_js_1.TallyParams.fromPartial(object.tallyParams);
        }
        if (object.params !== undefined && object.params !== null) {
            message.params = gov_js_1.Params.fromPartial(object.params);
        }
        return message;
    },
};
...
exports.QueryDepositResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.deposit))
            obj.deposit = gov_js_1.Deposit.fromJSON(object.deposit);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.deposit !== undefined &&
            (obj.deposit = message.deposit ? gov_js_1.Deposit.toJSON(message.deposit) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseQueryDepositResponse();
        if (object.deposit !== undefined && object.deposit !== null) {
            message.deposit = gov_js_1.Deposit.fromPartial(object.deposit);
        }
        return message;
    },
};
...
exports.QueryDepositsResponse = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.deposits))
            obj.deposits = object.deposits.map((e) => gov_js_1.Deposit.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.pagination))
            obj.pagination = pagination_js_1.PageResponse.fromJSON(object.pagination);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        if (message.deposits) {
            obj.deposits = message.deposits.map((e) => (e ? gov_js_1.Deposit.toJSON(e) : undefined));
        }
        else {
            obj.deposits = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseQueryDepositsResponse();
        message.deposits = object.deposits?.map((e) => gov_js_1.Deposit.fromPartial(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_js_1.PageResponse.fromPartial(object.pagination);
        }
        return message;
...
exports.QueryTallyResultResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.tally))
            obj.tally = gov_js_1.TallyResult.fromJSON(object.tally);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.tally !== undefined &&
            (obj.tally = message.tally ? gov_js_1.TallyResult.toJSON(message.tally) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseQueryTallyResultResponse();
        if (object.tally !== undefined && object.tally !== null) {
            message.tally = gov_js_1.TallyResult.fromPartial(object.tally);
        }
        return message;
    },
};

...
export declare const AminoConverter: {
    "/cosmos.gov.v1.MsgSubmitProposal": {
        aminoType: string;
        toAmino: ({ messages, initialDeposit, proposer, metadata, title, summary, expedited, }: MsgSubmitProposal) => MsgSubmitProposalAminoType["value"];
        fromAmino: ({ messages, initial_deposit, proposer, metadata, title, summary, expedited, }: MsgSubmitProposalAminoType["value"]) => MsgSubmitProposal;
    };

...
exports.MsgSubmitProposal = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.initialDeposit))
            obj.initialDeposit = object.initialDeposit.map((e) => coin_js_1.Coin.fromJSON(e));
    ...
    toJSON(message) {
        ...
        if (message.initialDeposit) {
            obj.initialDeposit = message.initialDeposit.map((e) => (e ? coin_js_1.Coin.toJSON(e) : undefined));
        }
        else {
            obj.initialDeposit = [];
        }
    ...
    fromPartial(object) {
        ...
        message.initialDeposit = object.initialDeposit?.map((e) => coin_js_1.Coin.fromPartial(e)) || [];
...
exports.MsgVote = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.option))
            obj.option = (0, gov_js_1.voteOptionFromJSON)(object.option);
        if ((0, helpers_js_1.isSet)(object.metadata))
            obj.metadata = String(object.metadata);
        return obj;
    },
    toJSON(message) {
        ...
        message.option !== undefined && (obj.option = (0, gov_js_1.voteOptionToJSON)(message.option));
        message.metadata !== undefined && (obj.metadata = message.metadata);
        return obj;
    },
    fromPartial(object) {
...
exports.MsgVoteWeighted = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.options))
            obj.options = object.options.map((e) => gov_js_1.WeightedVoteOption.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.metadata))
            obj.metadata = String(object.metadata);
        return obj;
    },
    toJSON(message) {
        ...
        message.voter !== undefined && (obj.voter = message.voter);
        if (message.options) {
            obj.options = message.options.map((e) => (e ? gov_js_1.WeightedVoteOption.toJSON(e) : undefined));
        }
        else {
            obj.options = [];
        }
    ...
    fromPartial(object) {
        ...
        message.voter = object.voter ?? "";
        message.options = object.options?.map((e) => gov_js_1.WeightedVoteOption.fromPartial(e)) || [];
        message.metadata = object.metadata ?? "";
        return message;
    },
};
...
function createBaseMsgUpdateParams() {
    return {
        authority: "",
        params: gov_js_1.Params.fromPartial({}),
    };
}
exports.MsgUpdateParams = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.params !== undefined) {
            gov_js_1.Params.encode(message.params, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.MsgCancelProposalResponse = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.canceledTime !== undefined) {
            timestamp_js_1.Timestamp.encode(message.canceledTime, writer.uint32(18).fork()).ldelim();
        }

...
exports.WeightedVoteOption = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.option))
            obj.option = voteOptionFromJSON(object.option);
        if ((0, helpers_js_1.isSet)(object.weight))
...
exports.Proposal = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.submitTime !== undefined) {
            timestamp_js_1.Timestamp.encode(message.submitTime, writer.uint32(42).fork()).ldelim();
        }
        if (message.depositEndTime !== undefined) {
            timestamp_js_1.Timestamp.encode(message.depositEndTime, writer.uint32(50).fork()).ldelim();
        }
        for (const v of message.totalDeposit) {
            coin_js_1.Coin.encode(v, writer.uint32(58).fork()).ldelim();
        }
        if (message.votingStartTime !== undefined) {
            timestamp_js_1.Timestamp.encode(message.votingStartTime, writer.uint32(66).fork()).ldelim();
        }
        if (message.votingEndTime !== undefined) {
            timestamp_js_1.Timestamp.encode(message.votingEndTime, writer.uint32(74).fork()).ldelim();
        }
        if (message.metadata !== "") {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    message.submitTime = timestamp_js_1.Timestamp.decode(reader, reader.uint32());
                    break;
                case 6:
                    message.depositEndTime = timestamp_js_1.Timestamp.decode(reader, reader.uint32());
                    break;
                case 7:
                    message.totalDeposit.push(coin_js_1.Coin.decode(reader, reader.uint32()));
                    break;
                case 8:
                    message.votingStartTime = timestamp_js_1.Timestamp.decode(reader, reader.uint32());
                    break;
                case 9:
                    message.votingEndTime = timestamp_js_1.Timestamp.decode(reader, reader.uint32());
                    break;
                case 10:
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.finalTallyResult))
            obj.finalTallyResult = exports.TallyResult.fromJSON(object.finalTallyResult);
        if ((0, helpers_js_1.isSet)(object.submitTime))
            obj.submitTime = (0, helpers_js_1.fromJsonTimestamp)(object.submitTime);
        if ((0, helpers_js_1.isSet)(object.depositEndTime))
            obj.depositEndTime = (0, helpers_js_1.fromJsonTimestamp)(object.depositEndTime);
        if (Array.isArray(object?.totalDeposit))
            obj.totalDeposit = object.totalDeposit.map((e) => coin_js_1.Coin.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.votingStartTime))
            obj.votingStartTime = (0, helpers_js_1.fromJsonTimestamp)(object.votingStartTime);
        if ((0, helpers_js_1.isSet)(object.votingEndTime))
            obj.votingEndTime = (0, helpers_js_1.fromJsonTimestamp)(object.votingEndTime);
        if ((0, helpers_js_1.isSet)(object.metadata))
            obj.metadata = String(object.metadata);
        if ((0, helpers_js_1.isSet)(object.title))
            obj.title = String(object.title);
        if ((0, helpers_js_1.isSet)(object.summary))
            obj.summary = String(object.summary);
        if ((0, helpers_js_1.isSet)(object.proposer))
            obj.proposer = String(object.proposer);
        if ((0, helpers_js_1.isSet)(object.expedited))
            obj.expedited = Boolean(object.expedited);
        if ((0, helpers_js_1.isSet)(object.failedReason))
    ...
    toJSON(message) {
        ...
        message.finalTallyResult !== undefined &&
            (obj.finalTallyResult = message.finalTallyResult
                ...
                : undefined);
        message.submitTime !== undefined && (obj.submitTime = (0, helpers_js_1.fromTimestamp)(message.submitTime).toISOString());
        message.depositEndTime !== undefined &&
            (obj.depositEndTime = (0, helpers_js_1.fromTimestamp)(message.depositEndTime).toISOString());
        if (message.totalDeposit) {
            obj.totalDeposit = message.totalDeposit.map((e) => (e ? coin_js_1.Coin.toJSON(e) : undefined));
        }
        else {
            obj.totalDeposit = [];
        }
        message.votingStartTime !== undefined &&
            (obj.votingStartTime = (0, helpers_js_1.fromTimestamp)(message.votingStartTime).toISOString());
        message.votingEndTime !== undefined &&
            (obj.votingEndTime = (0, helpers_js_1.fromTimestamp)(message.votingEndTime).toISOString());
    ...
    fromPartial(object) {
        ...
        if (object.submitTime !== undefined && object.submitTime !== null) {
            message.submitTime = timestamp_js_1.Timestamp.fromPartial(object.submitTime);
        }
        if (object.depositEndTime !== undefined && object.depositEndTime !== null) {
            message.depositEndTime = timestamp_js_1.Timestamp.fromPartial(object.depositEndTime);
        }
        message.totalDeposit = object.totalDeposit?.map((e) => coin_js_1.Coin.fromPartial(e)) || [];
        if (object.votingStartTime !== undefined && object.votingStartTime !== null) {
            message.votingStartTime = timestamp_js_1.Timestamp.fromPartial(object.votingStartTime);
        }
        if (object.votingEndTime !== undefined && object.votingEndTime !== null) {
            message.votingEndTime = timestamp_js_1.Timestamp.fromPartial(object.votingEndTime);
        }
...
exports.TallyResult = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.yesCount))
            obj.yesCount = String(object.yesCount);
        if ((0, helpers_js_1.isSet)(object.abstainCount))
            obj.abstainCount = String(object.abstainCount);
        if ((0, helpers_js_1.isSet)(object.noCount))
            obj.noCount = String(object.noCount);
        if ((0, helpers_js_1.isSet)(object.noWithVetoCount))
...
exports.Vote = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.proposalId))
            obj.proposalId = BigInt(object.proposalId.toString());
        if ((0, helpers_js_1.isSet)(object.voter))
...
exports.DepositParams = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.minDeposit))
            obj.minDeposit = object.minDeposit.map((e) => coin_js_1.Coin.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.maxDepositPeriod))
            obj.maxDepositPeriod = duration_js_1.Duration.fromJSON(object.maxDepositPeriod);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        if (message.minDeposit) {
            obj.minDeposit = message.minDeposit.map((e) => (e ? coin_js_1.Coin.toJSON(e) : undefined));
        }
        else {
            obj.minDeposit = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseDepositParams();
        message.minDeposit = object.minDeposit?.map((e) => coin_js_1.Coin.fromPartial(e)) || [];
        if (object.maxDepositPeriod !== undefined && object.maxDepositPeriod !== null) {
            message.maxDepositPeriod = duration_js_1.Duration.fromPartial(object.maxDepositPeriod);
        }
        return message;
    },
};
...
exports.VotingParams = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.votingPeriod))
            obj.votingPeriod = duration_js_1.Duration.fromJSON(object.votingPeriod);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.votingPeriod !== undefined &&
            (obj.votingPeriod = message.votingPeriod ? duration_js_1.Duration.toJSON(message.votingPeriod) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseVotingParams();
        if (object.votingPeriod !== undefined && object.votingPeriod !== null) {
            message.votingPeriod = duration_js_1.Duration.fromPartial(object.votingPeriod);
        }
        return message;
    },
};
...
exports.TallyParams = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.quorum))
            obj.quorum = String(object.quorum);
        if ((0, helpers_js_1.isSet)(object.threshold))
            obj.threshold = String(object.threshold);
        if ((0, helpers_js_1.isSet)(object.vetoThreshold))
...
exports.Params = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.votingPeriod !== undefined) {
            duration_js_1.Duration.encode(message.votingPeriod, writer.uint32(26).fork()).ldelim();
        }
        if (message.quorum !== "") {
        ...
        if (message.expeditedVotingPeriod !== undefined) {
            duration_js_1.Duration.encode(message.expeditedVotingPeriod, writer.uint32(82).fork()).ldelim();
        }
        ...
        for (const v of message.expeditedMinDeposit) {
            coin_js_1.Coin.encode(v, writer.uint32(98).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    message.expeditedVotingPeriod = duration_js_1.Duration.decode(reader, reader.uint32());
                    break;
                case 11:
                    message.expeditedThreshold = reader.string();
                    break;
                case 12:
                    message.expeditedMinDeposit.push(coin_js_1.Coin.decode(reader, reader.uint32()));
                    break;
                case 13:
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.vetoThreshold))
            obj.vetoThreshold = String(object.vetoThreshold);
        if ((0, helpers_js_1.isSet)(object.minInitialDepositRatio))
            obj.minInitialDepositRatio = String(object.minInitialDepositRatio);
        if ((0, helpers_js_1.isSet)(object.proposalCancelRatio))
            obj.proposalCancelRatio = String(object.proposalCancelRatio);
        if ((0, helpers_js_1.isSet)(object.proposalCancelDest))
            obj.proposalCancelDest = String(object.proposalCancelDest);
        if ((0, helpers_js_1.isSet)(object.expeditedVotingPeriod))
            obj.expeditedVotingPeriod = duration_js_1.Duration.fromJSON(object.expeditedVotingPeriod);
        if ((0, helpers_js_1.isSet)(object.expeditedThreshold))
            obj.expeditedThreshold = String(object.expeditedThreshold);
        if (Array.isArray(object?.expeditedMinDeposit))
            obj.expeditedMinDeposit = object.expeditedMinDeposit.map((e) => coin_js_1.Coin.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.burnVoteQuorum))
            obj.burnVoteQuorum = Boolean(object.burnVoteQuorum);
        if ((0, helpers_js_1.isSet)(object.burnProposalDepositPrevote))
            obj.burnProposalDepositPrevote = Boolean(object.burnProposalDepositPrevote);
        if ((0, helpers_js_1.isSet)(object.burnVoteVeto))
    ...
    toJSON(message) {
        ...
        message.expeditedVotingPeriod !== undefined &&
            (obj.expeditedVotingPeriod = message.expeditedVotingPeriod
                ? duration_js_1.Duration.toJSON(message.expeditedVotingPeriod)
                : undefined);
        message.expeditedThreshold !== undefined && (obj.expeditedThreshold = message.expeditedThreshold);
        if (message.expeditedMinDeposit) {
            obj.expeditedMinDeposit = message.expeditedMinDeposit.map((e) => (e ? coin_js_1.Coin.toJSON(e) : undefined));
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.expeditedVotingPeriod !== undefined && object.expeditedVotingPeriod !== null) {
            message.expeditedVotingPeriod = duration_js_1.Duration.fromPartial(object.expeditedVotingPeriod);
        }
        message.expeditedThreshold = object.expeditedThreshold ?? "";
        message.expeditedMinDeposit = object.expeditedMinDeposit?.map((e) => coin_js_1.Coin.fromPartial(e)) || [];

...
function createBaseEpochInfo() {
    return {
        identifier: "",
        startTime: timestamp_js_1.Timestamp.fromPartial({}),
        duration: duration_js_1.Duration.fromPartial({}),
        currentEpoch: BigInt(0),
        currentEpochStartTime: timestamp_js_1.Timestamp.fromPartial({}),
...
exports.EpochInfo = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.startTime !== undefined) {
            timestamp_js_1.Timestamp.encode(message.startTime, writer.uint32(18).fork()).ldelim();
        }
        if (message.duration !== undefined) {
            duration_js_1.Duration.encode(message.duration, writer.uint32(26).fork()).ldelim();
        }
        if (message.currentEpoch !== BigInt(0)) {
            writer.uint32(32).int64(message.currentEpoch);
        }
        if (message.currentEpochStartTime !== undefined) {
            timestamp_js_1.Timestamp.encode(message.currentEpochStartTime, writer.uint32(42).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.startTime = timestamp_js_1.Timestamp.decode(reader, reader.uint32());
                    break;
                case 3:
                ...
                case 4:
                    ...
                    break;
                case 5:
                    message.currentEpochStartTime = timestamp_js_1.Timestamp.decode(reader, reader.uint32());
                    break;
                case 6:
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.startTime))
            obj.startTime = (0, helpers_js_1.fromJsonTimestamp)(object.startTime);
        if ((0, helpers_js_1.isSet)(object.duration))
            obj.duration = duration_js_1.Duration.fromJSON(object.duration);
        if ((0, helpers_js_1.isSet)(object.currentEpoch))
            obj.currentEpoch = BigInt(object.currentEpoch.toString());
        if ((0, helpers_js_1.isSet)(object.currentEpochStartTime))
            obj.currentEpochStartTime = (0, helpers_js_1.fromJsonTimestamp)(object.currentEpochStartTime);
        if ((0, helpers_js_1.isSet)(object.epochCountingStarted))
            obj.epochCountingStarted = Boolean(object.epochCountingStarted);
        if ((0, helpers_js_1.isSet)(object.currentEpochStartHeight))
    ...
    toJSON(message) {
        ...
        message.startTime !== undefined && (obj.startTime = (0, helpers_js_1.fromTimestamp)(message.startTime).toISOString());
        message.duration !== undefined &&
            (obj.duration = message.duration ? duration_js_1.Duration.toJSON(message.duration) : undefined);
        ...
        message.currentEpochStartTime !== undefined &&
            (obj.currentEpochStartTime = (0, helpers_js_1.fromTimestamp)(message.currentEpochStartTime).toISOString());
    ...
    fromPartial(object) {
        ...
        if (object.startTime !== undefined && object.startTime !== null) {
            message.startTime = timestamp_js_1.Timestamp.fromPartial(object.startTime);
        }
        if (object.duration !== undefined && object.duration !== null) {
            message.duration = duration_js_1.Duration.fromPartial(object.duration);
        }
        ...
        if (object.currentEpochStartTime !== undefined && object.currentEpochStartTime !== null) {
            message.currentEpochStartTime = timestamp_js_1.Timestamp.fromPartial(object.currentEpochStartTime);
        }

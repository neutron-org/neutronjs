...
function createBaseSigningInfo() {
    return {
        address: "",
        validatorSigningInfo: slashing_js_1.ValidatorSigningInfo.fromPartial({}),
    };
}
exports.SigningInfo = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.validatorSigningInfo))
            obj.validatorSigningInfo = slashing_js_1.ValidatorSigningInfo.fromJSON(object.validatorSigningInfo);
        return obj;
    },
    toJSON(message) {
        const obj = {};
    ...
    fromPartial(object) {
        ...
        if (object.validatorSigningInfo !== undefined && object.validatorSigningInfo !== null) {
            message.validatorSigningInfo = slashing_js_1.ValidatorSigningInfo.fromPartial(object.validatorSigningInfo);
        }
        return message;
    },
};
...
exports.MissedBlock = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.missed))

...
function createBaseValidatorSigningInfo() {
    return {
        ...
        jailedUntil: timestamp_js_1.Timestamp.fromPartial({}),
        tombstoned: false,
...
exports.ValidatorSigningInfo = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.jailedUntil !== undefined) {
            timestamp_js_1.Timestamp.encode(message.jailedUntil, writer.uint32(34).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.jailedUntil = timestamp_js_1.Timestamp.decode(reader, reader.uint32());
                    break;
                case 5:
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.startHeight))
            obj.startHeight = BigInt(object.startHeight.toString());
        if ((0, helpers_js_1.isSet)(object.indexOffset))
            obj.indexOffset = BigInt(object.indexOffset.toString());
        if ((0, helpers_js_1.isSet)(object.jailedUntil))
            obj.jailedUntil = (0, helpers_js_1.fromJsonTimestamp)(object.jailedUntil);
        if ((0, helpers_js_1.isSet)(object.tombstoned))
            obj.tombstoned = Boolean(object.tombstoned);
        if ((0, helpers_js_1.isSet)(object.missedBlocksCounter))
    ...
    toJSON(message) {
        ...
        message.jailedUntil !== undefined && (obj.jailedUntil = (0, helpers_js_1.fromTimestamp)(message.jailedUntil).toISOString());
    ...
    fromPartial(object) {
        ...
        if (object.jailedUntil !== undefined && object.jailedUntil !== null) {
            message.jailedUntil = timestamp_js_1.Timestamp.fromPartial(object.jailedUntil);
        }
...
function createBaseParams() {
    return {
        ...
        downtimeJailDuration: duration_js_1.Duration.fromPartial({}),
...
exports.Params = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.signedBlocksWindow))
            obj.signedBlocksWindow = BigInt(object.signedBlocksWindow.toString());
        if ((0, helpers_js_1.isSet)(object.minSignedPerWindow))
            obj.minSignedPerWindow = (0, helpers_js_1.bytesFromBase64)(object.minSignedPerWindow);
        if ((0, helpers_js_1.isSet)(object.downtimeJailDuration))
            obj.downtimeJailDuration = duration_js_1.Duration.fromJSON(object.downtimeJailDuration);
        if ((0, helpers_js_1.isSet)(object.slashFractionDoubleSign))
            obj.slashFractionDoubleSign = (0, helpers_js_1.bytesFromBase64)(object.slashFractionDoubleSign);
        if ((0, helpers_js_1.isSet)(object.slashFractionDowntime))
            obj.slashFractionDowntime = (0, helpers_js_1.bytesFromBase64)(object.slashFractionDowntime);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.minSignedPerWindow !== undefined &&
            (obj.minSignedPerWindow = (0, helpers_js_1.base64FromBytes)(message.minSignedPerWindow !== undefined ? message.minSignedPerWindow : new Uint8Array()));
        ...
        message.slashFractionDoubleSign !== undefined &&
            (obj.slashFractionDoubleSign = (0, helpers_js_1.base64FromBytes)(message.slashFractionDoubleSign !== undefined ? message.slashFractionDoubleSign : new Uint8Array()));
        message.slashFractionDowntime !== undefined &&
            (obj.slashFractionDowntime = (0, helpers_js_1.base64FromBytes)(message.slashFractionDowntime !== undefined ? message.slashFractionDowntime : new Uint8Array()));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseParams();
        ...
        if (object.downtimeJailDuration !== undefined && object.downtimeJailDuration !== null) {
            message.downtimeJailDuration = duration_js_1.Duration.fromPartial(object.downtimeJailDuration);
        }

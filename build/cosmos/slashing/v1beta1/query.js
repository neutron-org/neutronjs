...
exports.QuerySigningInfosResponse = exports.QuerySigningInfosRequest = exports.QuerySigningInfoResponse = exports.QuerySigningInfoRequest = exports.QueryParamsResponse = exports.QueryParamsRequest = exports.protobufPackage = void 0;
//@ts-nocheck
/* eslint-disable */
...
exports.QuerySigningInfoRequest = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.consAddress))
...
function createBaseQuerySigningInfoResponse() {
    return {
        valSigningInfo: slashing_js_1.ValidatorSigningInfo.fromPartial({}),
    };
}
exports.QuerySigningInfoResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.valSigningInfo))
            obj.valSigningInfo = slashing_js_1.ValidatorSigningInfo.fromJSON(object.valSigningInfo);
        return obj;
    },
    toJSON(message) {
        const obj = {};
    ...
    fromPartial(object) {
        ...
        if (object.valSigningInfo !== undefined && object.valSigningInfo !== null) {
            message.valSigningInfo = slashing_js_1.ValidatorSigningInfo.fromPartial(object.valSigningInfo);
        }
        return message;
    },
};
...
exports.QuerySigningInfosResponse = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.info))
            obj.info = object.info.map((e) => slashing_js_1.ValidatorSigningInfo.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.pagination))
    ...
    toJSON(message) {
        const obj = {};
        if (message.info) {
            obj.info = message.info.map((e) => (e ? slashing_js_1.ValidatorSigningInfo.toJSON(e) : undefined));
        }
        else {
            obj.info = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseQuerySigningInfosResponse();
        message.info = object.info?.map((e) => slashing_js_1.ValidatorSigningInfo.fromPartial(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {

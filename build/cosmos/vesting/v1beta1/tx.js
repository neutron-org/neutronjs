...
const vesting_js_1 = require("./vesting.js");
...
exports.MsgCreateVestingAccount = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.delayed))
...
exports.MsgCreatePeriodicVestingAccount = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        for (const v of message.vestingPeriods) {
            vesting_js_1.Period.encode(v, writer.uint32(34).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.vestingPeriods.push(vesting_js_1.Period.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.vestingPeriods))
            obj.vestingPeriods = object.vestingPeriods.map((e) => vesting_js_1.Period.fromJSON(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.vestingPeriods) {
            obj.vestingPeriods = message.vestingPeriods.map((e) => (e ? vesting_js_1.Period.toJSON(e) : undefined));
        }
        else {
            obj.vestingPeriods = [];
        }
    ...
    fromPartial(object) {
        ...
        message.vestingPeriods = object.vestingPeriods?.map((e) => vesting_js_1.Period.fromPartial(e)) || [];
        return message;
    },
};

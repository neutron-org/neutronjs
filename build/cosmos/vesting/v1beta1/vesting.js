...
//@ts-nocheck
/* eslint-disable */
const auth_js_1 = require("../../auth/v1beta1/auth.js");
...
exports.BaseVestingAccount = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.originalVesting))
            obj.originalVesting = object.originalVesting.map((e) => coin_js_1.Coin.fromJSON(e));
        if (Array.isArray(object?.delegatedFree))
            obj.delegatedFree = object.delegatedFree.map((e) => coin_js_1.Coin.fromJSON(e));
        if (Array.isArray(object?.delegatedVesting))
            obj.delegatedVesting = object.delegatedVesting.map((e) => coin_js_1.Coin.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.endTime))
    ...
    toJSON(message) {
        ...
        if (message.originalVesting) {
            obj.originalVesting = message.originalVesting.map((e) => (e ? coin_js_1.Coin.toJSON(e) : undefined));
        }
        else {
            obj.originalVesting = [];
        }
        if (message.delegatedFree) {
            obj.delegatedFree = message.delegatedFree.map((e) => (e ? coin_js_1.Coin.toJSON(e) : undefined));
        }
        else {
            obj.delegatedFree = [];
        }
        if (message.delegatedVesting) {
            obj.delegatedVesting = message.delegatedVesting.map((e) => (e ? coin_js_1.Coin.toJSON(e) : undefined));
        }
        else {
    ...
    fromPartial(object) {
        ...
        message.originalVesting = object.originalVesting?.map((e) => coin_js_1.Coin.fromPartial(e)) || [];
        message.delegatedFree = object.delegatedFree?.map((e) => coin_js_1.Coin.fromPartial(e)) || [];
        message.delegatedVesting = object.delegatedVesting?.map((e) => coin_js_1.Coin.fromPartial(e)) || [];
...
exports.ContinuousVestingAccount = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.baseVestingAccount))

...
exports.MsgAuthorizeCircuitBreaker = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.permissions !== undefined) {
            types_js_1.Permissions.encode(message.permissions, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.permissions = types_js_1.Permissions.decode(reader, reader.uint32());
                    break;
                default:
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.permissions))
            obj.permissions = types_js_1.Permissions.fromJSON(object.permissions);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.permissions !== undefined &&
            (obj.permissions = message.permissions ? types_js_1.Permissions.toJSON(message.permissions) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseMsgAuthorizeCircuitBreaker();
        ...
        if (object.permissions !== undefined && object.permissions !== null) {
            message.permissions = types_js_1.Permissions.fromPartial(object.permissions);
        }
        return message;
    },
};

...
exports.AccountResponse = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        if (message.permission !== undefined) {
            types_js_1.Permissions.encode(message.permission, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.permission = types_js_1.Permissions.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.permission))
            obj.permission = types_js_1.Permissions.fromJSON(object.permission);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.permission !== undefined &&
            (obj.permission = message.permission ? types_js_1.Permissions.toJSON(message.permission) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseAccountResponse();
        if (object.permission !== undefined && object.permission !== null) {
            message.permission = types_js_1.Permissions.fromPartial(object.permission);
        }
        return message;
    },
};
...
exports.AccountsResponse = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        for (const v of message.accounts) {
            types_js_1.GenesisAccountPermissions.encode(v, writer.uint32(10).fork()).ldelim();
        }
        if (message.pagination !== undefined) {
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.accounts.push(types_js_1.GenesisAccountPermissions.decode(reader, reader.uint32()));
                    break;
                case 2:
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.accounts))
            obj.accounts = object.accounts.map((e) => types_js_1.GenesisAccountPermissions.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.pagination))
    ...
    toJSON(message) {
        const obj = {};
        if (message.accounts) {
            obj.accounts = message.accounts.map((e) => (e ? types_js_1.GenesisAccountPermissions.toJSON(e) : undefined));
        }
        else {
            obj.accounts = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseAccountsResponse();
        message.accounts = object.accounts?.map((e) => types_js_1.GenesisAccountPermissions.fromPartial(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {

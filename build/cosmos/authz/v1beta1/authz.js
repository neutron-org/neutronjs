...
exports.Grant = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.authorization))
            obj.authorization = any_js_1.Any.fromJSON(object.authorization);
    ...
    toJSON(message) {
        ...
        message.authorization !== undefined &&
            (obj.authorization = message.authorization ? any_js_1.Any.toJSON(message.authorization) : undefined);
    ...
    fromPartial(object) {
        ...
        if (object.authorization !== undefined && object.authorization !== null) {
            message.authorization = any_js_1.Any.fromPartial(object.authorization);
        }
...
exports.GrantAuthorization = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.expiration !== undefined) {
            timestamp_js_1.Timestamp.encode(message.expiration, writer.uint32(34).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {

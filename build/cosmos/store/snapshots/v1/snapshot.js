...
exports.Metadata = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.chunkHashes))
            obj.chunkHashes = object.chunkHashes.map((e) => (0, helpers_js_1.bytesFromBase64)(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
        if (message.chunkHashes) {
            obj.chunkHashes = message.chunkHashes.map((e) => (0, helpers_js_1.base64FromBytes)(e !== undefined ? e : new Uint8Array()));
        }
        else {
            obj.chunkHashes = [];
        }
...
exports.SnapshotItem = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.store))
            obj.store = exports.SnapshotStoreItem.fromJSON(object.store);
        if ((0, helpers_js_1.isSet)(object.iavl))
        ...
        if ((0, helpers_js_1.isSet)(object.extensionPayload))
...
exports.SnapshotExtensionPayload = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.payload))
            obj.payload = (0, helpers_js_1.bytesFromBase64)(object.payload);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.payload !== undefined &&
            (obj.payload = (0, helpers_js_1.base64FromBytes)(message.payload !== undefined ? message.payload : new Uint8Array()));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseSnapshotExtensionPayload();

...
exports.StoreKVPair = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.storeKey))
...
exports.BlockMetadata = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        if (message.responseCommit !== undefined) {
            types_js_1.ResponseCommit.encode(message.responseCommit, writer.uint32(50).fork()).ldelim();
        }
        if (message.requestFinalizeBlock !== undefined) {
            types_js_1.RequestFinalizeBlock.encode(message.requestFinalizeBlock, writer.uint32(58).fork()).ldelim();
        }
        if (message.responseFinalizeBlock !== undefined) {
            types_js_1.ResponseFinalizeBlock.encode(message.responseFinalizeBlock, writer.uint32(66).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 6:
                    message.responseCommit = types_js_1.ResponseCommit.decode(reader, reader.uint32());
                    break;
                case 7:
                    message.requestFinalizeBlock = types_js_1.RequestFinalizeBlock.decode(reader, reader.uint32());
                    break;
                case 8:
                    message.responseFinalizeBlock = types_js_1.ResponseFinalizeBlock.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.responseCommit))
            obj.responseCommit = types_js_1.ResponseCommit.fromJSON(object.responseCommit);
        if ((0, helpers_js_1.isSet)(object.requestFinalizeBlock))
            obj.requestFinalizeBlock = types_js_1.RequestFinalizeBlock.fromJSON(object.requestFinalizeBlock);
        if ((0, helpers_js_1.isSet)(object.responseFinalizeBlock))
            obj.responseFinalizeBlock = types_js_1.ResponseFinalizeBlock.fromJSON(object.responseFinalizeBlock);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.responseCommit !== undefined &&
            (obj.responseCommit = message.responseCommit
                ? types_js_1.ResponseCommit.toJSON(message.responseCommit)
                : undefined);
        message.requestFinalizeBlock !== undefined &&
            (obj.requestFinalizeBlock = message.requestFinalizeBlock
                ? types_js_1.RequestFinalizeBlock.toJSON(message.requestFinalizeBlock)
                : undefined);
        message.responseFinalizeBlock !== undefined &&
            (obj.responseFinalizeBlock = message.responseFinalizeBlock
                ? types_js_1.ResponseFinalizeBlock.toJSON(message.responseFinalizeBlock)
                : undefined);
        return obj;
    },
    fromPartial(object) {
        ...
        if (object.responseCommit !== undefined && object.responseCommit !== null) {
            message.responseCommit = types_js_1.ResponseCommit.fromPartial(object.responseCommit);
        }
        if (object.requestFinalizeBlock !== undefined && object.requestFinalizeBlock !== null) {
            message.requestFinalizeBlock = types_js_1.RequestFinalizeBlock.fromPartial(object.requestFinalizeBlock);
        }
        if (object.responseFinalizeBlock !== undefined && object.responseFinalizeBlock !== null) {
            message.responseFinalizeBlock = types_js_1.ResponseFinalizeBlock.fromPartial(object.responseFinalizeBlock);
        }
        return message;
    },
};

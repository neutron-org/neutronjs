...
class QueryClientImpl {
    ...
    subspaces(request = {}) {
        const data = query_js_1.QuerySubspacesRequest.encode(request).finish();
        const promise = this.rpc.request("cosmos.params.v1beta1.Query", "Subspaces", data);
        return promise.then((data) => query_js_1.QuerySubspacesResponse.decode(new binary_js_1.BinaryReader(data)));
    }
}

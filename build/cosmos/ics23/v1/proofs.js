...
exports.ExistenceProof = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.leaf))
...
exports.NonExistenceProof = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.key))
            obj.key = (0, helpers_js_1.bytesFromBase64)(object.key);
        if ((0, helpers_js_1.isSet)(object.left))
            obj.left = exports.ExistenceProof.fromJSON(object.left);
        if ((0, helpers_js_1.isSet)(object.right))
...
exports.LeafOp = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.prehashKey))
            obj.prehashKey = hashOpFromJSON(object.prehashKey);
        if ((0, helpers_js_1.isSet)(object.prehashValue))
            obj.prehashValue = hashOpFromJSON(object.prehashValue);
        if ((0, helpers_js_1.isSet)(object.length))
            obj.length = lengthOpFromJSON(object.length);
        if ((0, helpers_js_1.isSet)(object.prefix))
            obj.prefix = (0, helpers_js_1.bytesFromBase64)(object.prefix);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.prefix !== undefined &&
            (obj.prefix = (0, helpers_js_1.base64FromBytes)(message.prefix !== undefined ? message.prefix : new Uint8Array()));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseLeafOp();
...
exports.InnerOp = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.prefix))
            obj.prefix = (0, helpers_js_1.bytesFromBase64)(object.prefix);
        if ((0, helpers_js_1.isSet)(object.suffix))
            obj.suffix = (0, helpers_js_1.bytesFromBase64)(object.suffix);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.suffix !== undefined &&
            (obj.suffix = (0, helpers_js_1.base64FromBytes)(message.suffix !== undefined ? message.suffix : new Uint8Array()));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseInnerOp();
...
exports.ProofSpec = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.leafSpec))
            obj.leafSpec = exports.LeafOp.fromJSON(object.leafSpec);
        if ((0, helpers_js_1.isSet)(object.innerSpec))
            obj.innerSpec = exports.InnerSpec.fromJSON(object.innerSpec);
        if ((0, helpers_js_1.isSet)(object.maxDepth))
            obj.maxDepth = Number(object.maxDepth);
        if ((0, helpers_js_1.isSet)(object.minDepth))
...
exports.InnerSpec = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.childSize))
            obj.childSize = Number(object.childSize);
        if ((0, helpers_js_1.isSet)(object.minPrefixLength))
            obj.minPrefixLength = Number(object.minPrefixLength);
        if ((0, helpers_js_1.isSet)(object.maxPrefixLength))
            obj.maxPrefixLength = Number(object.maxPrefixLength);
        if ((0, helpers_js_1.isSet)(object.emptyChild))
            obj.emptyChild = (0, helpers_js_1.bytesFromBase64)(object.emptyChild);
        if ((0, helpers_js_1.isSet)(object.hash))
            obj.hash = hashOpFromJSON(object.hash);
        return obj;
    },
    toJSON(message) {
        ...
        message.emptyChild !== undefined &&
            (obj.emptyChild = (0, helpers_js_1.base64FromBytes)(message.emptyChild !== undefined ? message.emptyChild : new Uint8Array()));
        message.hash !== undefined && (obj.hash = hashOpToJSON(message.hash));
        return obj;
    },
    fromPartial(object) {

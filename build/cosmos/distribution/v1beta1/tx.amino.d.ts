...
export declare const AminoConverter: {
    ...
    "/cosmos.distribution.v1beta1.MsgDepositValidatorRewardsPool": {
        aminoType: string;
        toAmino: ({ depositor, validatorAddress, amount, }: MsgDepositValidatorRewardsPool) => MsgDepositValidatorRewardsPoolAminoType["value"];
        fromAmino: ({ depositor, validator_address, amount, }: MsgDepositValidatorRewardsPoolAminoType["value"]) => MsgDepositValidatorRewardsPool;
    };
};

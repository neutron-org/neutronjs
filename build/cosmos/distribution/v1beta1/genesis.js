...
exports.ValidatorOutstandingRewardsRecord = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.outstandingRewards))
            obj.outstandingRewards = object.outstandingRewards.map((e) => coin_js_1.DecCoin.fromJSON(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.outstandingRewards) {
            obj.outstandingRewards = message.outstandingRewards.map((e) => (e ? coin_js_1.DecCoin.toJSON(e) : undefined));
        }
        else {
    ...
    fromPartial(object) {
        ...
        message.outstandingRewards = object.outstandingRewards?.map((e) => coin_js_1.DecCoin.fromPartial(e)) || [];
        return message;
    },
};
function createBaseValidatorAccumulatedCommissionRecord() {
    return {
        validatorAddress: "",
        accumulated: distribution_js_1.ValidatorAccumulatedCommission.fromPartial({}),
    };
}
exports.ValidatorAccumulatedCommissionRecord = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.validatorAddress))
            obj.validatorAddress = String(object.validatorAddress);
        if ((0, helpers_js_1.isSet)(object.accumulated))
            obj.accumulated = distribution_js_1.ValidatorAccumulatedCommission.fromJSON(object.accumulated);
        return obj;
    },
    toJSON(message) {
        const obj = {};
    ...
    fromPartial(object) {
        ...
        if (object.accumulated !== undefined && object.accumulated !== null) {
            message.accumulated = distribution_js_1.ValidatorAccumulatedCommission.fromPartial(object.accumulated);
        }
        return message;
    },
};
function createBaseValidatorHistoricalRewardsRecord() {
    return {
        validatorAddress: "",
        period: BigInt(0),
        rewards: distribution_js_1.ValidatorHistoricalRewards.fromPartial({}),
    };
}
exports.ValidatorHistoricalRewardsRecord = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.rewards))
            obj.rewards = distribution_js_1.ValidatorHistoricalRewards.fromJSON(object.rewards);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.rewards !== undefined &&
            (obj.rewards = message.rewards ? distribution_js_1.ValidatorHistoricalRewards.toJSON(message.rewards) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseValidatorHistoricalRewardsRecord();
        ...
        if (object.rewards !== undefined && object.rewards !== null) {
            message.rewards = distribution_js_1.ValidatorHistoricalRewards.fromPartial(object.rewards);
        }
        return message;
    },
};
function createBaseValidatorCurrentRewardsRecord() {
    return {
        validatorAddress: "",
        rewards: distribution_js_1.ValidatorCurrentRewards.fromPartial({}),
    };
}
exports.ValidatorCurrentRewardsRecord = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.validatorAddress))
            obj.validatorAddress = String(object.validatorAddress);
        if ((0, helpers_js_1.isSet)(object.rewards))
            obj.rewards = distribution_js_1.ValidatorCurrentRewards.fromJSON(object.rewards);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.validatorAddress !== undefined && (obj.validatorAddress = message.validatorAddress);
        message.rewards !== undefined &&
            (obj.rewards = message.rewards ? distribution_js_1.ValidatorCurrentRewards.toJSON(message.rewards) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseValidatorCurrentRewardsRecord();
        message.validatorAddress = object.validatorAddress ?? "";
        if (object.rewards !== undefined && object.rewards !== null) {
            message.rewards = distribution_js_1.ValidatorCurrentRewards.fromPartial(object.rewards);
        }
        return message;
    },
};
function createBaseDelegatorStartingInfoRecord() {
    return {
        delegatorAddress: "",
        validatorAddress: "",
        startingInfo: distribution_js_1.DelegatorStartingInfo.fromPartial({}),
    };
}
exports.DelegatorStartingInfoRecord = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.validatorAddress))
            obj.validatorAddress = String(object.validatorAddress);
        if ((0, helpers_js_1.isSet)(object.startingInfo))
            obj.startingInfo = distribution_js_1.DelegatorStartingInfo.fromJSON(object.startingInfo);
        return obj;
    },
    toJSON(message) {
        const obj = {};
    ...
    fromPartial(object) {
        ...
        if (object.startingInfo !== undefined && object.startingInfo !== null) {
            message.startingInfo = distribution_js_1.DelegatorStartingInfo.fromPartial(object.startingInfo);
        }
        return message;
    },
};
function createBaseValidatorSlashEventRecord() {
    return {
        ...
        height: BigInt(0),
        period: BigInt(0),
        validatorSlashEvent: distribution_js_1.ValidatorSlashEvent.fromPartial({}),
    };
}
exports.ValidatorSlashEventRecord = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.period))
            obj.period = BigInt(object.period.toString());
        if ((0, helpers_js_1.isSet)(object.validatorSlashEvent))
            obj.validatorSlashEvent = distribution_js_1.ValidatorSlashEvent.fromJSON(object.validatorSlashEvent);
        return obj;
    },
    toJSON(message) {
        const obj = {};
    ...
    fromPartial(object) {
        ...
        if (object.validatorSlashEvent !== undefined && object.validatorSlashEvent !== null) {
            message.validatorSlashEvent = distribution_js_1.ValidatorSlashEvent.fromPartial(object.validatorSlashEvent);
        }
        return message;
    },
};
function createBaseGenesisState() {
    return {
        ...
        feePool: distribution_js_1.FeePool.fromPartial({}),
...
exports.GenesisState = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.feePool))
            obj.feePool = distribution_js_1.FeePool.fromJSON(object.feePool);
        ...
        if ((0, helpers_js_1.isSet)(object.previousProposer))
    ...
    toJSON(message) {
        ...
        message.feePool !== undefined &&
            (obj.feePool = message.feePool ? distribution_js_1.FeePool.toJSON(message.feePool) : undefined);
    ...
    fromPartial(object) {
        ...
        if (object.feePool !== undefined && object.feePool !== null) {
            message.feePool = distribution_js_1.FeePool.fromPartial(object.feePool);
        }

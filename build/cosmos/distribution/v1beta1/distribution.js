...
exports.Params = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.communityTax))
            obj.communityTax = String(object.communityTax);
        if ((0, helpers_js_1.isSet)(object.baseProposerReward))
            obj.baseProposerReward = String(object.baseProposerReward);
        if ((0, helpers_js_1.isSet)(object.bonusProposerReward))
            obj.bonusProposerReward = String(object.bonusProposerReward);
        if ((0, helpers_js_1.isSet)(object.withdrawAddrEnabled))
...
exports.ValidatorHistoricalRewards = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.cumulativeRewardRatio))
            obj.cumulativeRewardRatio = object.cumulativeRewardRatio.map((e) => coin_js_1.DecCoin.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.referenceCount))
    ...
    toJSON(message) {
        ...
        if (message.cumulativeRewardRatio) {
            obj.cumulativeRewardRatio = message.cumulativeRewardRatio.map((e) => e ? coin_js_1.DecCoin.toJSON(e) : undefined);
        }
        else {
    ...
    fromPartial(object) {
        const message = createBaseValidatorHistoricalRewards();
        message.cumulativeRewardRatio = object.cumulativeRewardRatio?.map((e) => coin_js_1.DecCoin.fromPartial(e)) || [];
...
exports.ValidatorSlashEvent = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.validatorPeriod))
            obj.validatorPeriod = BigInt(object.validatorPeriod.toString());
        if ((0, helpers_js_1.isSet)(object.fraction))
...
exports.FeePool = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.communityPool))
            obj.communityPool = object.communityPool.map((e) => coin_js_1.DecCoin.fromJSON(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
        if (message.communityPool) {
            obj.communityPool = message.communityPool.map((e) => (e ? coin_js_1.DecCoin.toJSON(e) : undefined));
        }
        else {
            obj.communityPool = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseFeePool();
        message.communityPool = object.communityPool?.map((e) => coin_js_1.DecCoin.fromPartial(e)) || [];
        return message;
    },
};
...
exports.DelegatorStartingInfo = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.previousPeriod))
            obj.previousPeriod = BigInt(object.previousPeriod.toString());
        if ((0, helpers_js_1.isSet)(object.stake))
...
exports.DelegationDelegatorReward = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.reward))
            obj.reward = object.reward.map((e) => coin_js_1.DecCoin.fromJSON(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.reward) {
            obj.reward = message.reward.map((e) => (e ? coin_js_1.DecCoin.toJSON(e) : undefined));
        }
        else {
            obj.reward = [];
        }
    ...
    fromPartial(object) {
        ...
        message.reward = object.reward?.map((e) => coin_js_1.DecCoin.fromPartial(e)) || [];
        return message;
    },
};

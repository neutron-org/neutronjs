...
exports.BasicAllowance = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.expiration !== undefined) {
            timestamp_js_1.Timestamp.encode(message.expiration, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.expiration = timestamp_js_1.Timestamp.decode(reader, reader.uint32());
                    break;
                default:
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.spendLimit))
            obj.spendLimit = object.spendLimit.map((e) => coin_js_1.Coin.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.expiration))
            obj.expiration = (0, helpers_js_1.fromJsonTimestamp)(object.expiration);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        if (message.spendLimit) {
            obj.spendLimit = message.spendLimit.map((e) => (e ? coin_js_1.Coin.toJSON(e) : undefined));
        }
        else {
            obj.spendLimit = [];
        }
        message.expiration !== undefined && (obj.expiration = (0, helpers_js_1.fromTimestamp)(message.expiration).toISOString());
        return obj;
    },
    fromPartial(object) {
        const message = createBaseBasicAllowance();
        message.spendLimit = object.spendLimit?.map((e) => coin_js_1.Coin.fromPartial(e)) || [];
        if (object.expiration !== undefined && object.expiration !== null) {
            message.expiration = timestamp_js_1.Timestamp.fromPartial(object.expiration);
        }
        return message;
    },
};
function createBasePeriodicAllowance() {
    return {
        ...
        period: duration_js_1.Duration.fromPartial({}),
        periodSpendLimit: [],
        periodCanSpend: [],
        periodReset: timestamp_js_1.Timestamp.fromPartial({}),
    };
}
exports.PeriodicAllowance = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.periodReset !== undefined) {
            timestamp_js_1.Timestamp.encode(message.periodReset, writer.uint32(42).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    message.periodReset = timestamp_js_1.Timestamp.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.basic))
            obj.basic = exports.BasicAllowance.fromJSON(object.basic);
        if ((0, helpers_js_1.isSet)(object.period))
            obj.period = duration_js_1.Duration.fromJSON(object.period);
        if (Array.isArray(object?.periodSpendLimit))
            obj.periodSpendLimit = object.periodSpendLimit.map((e) => coin_js_1.Coin.fromJSON(e));
        if (Array.isArray(object?.periodCanSpend))
            obj.periodCanSpend = object.periodCanSpend.map((e) => coin_js_1.Coin.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.periodReset))
            obj.periodReset = (0, helpers_js_1.fromJsonTimestamp)(object.periodReset);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.period !== undefined &&
            (obj.period = message.period ? duration_js_1.Duration.toJSON(message.period) : undefined);
        if (message.periodSpendLimit) {
            obj.periodSpendLimit = message.periodSpendLimit.map((e) => (e ? coin_js_1.Coin.toJSON(e) : undefined));
        }
        else {
            obj.periodSpendLimit = [];
        }
        if (message.periodCanSpend) {
            obj.periodCanSpend = message.periodCanSpend.map((e) => (e ? coin_js_1.Coin.toJSON(e) : undefined));
        }
        else {
            obj.periodCanSpend = [];
        }
        message.periodReset !== undefined && (obj.periodReset = (0, helpers_js_1.fromTimestamp)(message.periodReset).toISOString());
        return obj;
    },
    fromPartial(object) {
        const message = createBasePeriodicAllowance();
        ...
        if (object.period !== undefined && object.period !== null) {
            message.period = duration_js_1.Duration.fromPartial(object.period);
        }
        message.periodSpendLimit = object.periodSpendLimit?.map((e) => coin_js_1.Coin.fromPartial(e)) || [];
        message.periodCanSpend = object.periodCanSpend?.map((e) => coin_js_1.Coin.fromPartial(e)) || [];
        if (object.periodReset !== undefined && object.periodReset !== null) {
            message.periodReset = timestamp_js_1.Timestamp.fromPartial(object.periodReset);
        }
        return message;
    },
};
...
exports.AllowedMsgAllowance = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.allowance))
            obj.allowance = any_js_1.Any.fromJSON(object.allowance);
    ...
    toJSON(message) {
        ...
        message.allowance !== undefined &&
            (obj.allowance = message.allowance ? any_js_1.Any.toJSON(message.allowance) : undefined);
    ...
    fromPartial(object) {
        ...
        if (object.allowance !== undefined && object.allowance !== null) {
            message.allowance = any_js_1.Any.fromPartial(object.allowance);
        }

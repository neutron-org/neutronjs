...
exports.GenesisState = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.lastTotalPower))
            obj.lastTotalPower = (0, helpers_js_1.bytesFromBase64)(object.lastTotalPower);
        ...
        if (Array.isArray(object?.delegations))
            obj.delegations = object.delegations.map((e) => staking_js_1.Delegation.fromJSON(e));
        if (Array.isArray(object?.unbondingDelegations))
            obj.unbondingDelegations = object.unbondingDelegations.map((e) => staking_js_1.UnbondingDelegation.fromJSON(e));
        if (Array.isArray(object?.redelegations))
            obj.redelegations = object.redelegations.map((e) => staking_js_1.Redelegation.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.exported))
    ...
    toJSON(message) {
        ...
        message.lastTotalPower !== undefined &&
            (obj.lastTotalPower = (0, helpers_js_1.base64FromBytes)(message.lastTotalPower !== undefined ? message.lastTotalPower : new Uint8Array()));
        ...
        if (message.delegations) {
            obj.delegations = message.delegations.map((e) => (e ? staking_js_1.Delegation.toJSON(e) : undefined));
        }
        else {
            obj.delegations = [];
        }
        if (message.unbondingDelegations) {
            obj.unbondingDelegations = message.unbondingDelegations.map((e) => e ? staking_js_1.UnbondingDelegation.toJSON(e) : undefined);
        }
        else {
            obj.unbondingDelegations = [];
        }
        if (message.redelegations) {
            obj.redelegations = message.redelegations.map((e) => (e ? staking_js_1.Redelegation.toJSON(e) : undefined));
        }
        else {
            obj.redelegations = [];
        }
    ...
    fromPartial(object) {
        ...
        message.delegations = object.delegations?.map((e) => staking_js_1.Delegation.fromPartial(e)) || [];
        message.unbondingDelegations =
            object.unbondingDelegations?.map((e) => staking_js_1.UnbondingDelegation.fromPartial(e)) || [];
        message.redelegations = object.redelegations?.map((e) => staking_js_1.Redelegation.fromPartial(e)) || [];

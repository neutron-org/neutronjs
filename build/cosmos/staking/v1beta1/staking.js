...
//@ts-nocheck
/* eslint-disable */
const types_js_1 = require("../../../tendermint/types/types.js");
...
const types_js_2 = require("../../../tendermint/abci/types.js");
...
function createBaseHistoricalInfo() {
    return {
        header: types_js_1.Header.fromPartial({}),
        valset: [],
    };
}
exports.HistoricalInfo = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.header))
            obj.header = types_js_1.Header.fromJSON(object.header);
    ...
    toJSON(message) {
        const obj = {};
        message.header !== undefined && (obj.header = message.header ? types_js_1.Header.toJSON(message.header) : undefined);
        if (message.valset) {
    ...
    fromPartial(object) {
        ...
        if (object.header !== undefined && object.header !== null) {
            message.header = types_js_1.Header.fromPartial(object.header);
        }
...
exports.CommissionRates = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.rate))
            obj.rate = String(object.rate);
        if ((0, helpers_js_1.isSet)(object.maxRate))
            obj.maxRate = String(object.maxRate);
        if ((0, helpers_js_1.isSet)(object.maxChangeRate))
...
function createBaseCommission() {
    return {
        ...
        updateTime: timestamp_js_1.Timestamp.fromPartial({}),
    };
}
exports.Commission = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.updateTime !== undefined) {
            timestamp_js_1.Timestamp.encode(message.updateTime, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.updateTime = timestamp_js_1.Timestamp.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.commissionRates))
            obj.commissionRates = exports.CommissionRates.fromJSON(object.commissionRates);
        if ((0, helpers_js_1.isSet)(object.updateTime))
            obj.updateTime = (0, helpers_js_1.fromJsonTimestamp)(object.updateTime);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.commissionRates !== undefined &&
            (obj.commissionRates = message.commissionRates
                ...
                : undefined);
        message.updateTime !== undefined && (obj.updateTime = (0, helpers_js_1.fromTimestamp)(message.updateTime).toISOString());
        return obj;
    },
    fromPartial(object) {
        const message = createBaseCommission();
        ...
        if (object.updateTime !== undefined && object.updateTime !== null) {
            message.updateTime = timestamp_js_1.Timestamp.fromPartial(object.updateTime);
        }
        return message;
    },
};
...
exports.Description = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.moniker))
            obj.moniker = String(object.moniker);
        if ((0, helpers_js_1.isSet)(object.identity))
            obj.identity = String(object.identity);
        if ((0, helpers_js_1.isSet)(object.website))
            obj.website = String(object.website);
        if ((0, helpers_js_1.isSet)(object.securityContact))
            obj.securityContact = String(object.securityContact);
        if ((0, helpers_js_1.isSet)(object.details))
...
function createBaseValidator() {
    return {
        ...
        unbondingTime: timestamp_js_1.Timestamp.fromPartial({}),
...
exports.Validator = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.unbondingTime !== undefined) {
            timestamp_js_1.Timestamp.encode(message.unbondingTime, writer.uint32(74).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    message.unbondingTime = timestamp_js_1.Timestamp.decode(reader, reader.uint32());
                    break;
                case 10:
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.consensusPubkey))
            obj.consensusPubkey = any_js_1.Any.fromJSON(object.consensusPubkey);
        if ((0, helpers_js_1.isSet)(object.jailed))
            obj.jailed = Boolean(object.jailed);
        if ((0, helpers_js_1.isSet)(object.status))
            obj.status = bondStatusFromJSON(object.status);
        if ((0, helpers_js_1.isSet)(object.tokens))
            obj.tokens = String(object.tokens);
        if ((0, helpers_js_1.isSet)(object.delegatorShares))
            obj.delegatorShares = String(object.delegatorShares);
        if ((0, helpers_js_1.isSet)(object.description))
            obj.description = exports.Description.fromJSON(object.description);
        if ((0, helpers_js_1.isSet)(object.unbondingHeight))
            obj.unbondingHeight = BigInt(object.unbondingHeight.toString());
        if ((0, helpers_js_1.isSet)(object.unbondingTime))
            obj.unbondingTime = (0, helpers_js_1.fromJsonTimestamp)(object.unbondingTime);
        if ((0, helpers_js_1.isSet)(object.commission))
            obj.commission = exports.Commission.fromJSON(object.commission);
        if ((0, helpers_js_1.isSet)(object.minSelfDelegation))
            obj.minSelfDelegation = String(object.minSelfDelegation);
        if ((0, helpers_js_1.isSet)(object.unbondingOnHoldRefCount))
    ...
    toJSON(message) {
        ...
        message.consensusPubkey !== undefined &&
            (obj.consensusPubkey = message.consensusPubkey ? any_js_1.Any.toJSON(message.consensusPubkey) : undefined);
        ...
        message.unbondingTime !== undefined &&
            (obj.unbondingTime = (0, helpers_js_1.fromTimestamp)(message.unbondingTime).toISOString());
    ...
    fromPartial(object) {
        ...
        if (object.consensusPubkey !== undefined && object.consensusPubkey !== null) {
            message.consensusPubkey = any_js_1.Any.fromPartial(object.consensusPubkey);
        }
        ...
        if (object.unbondingTime !== undefined && object.unbondingTime !== null) {
            message.unbondingTime = timestamp_js_1.Timestamp.fromPartial(object.unbondingTime);
        }
...
exports.DVVTriplet = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.delegatorAddress))
            obj.delegatorAddress = String(object.delegatorAddress);
        if ((0, helpers_js_1.isSet)(object.validatorSrcAddress))
            obj.validatorSrcAddress = String(object.validatorSrcAddress);
        if ((0, helpers_js_1.isSet)(object.validatorDstAddress))
...
exports.Delegation = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.validatorAddress))
            obj.validatorAddress = String(object.validatorAddress);
        if ((0, helpers_js_1.isSet)(object.shares))
...
function createBaseUnbondingDelegationEntry() {
    return {
        ...
        completionTime: timestamp_js_1.Timestamp.fromPartial({}),
        initialBalance: "",
        balance: "",
...
exports.UnbondingDelegationEntry = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.completionTime !== undefined) {
            timestamp_js_1.Timestamp.encode(message.completionTime, writer.uint32(18).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.completionTime = timestamp_js_1.Timestamp.decode(reader, reader.uint32());
                    break;
                case 3:
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.creationHeight))
            obj.creationHeight = BigInt(object.creationHeight.toString());
        if ((0, helpers_js_1.isSet)(object.completionTime))
            obj.completionTime = (0, helpers_js_1.fromJsonTimestamp)(object.completionTime);
        if ((0, helpers_js_1.isSet)(object.initialBalance))
            obj.initialBalance = String(object.initialBalance);
        if ((0, helpers_js_1.isSet)(object.balance))
            obj.balance = String(object.balance);
        if ((0, helpers_js_1.isSet)(object.unbondingId))
    ...
    toJSON(message) {
        ...
        message.completionTime !== undefined &&
            (obj.completionTime = (0, helpers_js_1.fromTimestamp)(message.completionTime).toISOString());
    ...
    fromPartial(object) {
        ...
        if (object.completionTime !== undefined && object.completionTime !== null) {
            message.completionTime = timestamp_js_1.Timestamp.fromPartial(object.completionTime);
        }
...
exports.RedelegationEntry = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.initialBalance))
            obj.initialBalance = String(object.initialBalance);
        if ((0, helpers_js_1.isSet)(object.sharesDst))
...
function createBaseParams() {
    return {
        unbondingTime: duration_js_1.Duration.fromPartial({}),
        maxValidators: 0,
        maxEntries: 0,
        historicalEntries: 0,
        bondDenom: "",
...
exports.Params = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.unbondingTime))
            obj.unbondingTime = duration_js_1.Duration.fromJSON(object.unbondingTime);
        if ((0, helpers_js_1.isSet)(object.maxValidators))
            obj.maxValidators = Number(object.maxValidators);
        if ((0, helpers_js_1.isSet)(object.maxEntries))
            obj.maxEntries = Number(object.maxEntries);
        if ((0, helpers_js_1.isSet)(object.historicalEntries))
            obj.historicalEntries = Number(object.historicalEntries);
        if ((0, helpers_js_1.isSet)(object.bondDenom))
            obj.bondDenom = String(object.bondDenom);
        if ((0, helpers_js_1.isSet)(object.minCommissionRate))
    ...
    toJSON(message) {
        const obj = {};
        message.unbondingTime !== undefined &&
            (obj.unbondingTime = message.unbondingTime ? duration_js_1.Duration.toJSON(message.unbondingTime) : undefined);
    ...
    fromPartial(object) {
        const message = createBaseParams();
        if (object.unbondingTime !== undefined && object.unbondingTime !== null) {
            message.unbondingTime = duration_js_1.Duration.fromPartial(object.unbondingTime);
        }
...
function createBaseDelegationResponse() {
    return {
        ...
        balance: coin_js_1.Coin.fromPartial({}),
    };
}
exports.DelegationResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.delegation))
            obj.delegation = exports.Delegation.fromJSON(object.delegation);
        if ((0, helpers_js_1.isSet)(object.balance))
            obj.balance = coin_js_1.Coin.fromJSON(object.balance);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.balance !== undefined &&
            (obj.balance = message.balance ? coin_js_1.Coin.toJSON(message.balance) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseDelegationResponse();
        ...
        if (object.balance !== undefined && object.balance !== null) {
            message.balance = coin_js_1.Coin.fromPartial(object.balance);
        }
        return message;
    },
};
...
exports.RedelegationEntryResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.redelegationEntry))
...
exports.RedelegationResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.redelegation))
...
exports.Pool = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.notBondedTokens))
            obj.notBondedTokens = String(object.notBondedTokens);
        if ((0, helpers_js_1.isSet)(object.bondedTokens))
...
exports.ValidatorUpdates = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        for (const v of message.updates) {
            types_js_2.ValidatorUpdate.encode(v, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.updates.push(types_js_2.ValidatorUpdate.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.updates))
            obj.updates = object.updates.map((e) => types_js_2.ValidatorUpdate.fromJSON(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
        if (message.updates) {
            obj.updates = message.updates.map((e) => (e ? types_js_2.ValidatorUpdate.toJSON(e) : undefined));
        }
        else {
            obj.updates = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseValidatorUpdates();
        message.updates = object.updates?.map((e) => types_js_2.ValidatorUpdate.fromPartial(e)) || [];
        return message;
    },
};

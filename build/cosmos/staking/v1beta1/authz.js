...
exports.StakeAuthorization = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.maxTokens))
            obj.maxTokens = coin_js_1.Coin.fromJSON(object.maxTokens);
        if ((0, helpers_js_1.isSet)(object.allowList))
            obj.allowList = exports.StakeAuthorization_Validators.fromJSON(object.allowList);
        if ((0, helpers_js_1.isSet)(object.denyList))
            obj.denyList = exports.StakeAuthorization_Validators.fromJSON(object.denyList);
        if ((0, helpers_js_1.isSet)(object.authorizationType))
    ...
    toJSON(message) {
        ...
        message.maxTokens !== undefined &&
            (obj.maxTokens = message.maxTokens ? coin_js_1.Coin.toJSON(message.maxTokens) : undefined);
    ...
    fromPartial(object) {
        ...
        if (object.maxTokens !== undefined && object.maxTokens !== null) {
            message.maxTokens = coin_js_1.Coin.fromPartial(object.maxTokens);
        }

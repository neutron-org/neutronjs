...
exports.LegacyAminoPubKey = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.publicKeys))
            obj.publicKeys = object.publicKeys.map((e) => any_js_1.Any.fromJSON(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.publicKeys) {
            obj.publicKeys = message.publicKeys.map((e) => (e ? any_js_1.Any.toJSON(e) : undefined));
        }
        else {
            obj.publicKeys = [];
        }
    ...
    fromPartial(object) {
        ...
        message.publicKeys = object.publicKeys?.map((e) => any_js_1.Any.fromPartial(e)) || [];
        return message;
    },
};

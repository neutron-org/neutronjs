...
const hd_js_1 = require("../../hd/v1/hd.js");
...
exports.Record = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.local))
            obj.local = exports.Record_Local.fromJSON(object.local);
        if ((0, helpers_js_1.isSet)(object.ledger))
        ...
        if ((0, helpers_js_1.isSet)(object.offline))
...
exports.Record_Local = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        if (message.privKey !== undefined) {
            any_js_1.Any.encode(message.privKey, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.privKey = any_js_1.Any.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.privKey))
            obj.privKey = any_js_1.Any.fromJSON(object.privKey);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.privKey !== undefined &&
            (obj.privKey = message.privKey ? any_js_1.Any.toJSON(message.privKey) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseRecord_Local();
        if (object.privKey !== undefined && object.privKey !== null) {
            message.privKey = any_js_1.Any.fromPartial(object.privKey);
        }
        return message;
    },
};
...
exports.Record_Ledger = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        if (message.path !== undefined) {
            hd_js_1.BIP44Params.encode(message.path, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.path = hd_js_1.BIP44Params.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.path))
            obj.path = hd_js_1.BIP44Params.fromJSON(object.path);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.path !== undefined && (obj.path = message.path ? hd_js_1.BIP44Params.toJSON(message.path) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseRecord_Ledger();
        if (object.path !== undefined && object.path !== null) {
            message.path = hd_js_1.BIP44Params.fromPartial(object.path);
        }
        return message;
    },
};

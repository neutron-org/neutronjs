...
exports.QueryUpgradedConsensusStateRequest = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.lastHeight))
...
exports.QueryUpgradedConsensusStateResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.upgradedConsensusState))
            obj.upgradedConsensusState = (0, helpers_js_1.bytesFromBase64)(object.upgradedConsensusState);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.upgradedConsensusState !== undefined &&
            (obj.upgradedConsensusState = (0, helpers_js_1.base64FromBytes)(message.upgradedConsensusState !== undefined ? message.upgradedConsensusState : new Uint8Array()));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseQueryUpgradedConsensusStateResponse();
...
exports.QueryModuleVersionsResponse = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.moduleVersions))
            obj.moduleVersions = object.moduleVersions.map((e) => upgrade_js_1.ModuleVersion.fromJSON(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
        if (message.moduleVersions) {
            obj.moduleVersions = message.moduleVersions.map((e) => (e ? upgrade_js_1.ModuleVersion.toJSON(e) : undefined));
        }
        else {
            obj.moduleVersions = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseQueryModuleVersionsResponse();
        message.moduleVersions = object.moduleVersions?.map((e) => upgrade_js_1.ModuleVersion.fromPartial(e)) || [];
        return message;
    },
};

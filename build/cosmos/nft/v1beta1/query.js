...
exports.QueryBalanceRequest = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.classId))
...
exports.QueryNFTsResponse = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        for (const v of message.nfts) {
            nft_js_1.NFT.encode(v, writer.uint32(10).fork()).ldelim();
        }
        if (message.pagination !== undefined) {
...
exports.QueryNFTResponse = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        if (message.nft !== undefined) {
            nft_js_1.NFT.encode(message.nft, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.nft = nft_js_1.NFT.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.nft))
            obj.nft = nft_js_1.NFT.fromJSON(object.nft);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.nft !== undefined && (obj.nft = message.nft ? nft_js_1.NFT.toJSON(message.nft) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseQueryNFTResponse();
        if (object.nft !== undefined && object.nft !== null) {
            message.nft = nft_js_1.NFT.fromPartial(object.nft);
        }
        return message;
    },
};
...
exports.QueryClassResponse = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        if (message.class !== undefined) {
            nft_js_1.Class.encode(message.class, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.class = nft_js_1.Class.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.class))
            obj.class = nft_js_1.Class.fromJSON(object.class);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.class !== undefined && (obj.class = message.class ? nft_js_1.Class.toJSON(message.class) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseQueryClassResponse();
        if (object.class !== undefined && object.class !== null) {
            message.class = nft_js_1.Class.fromPartial(object.class);
        }
        return message;
    },
};

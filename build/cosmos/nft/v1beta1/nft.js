...
exports.Class = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.data !== undefined) {
            any_js_1.Any.encode(message.data, writer.uint32(58).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.data))
            obj.data = any_js_1.Any.fromJSON(object.data);
        return obj;
    },
    toJSON(message) {
        const obj = {};
    ...
    fromPartial(object) {
        ...
        if (object.data !== undefined && object.data !== null) {
            message.data = any_js_1.Any.fromPartial(object.data);
        }
        return message;
    },
};
...
exports.NFT = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.data !== undefined) {
            any_js_1.Any.encode(message.data, writer.uint32(82).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {

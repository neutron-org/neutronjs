...
const signing_js_1 = require("../signing/v1beta1/signing.js");
const multisig_js_1 = require("../../crypto/multisig/v1beta1/multisig.js");
...
exports.Tx = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.body))
            obj.body = exports.TxBody.fromJSON(object.body);
        if ((0, helpers_js_1.isSet)(object.authInfo))
            obj.authInfo = exports.AuthInfo.fromJSON(object.authInfo);
        if (Array.isArray(object?.signatures))
            obj.signatures = object.signatures.map((e) => (0, helpers_js_1.bytesFromBase64)(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.signatures) {
            obj.signatures = message.signatures.map((e) => (0, helpers_js_1.base64FromBytes)(e !== undefined ? e : new Uint8Array()));
        }
        else {
            obj.signatures = [];
        }
...
exports.TxRaw = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.bodyBytes))
            obj.bodyBytes = (0, helpers_js_1.bytesFromBase64)(object.bodyBytes);
        if ((0, helpers_js_1.isSet)(object.authInfoBytes))
            obj.authInfoBytes = (0, helpers_js_1.bytesFromBase64)(object.authInfoBytes);
        if (Array.isArray(object?.signatures))
            obj.signatures = object.signatures.map((e) => (0, helpers_js_1.bytesFromBase64)(e));
        return obj;
    },
    toJSON(message) {
        ...
        message.bodyBytes !== undefined &&
            (obj.bodyBytes = (0, helpers_js_1.base64FromBytes)(message.bodyBytes !== undefined ? message.bodyBytes : new Uint8Array()));
        message.authInfoBytes !== undefined &&
            (obj.authInfoBytes = (0, helpers_js_1.base64FromBytes)(message.authInfoBytes !== undefined ? message.authInfoBytes : new Uint8Array()));
        if (message.signatures) {
            obj.signatures = message.signatures.map((e) => (0, helpers_js_1.base64FromBytes)(e !== undefined ? e : new Uint8Array()));
        }
        else {
...
exports.SignDoc = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.accountNumber))
...
exports.SignDocDirectAux = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.publicKey !== undefined) {
            any_js_1.Any.encode(message.publicKey, writer.uint32(18).fork()).ldelim();
        }
        if (message.chainId !== "") {
            writer.uint32(26).string(message.chainId);
        }
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.tip))
...
exports.TxBody = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.timeoutTimestamp !== undefined) {
            timestamp_js_1.Timestamp.encode(message.timeoutTimestamp, writer.uint32(42).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    message.timeoutTimestamp = timestamp_js_1.Timestamp.decode(reader, reader.uint32());
                    break;
                case 1023:
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.timeoutHeight))
            obj.timeoutHeight = BigInt(object.timeoutHeight.toString());
        if ((0, helpers_js_1.isSet)(object.unordered))
            obj.unordered = Boolean(object.unordered);
        if ((0, helpers_js_1.isSet)(object.timeoutTimestamp))
            obj.timeoutTimestamp = (0, helpers_js_1.fromJsonTimestamp)(object.timeoutTimestamp);
        if (Array.isArray(object?.extensionOptions))
            obj.extensionOptions = object.extensionOptions.map((e) => any_js_1.Any.fromJSON(e));
        if (Array.isArray(object?.nonCriticalExtensionOptions))
            obj.nonCriticalExtensionOptions = object.nonCriticalExtensionOptions.map((e) => any_js_1.Any.fromJSON(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.timeoutTimestamp !== undefined &&
            (obj.timeoutTimestamp = (0, helpers_js_1.fromTimestamp)(message.timeoutTimestamp).toISOString());
        if (message.extensionOptions) {
            obj.extensionOptions = message.extensionOptions.map((e) => (e ? any_js_1.Any.toJSON(e) : undefined));
        }
        else {
            obj.extensionOptions = [];
        }
        if (message.nonCriticalExtensionOptions) {
            obj.nonCriticalExtensionOptions = message.nonCriticalExtensionOptions.map((e) => e ? any_js_1.Any.toJSON(e) : undefined);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.timeoutTimestamp !== undefined && object.timeoutTimestamp !== null) {
            message.timeoutTimestamp = timestamp_js_1.Timestamp.fromPartial(object.timeoutTimestamp);
        }
        message.extensionOptions = object.extensionOptions?.map((e) => any_js_1.Any.fromPartial(e)) || [];
        message.nonCriticalExtensionOptions =
            object.nonCriticalExtensionOptions?.map((e) => any_js_1.Any.fromPartial(e)) || [];
        return message;
    },
};
...
exports.SignerInfo = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.publicKey))
            obj.publicKey = any_js_1.Any.fromJSON(object.publicKey);
        if ((0, helpers_js_1.isSet)(object.modeInfo))
...
exports.ModeInfo = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.single))
            obj.single = exports.ModeInfo_Single.fromJSON(object.single);
        if ((0, helpers_js_1.isSet)(object.multi))
...
exports.ModeInfo_Single = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.mode))
            obj.mode = (0, signing_js_1.signModeFromJSON)(object.mode);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.mode !== undefined && (obj.mode = (0, signing_js_1.signModeToJSON)(message.mode));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseModeInfo_Single();
...
exports.ModeInfo_Multi = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.bitarray))
            obj.bitarray = multisig_js_1.CompactBitArray.fromJSON(object.bitarray);
    ...
    toJSON(message) {
        ...
        message.bitarray !== undefined &&
            (obj.bitarray = message.bitarray ? multisig_js_1.CompactBitArray.toJSON(message.bitarray) : undefined);
    ...
    fromPartial(object) {
        ...
        if (object.bitarray !== undefined && object.bitarray !== null) {
            message.bitarray = multisig_js_1.CompactBitArray.fromPartial(object.bitarray);
        }
...
exports.Tip = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.amount))
            obj.amount = object.amount.map((e) => coin_js_1.Coin.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.tipper))
...
exports.AuxSignerData = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.signDoc))
            obj.signDoc = exports.SignDocDirectAux.fromJSON(object.signDoc);
        if ((0, helpers_js_1.isSet)(object.mode))
            obj.mode = (0, signing_js_1.signModeFromJSON)(object.mode);
        if ((0, helpers_js_1.isSet)(object.sig))
            obj.sig = (0, helpers_js_1.bytesFromBase64)(object.sig);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.sig !== undefined &&
            (obj.sig = (0, helpers_js_1.base64FromBytes)(message.sig !== undefined ? message.sig : new Uint8Array()));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseAuxSignerData();

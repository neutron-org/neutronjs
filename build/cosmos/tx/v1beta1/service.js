...
const abci_js_1 = require("../../base/abci/v1beta1/abci.js");
const types_js_1 = require("../../../tendermint/types/types.js");
const block_js_1 = require("../../../tendermint/types/block.js");
...
exports.GetTxsEventRequest = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.orderBy))
            obj.orderBy = orderByFromJSON(object.orderBy);
        if ((0, helpers_js_1.isSet)(object.page))
...
exports.GetTxsEventResponse = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.txs))
            obj.txs = object.txs.map((e) => tx_js_1.Tx.fromJSON(e));
        if (Array.isArray(object?.txResponses))
            obj.txResponses = object.txResponses.map((e) => abci_js_1.TxResponse.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.pagination))
    ...
    toJSON(message) {
        const obj = {};
        if (message.txs) {
            obj.txs = message.txs.map((e) => (e ? tx_js_1.Tx.toJSON(e) : undefined));
        }
        else {
            obj.txs = [];
        }
        if (message.txResponses) {
            obj.txResponses = message.txResponses.map((e) => (e ? abci_js_1.TxResponse.toJSON(e) : undefined));
        }
        else {
            obj.txResponses = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseGetTxsEventResponse();
        message.txs = object.txs?.map((e) => tx_js_1.Tx.fromPartial(e)) || [];
        message.txResponses = object.txResponses?.map((e) => abci_js_1.TxResponse.fromPartial(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
...
exports.BroadcastTxRequest = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.txBytes))
            obj.txBytes = (0, helpers_js_1.bytesFromBase64)(object.txBytes);
    ...
    toJSON(message) {
        ...
        message.txBytes !== undefined &&
            (obj.txBytes = (0, helpers_js_1.base64FromBytes)(message.txBytes !== undefined ? message.txBytes : new Uint8Array()));
...
exports.BroadcastTxResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.txResponse))
            obj.txResponse = abci_js_1.TxResponse.fromJSON(object.txResponse);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.txResponse !== undefined &&
            (obj.txResponse = message.txResponse ? abci_js_1.TxResponse.toJSON(message.txResponse) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseBroadcastTxResponse();
        if (object.txResponse !== undefined && object.txResponse !== null) {
            message.txResponse = abci_js_1.TxResponse.fromPartial(object.txResponse);
        }
        return message;
    },
};
...
exports.SimulateRequest = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.tx))
            obj.tx = tx_js_1.Tx.fromJSON(object.tx);
        if ((0, helpers_js_1.isSet)(object.txBytes))
            obj.txBytes = (0, helpers_js_1.bytesFromBase64)(object.txBytes);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.tx !== undefined && (obj.tx = message.tx ? tx_js_1.Tx.toJSON(message.tx) : undefined);
        message.txBytes !== undefined &&
            (obj.txBytes = (0, helpers_js_1.base64FromBytes)(message.txBytes !== undefined ? message.txBytes : new Uint8Array()));
        return obj;
    },
    fromPartial(object) {
        ...
        if (object.tx !== undefined && object.tx !== null) {
            message.tx = tx_js_1.Tx.fromPartial(object.tx);
        }
        message.txBytes = object.txBytes ?? new Uint8Array();
        return message;
    },
...
exports.SimulateResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.gasInfo))
            obj.gasInfo = abci_js_1.GasInfo.fromJSON(object.gasInfo);
        if ((0, helpers_js_1.isSet)(object.result))
            obj.result = abci_js_1.Result.fromJSON(object.result);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.gasInfo !== undefined &&
            (obj.gasInfo = message.gasInfo ? abci_js_1.GasInfo.toJSON(message.gasInfo) : undefined);
        message.result !== undefined && (obj.result = message.result ? abci_js_1.Result.toJSON(message.result) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseSimulateResponse();
        if (object.gasInfo !== undefined && object.gasInfo !== null) {
            message.gasInfo = abci_js_1.GasInfo.fromPartial(object.gasInfo);
        }
        if (object.result !== undefined && object.result !== null) {
            message.result = abci_js_1.Result.fromPartial(object.result);
        }
        return message;
    },
};
...
exports.GetBlockWithTxsResponse = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.blockId !== undefined) {
            types_js_1.BlockID.encode(message.blockId, writer.uint32(18).fork()).ldelim();
        }
        if (message.block !== undefined) {
            block_js_1.Block.encode(message.block, writer.uint32(26).fork()).ldelim();
        }
        if (message.pagination !== undefined) {
            pagination_js_1.PageResponse.encode(message.pagination, writer.uint32(34).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.blockId))
            obj.blockId = types_js_1.BlockID.fromJSON(object.blockId);
        if ((0, helpers_js_1.isSet)(object.block))
            obj.block = block_js_1.Block.fromJSON(object.block);
        if ((0, helpers_js_1.isSet)(object.pagination))
            obj.pagination = pagination_js_1.PageResponse.fromJSON(object.pagination);
        return obj;
    },
    toJSON(message) {
        ...
        message.blockId !== undefined &&
            (obj.blockId = message.blockId ? types_js_1.BlockID.toJSON(message.blockId) : undefined);
        message.block !== undefined && (obj.block = message.block ? block_js_1.Block.toJSON(message.block) : undefined);
        message.pagination !== undefined &&
            (obj.pagination = message.pagination ? pagination_js_1.PageResponse.toJSON(message.pagination) : undefined);
        return obj;
    },
    fromPartial(object) {
        ...
        if (object.blockId !== undefined && object.blockId !== null) {
            message.blockId = types_js_1.BlockID.fromPartial(object.blockId);
        }
        if (object.block !== undefined && object.block !== null) {
            message.block = block_js_1.Block.fromPartial(object.block);
        }
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_js_1.PageResponse.fromPartial(object.pagination);
        }
...
exports.TxEncodeAminoRequest = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.aminoJson))
...
exports.TxEncodeAminoResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.aminoBinary))
            obj.aminoBinary = (0, helpers_js_1.bytesFromBase64)(object.aminoBinary);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.aminoBinary !== undefined &&
            (obj.aminoBinary = (0, helpers_js_1.base64FromBytes)(message.aminoBinary !== undefined ? message.aminoBinary : new Uint8Array()));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseTxEncodeAminoResponse();

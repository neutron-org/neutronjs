...
exports.QueryAllBalancesRequest = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.resolveDenom))
...
exports.QueryAllBalancesResponse = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.balances))
            obj.balances = object.balances.map((e) => coin_js_1.Coin.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.pagination))
    ...
    toJSON(message) {
        const obj = {};
        if (message.balances) {
            obj.balances = message.balances.map((e) => (e ? coin_js_1.Coin.toJSON(e) : undefined));
        }
        else {
            obj.balances = [];
        }
...
exports.QueryTotalSupplyResponse = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.supply))
            obj.supply = object.supply.map((e) => coin_js_1.Coin.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.pagination))
            obj.pagination = pagination_js_1.PageResponse.fromJSON(object.pagination);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        if (message.supply) {
            obj.supply = message.supply.map((e) => (e ? coin_js_1.Coin.toJSON(e) : undefined));
        }
        else {
            obj.supply = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseQueryTotalSupplyResponse();
        message.supply = object.supply?.map((e) => coin_js_1.Coin.fromPartial(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_js_1.PageResponse.fromPartial(object.pagination);
        }
        return message;
...
exports.QueryDenomsMetadataResponse = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.metadatas))
            obj.metadatas = object.metadatas.map((e) => bank_js_1.Metadata.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.pagination))
            obj.pagination = pagination_js_1.PageResponse.fromJSON(object.pagination);
        return obj;
    },
    toJSON(message) {
        ...
        if (message.metadatas) {
            obj.metadatas = message.metadatas.map((e) => (e ? bank_js_1.Metadata.toJSON(e) : undefined));
        }
        else {
            obj.metadatas = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseQueryDenomsMetadataResponse();
        message.metadatas = object.metadatas?.map((e) => bank_js_1.Metadata.fromPartial(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_js_1.PageResponse.fromPartial(object.pagination);
        }
        return message;
...
exports.QuerySendEnabledRequest = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.pagination !== undefined) {
            pagination_js_1.PageRequest.encode(message.pagination, writer.uint32(794).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.QuerySendEnabledResponse = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        for (const v of message.sendEnabled) {
            bank_js_1.SendEnabled.encode(v, writer.uint32(10).fork()).ldelim();
        }
        if (message.pagination !== undefined) {
            pagination_js_1.PageResponse.encode(message.pagination, writer.uint32(794).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.sendEnabled.push(bank_js_1.SendEnabled.decode(reader, reader.uint32()));
                    break;
                case 99:
                    message.pagination = pagination_js_1.PageResponse.decode(reader, reader.uint32());
                    break;
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.sendEnabled))
            obj.sendEnabled = object.sendEnabled.map((e) => bank_js_1.SendEnabled.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.pagination))
            obj.pagination = pagination_js_1.PageResponse.fromJSON(object.pagination);
        return obj;
    },
    toJSON(message) {
        ...
        if (message.sendEnabled) {
            obj.sendEnabled = message.sendEnabled.map((e) => (e ? bank_js_1.SendEnabled.toJSON(e) : undefined));
        }
        else {
            obj.sendEnabled = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseQuerySendEnabledResponse();
        message.sendEnabled = object.sendEnabled?.map((e) => bank_js_1.SendEnabled.fromPartial(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_js_1.PageResponse.fromPartial(object.pagination);
        }
        return message;

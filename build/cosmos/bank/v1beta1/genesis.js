...
exports.GenesisState = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        for (const v of message.sendEnabled) {
            bank_js_1.SendEnabled.encode(v, writer.uint32(42).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.denomMetadata))
            obj.denomMetadata = object.denomMetadata.map((e) => bank_js_1.Metadata.fromJSON(e));
    ...
    toJSON(message) {
        ...
        if (message.denomMetadata) {
            obj.denomMetadata = message.denomMetadata.map((e) => (e ? bank_js_1.Metadata.toJSON(e) : undefined));
        }
        else {
            obj.denomMetadata = [];
        }
    ...
    fromPartial(object) {
        ...
        message.denomMetadata = object.denomMetadata?.map((e) => bank_js_1.Metadata.fromPartial(e)) || [];
...
exports.Balance = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.coins))
            obj.coins = object.coins.map((e) => coin_js_1.Coin.fromJSON(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.coins) {
            obj.coins = message.coins.map((e) => (e ? coin_js_1.Coin.toJSON(e) : undefined));
        }
        else {
            obj.coins = [];
        }
    ...
    fromPartial(object) {
        ...
        message.coins = object.coins?.map((e) => coin_js_1.Coin.fromPartial(e)) || [];
        return message;
    },
};

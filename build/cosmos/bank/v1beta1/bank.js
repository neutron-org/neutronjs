...
exports.Params = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.defaultSendEnabled))
...
exports.Supply = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.total))
            obj.total = object.total.map((e) => coin_js_1.Coin.fromJSON(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
        if (message.total) {
            obj.total = message.total.map((e) => (e ? coin_js_1.Coin.toJSON(e) : undefined));
        }
        else {
            obj.total = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseSupply();
        message.total = object.total?.map((e) => coin_js_1.Coin.fromPartial(e)) || [];
        return message;
    },
};
...
exports.DenomUnit = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.denom))
            obj.denom = String(object.denom);
        if ((0, helpers_js_1.isSet)(object.exponent))

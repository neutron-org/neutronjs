...
exports.MsgSend = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.toAddress))
...
exports.MsgMultiSend = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.inputs))
            obj.inputs = object.inputs.map((e) => bank_js_1.Input.fromJSON(e));
        if (Array.isArray(object?.outputs))
            obj.outputs = object.outputs.map((e) => bank_js_1.Output.fromJSON(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
        if (message.inputs) {
            obj.inputs = message.inputs.map((e) => (e ? bank_js_1.Input.toJSON(e) : undefined));
        }
        else {
            obj.inputs = [];
        }
        if (message.outputs) {
            obj.outputs = message.outputs.map((e) => (e ? bank_js_1.Output.toJSON(e) : undefined));
        }
        else {
            obj.outputs = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseMsgMultiSend();
        message.inputs = object.inputs?.map((e) => bank_js_1.Input.fromPartial(e)) || [];
        message.outputs = object.outputs?.map((e) => bank_js_1.Output.fromPartial(e)) || [];
        return message;
    },
};
...
exports.MsgSetSendEnabled = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        for (const v of message.sendEnabled) {
            bank_js_1.SendEnabled.encode(v, writer.uint32(18).fork()).ldelim();
        }

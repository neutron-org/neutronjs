...
function createBaseMember() {
    return {
        ...
        weight: "",
        metadata: "",
        addedAt: timestamp_js_1.Timestamp.fromPartial({}),
    };
}
exports.Member = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.addedAt !== undefined) {
            timestamp_js_1.Timestamp.encode(message.addedAt, writer.uint32(34).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.addedAt = timestamp_js_1.Timestamp.decode(reader, reader.uint32());
                    break;
                default:
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.addedAt))
            obj.addedAt = (0, helpers_js_1.fromJsonTimestamp)(object.addedAt);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.addedAt !== undefined && (obj.addedAt = (0, helpers_js_1.fromTimestamp)(message.addedAt).toISOString());
        return obj;
    },
    fromPartial(object) {
        const message = createBaseMember();
        ...
        if (object.addedAt !== undefined && object.addedAt !== null) {
            message.addedAt = timestamp_js_1.Timestamp.fromPartial(object.addedAt);
        }
        return message;
    },
};
...
exports.ThresholdDecisionPolicy = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.windows))
...
function createBaseDecisionPolicyWindows() {
    return {
        votingPeriod: duration_js_1.Duration.fromPartial({}),
        minExecutionPeriod: duration_js_1.Duration.fromPartial({}),
    };
}
exports.DecisionPolicyWindows = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.minExecutionPeriod !== undefined) {
            duration_js_1.Duration.encode(message.minExecutionPeriod, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.minExecutionPeriod = duration_js_1.Duration.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.minExecutionPeriod))
            obj.minExecutionPeriod = duration_js_1.Duration.fromJSON(object.minExecutionPeriod);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.minExecutionPeriod !== undefined &&
            (obj.minExecutionPeriod = message.minExecutionPeriod
                ? duration_js_1.Duration.toJSON(message.minExecutionPeriod)
                : undefined);
        return obj;
    },
    fromPartial(object) {
        ...
        if (object.minExecutionPeriod !== undefined && object.minExecutionPeriod !== null) {
            message.minExecutionPeriod = duration_js_1.Duration.fromPartial(object.minExecutionPeriod);
        }
        return message;
    },
};
function createBaseGroupInfo() {
    return {
        ...
        version: BigInt(0),
        totalWeight: "",
        createdAt: timestamp_js_1.Timestamp.fromPartial({}),
    };
}
exports.GroupInfo = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.createdAt !== undefined) {
            timestamp_js_1.Timestamp.encode(message.createdAt, writer.uint32(50).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    message.createdAt = timestamp_js_1.Timestamp.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.totalWeight))
            obj.totalWeight = String(object.totalWeight);
        if ((0, helpers_js_1.isSet)(object.createdAt))
            obj.createdAt = (0, helpers_js_1.fromJsonTimestamp)(object.createdAt);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.createdAt !== undefined && (obj.createdAt = (0, helpers_js_1.fromTimestamp)(message.createdAt).toISOString());
        return obj;
    },
    fromPartial(object) {
        const message = createBaseGroupInfo();
        ...
        if (object.createdAt !== undefined && object.createdAt !== null) {
            message.createdAt = timestamp_js_1.Timestamp.fromPartial(object.createdAt);
        }
        return message;
    },
};
...
exports.GroupMember = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.groupId))
            obj.groupId = BigInt(object.groupId.toString());
        if ((0, helpers_js_1.isSet)(object.member))
...
exports.GroupPolicyInfo = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.decisionPolicy !== undefined) {
            any_js_1.Any.encode(message.decisionPolicy, writer.uint32(50).fork()).ldelim();
        }
        if (message.createdAt !== undefined) {
            timestamp_js_1.Timestamp.encode(message.createdAt, writer.uint32(58).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    message.decisionPolicy = any_js_1.Any.decode(reader, reader.uint32());
                    break;
                case 7:
                    message.createdAt = timestamp_js_1.Timestamp.decode(reader, reader.uint32());
                    break;
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.version))
            obj.version = BigInt(object.version.toString());
        if ((0, helpers_js_1.isSet)(object.decisionPolicy))
            obj.decisionPolicy = any_js_1.Any.fromJSON(object.decisionPolicy);
        if ((0, helpers_js_1.isSet)(object.createdAt))
            obj.createdAt = (0, helpers_js_1.fromJsonTimestamp)(object.createdAt);
        return obj;
    },
    toJSON(message) {
        ...
        message.decisionPolicy !== undefined &&
            (obj.decisionPolicy = message.decisionPolicy ? any_js_1.Any.toJSON(message.decisionPolicy) : undefined);
        message.createdAt !== undefined && (obj.createdAt = (0, helpers_js_1.fromTimestamp)(message.createdAt).toISOString());
        return obj;
    },
    fromPartial(object) {
        ...
        if (object.decisionPolicy !== undefined && object.decisionPolicy !== null) {
            message.decisionPolicy = any_js_1.Any.fromPartial(object.decisionPolicy);
        }
        if (object.createdAt !== undefined && object.createdAt !== null) {
            message.createdAt = timestamp_js_1.Timestamp.fromPartial(object.createdAt);
        }
...
function createBaseProposal() {
    return {
        ...
        metadata: "",
        proposers: [],
        submitTime: timestamp_js_1.Timestamp.fromPartial({}),
        groupVersion: BigInt(0),
        groupPolicyVersion: BigInt(0),
        status: 0,
        finalTallyResult: exports.TallyResult.fromPartial({}),
        votingPeriodEnd: timestamp_js_1.Timestamp.fromPartial({}),
        executorResult: 0,
        messages: [],
        title: "",
        summary: "",
...
exports.Proposal = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.votingPeriodEnd !== undefined) {
            timestamp_js_1.Timestamp.encode(message.votingPeriodEnd, writer.uint32(82).fork()).ldelim();
        }
        if (message.executorResult !== 0) {
            writer.uint32(88).int32(message.executorResult);
        }
        for (const v of message.messages) {
            any_js_1.Any.encode(v, writer.uint32(98).fork()).ldelim();
        }
        if (message.title !== "") {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    message.votingPeriodEnd = timestamp_js_1.Timestamp.decode(reader, reader.uint32());
                    break;
                case 11:
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.id))
            obj.id = BigInt(object.id.toString());
        if ((0, helpers_js_1.isSet)(object.groupPolicyAddress))
        ...
        if ((0, helpers_js_1.isSet)(object.groupVersion))
            obj.groupVersion = BigInt(object.groupVersion.toString());
        if ((0, helpers_js_1.isSet)(object.groupPolicyVersion))
        ...
        if ((0, helpers_js_1.isSet)(object.votingPeriodEnd))
            obj.votingPeriodEnd = (0, helpers_js_1.fromJsonTimestamp)(object.votingPeriodEnd);
        if ((0, helpers_js_1.isSet)(object.executorResult))
    ...
    toJSON(message) {
        ...
        message.votingPeriodEnd !== undefined &&
            (obj.votingPeriodEnd = (0, helpers_js_1.fromTimestamp)(message.votingPeriodEnd).toISOString());
    ...
    fromPartial(object) {
        ...
        if (object.votingPeriodEnd !== undefined && object.votingPeriodEnd !== null) {
            message.votingPeriodEnd = timestamp_js_1.Timestamp.fromPartial(object.votingPeriodEnd);
        }

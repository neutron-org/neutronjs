...
exports.QueryGroupInfoResponse = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        if (message.info !== undefined) {
            types_js_1.GroupInfo.encode(message.info, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.info = types_js_1.GroupInfo.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.info))
            obj.info = types_js_1.GroupInfo.fromJSON(object.info);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.info !== undefined && (obj.info = message.info ? types_js_1.GroupInfo.toJSON(message.info) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseQueryGroupInfoResponse();
        if (object.info !== undefined && object.info !== null) {
            message.info = types_js_1.GroupInfo.fromPartial(object.info);
        }
        return message;
    },
};
...
exports.QueryGroupPolicyInfoResponse = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        if (message.info !== undefined) {
            types_js_1.GroupPolicyInfo.encode(message.info, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.info = types_js_1.GroupPolicyInfo.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.info))
            obj.info = types_js_1.GroupPolicyInfo.fromJSON(object.info);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.info !== undefined &&
            (obj.info = message.info ? types_js_1.GroupPolicyInfo.toJSON(message.info) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseQueryGroupPolicyInfoResponse();
        if (object.info !== undefined && object.info !== null) {
            message.info = types_js_1.GroupPolicyInfo.fromPartial(object.info);
        }
        return message;
    },
};
...
exports.QueryGroupMembersResponse = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        for (const v of message.members) {
            types_js_1.GroupMember.encode(v, writer.uint32(10).fork()).ldelim();
        }
        if (message.pagination !== undefined) {
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.members.push(types_js_1.GroupMember.decode(reader, reader.uint32()));
                    break;
                case 2:
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.members))
            obj.members = object.members.map((e) => types_js_1.GroupMember.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.pagination))
    ...
    toJSON(message) {
        const obj = {};
        if (message.members) {
            obj.members = message.members.map((e) => (e ? types_js_1.GroupMember.toJSON(e) : undefined));
        }
        else {
            obj.members = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseQueryGroupMembersResponse();
        message.members = object.members?.map((e) => types_js_1.GroupMember.fromPartial(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
...
exports.QueryGroupsByAdminResponse = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        for (const v of message.groups) {
            types_js_1.GroupInfo.encode(v, writer.uint32(10).fork()).ldelim();
        }
        if (message.pagination !== undefined) {
            pagination_js_1.PageResponse.encode(message.pagination, writer.uint32(18).fork()).ldelim();
        }
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.groups.push(types_js_1.GroupInfo.decode(reader, reader.uint32()));
                    break;
                case 2:
                    message.pagination = pagination_js_1.PageResponse.decode(reader, reader.uint32());
                    break;
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.groups))
            obj.groups = object.groups.map((e) => types_js_1.GroupInfo.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.pagination))
            obj.pagination = pagination_js_1.PageResponse.fromJSON(object.pagination);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        if (message.groups) {
            obj.groups = message.groups.map((e) => (e ? types_js_1.GroupInfo.toJSON(e) : undefined));
        }
        else {
            obj.groups = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseQueryGroupsByAdminResponse();
        message.groups = object.groups?.map((e) => types_js_1.GroupInfo.fromPartial(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_js_1.PageResponse.fromPartial(object.pagination);
        }
        return message;
...
exports.QueryGroupPoliciesByGroupResponse = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        for (const v of message.groupPolicies) {
            types_js_1.GroupPolicyInfo.encode(v, writer.uint32(10).fork()).ldelim();
        }
        if (message.pagination !== undefined) {
            pagination_js_1.PageResponse.encode(message.pagination, writer.uint32(18).fork()).ldelim();
        }
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.groupPolicies.push(types_js_1.GroupPolicyInfo.decode(reader, reader.uint32()));
                    break;
                case 2:
                    message.pagination = pagination_js_1.PageResponse.decode(reader, reader.uint32());
                    break;
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.groupPolicies))
            obj.groupPolicies = object.groupPolicies.map((e) => types_js_1.GroupPolicyInfo.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.pagination))
            obj.pagination = pagination_js_1.PageResponse.fromJSON(object.pagination);
        return obj;
    },
    toJSON(message) {
        ...
        if (message.groupPolicies) {
            obj.groupPolicies = message.groupPolicies.map((e) => (e ? types_js_1.GroupPolicyInfo.toJSON(e) : undefined));
        }
        else {
            obj.groupPolicies = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseQueryGroupPoliciesByGroupResponse();
        message.groupPolicies = object.groupPolicies?.map((e) => types_js_1.GroupPolicyInfo.fromPartial(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_js_1.PageResponse.fromPartial(object.pagination);
        }
        return message;
...
exports.QueryProposalResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.proposal))
            obj.proposal = types_js_1.Proposal.fromJSON(object.proposal);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.proposal !== undefined &&
            (obj.proposal = message.proposal ? types_js_1.Proposal.toJSON(message.proposal) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseQueryProposalResponse();
        if (object.proposal !== undefined && object.proposal !== null) {
            message.proposal = types_js_1.Proposal.fromPartial(object.proposal);
        }
        return message;
    },
};
...
exports.QueryProposalsByGroupPolicyResponse = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        for (const v of message.proposals) {
            types_js_1.Proposal.encode(v, writer.uint32(10).fork()).ldelim();
        }
        if (message.pagination !== undefined) {
            pagination_js_1.PageResponse.encode(message.pagination, writer.uint32(18).fork()).ldelim();
        }
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.proposals.push(types_js_1.Proposal.decode(reader, reader.uint32()));
                    break;
                case 2:
                    message.pagination = pagination_js_1.PageResponse.decode(reader, reader.uint32());
                    break;
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.proposals))
            obj.proposals = object.proposals.map((e) => types_js_1.Proposal.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.pagination))
            obj.pagination = pagination_js_1.PageResponse.fromJSON(object.pagination);
        return obj;
    },
    toJSON(message) {
        ...
        if (message.proposals) {
            obj.proposals = message.proposals.map((e) => (e ? types_js_1.Proposal.toJSON(e) : undefined));
        }
        else {
            obj.proposals = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseQueryProposalsByGroupPolicyResponse();
        message.proposals = object.proposals?.map((e) => types_js_1.Proposal.fromPartial(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_js_1.PageResponse.fromPartial(object.pagination);
        }
        return message;
...
exports.QueryVoteByProposalVoterResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.vote))
            obj.vote = types_js_1.Vote.fromJSON(object.vote);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.vote !== undefined && (obj.vote = message.vote ? types_js_1.Vote.toJSON(message.vote) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseQueryVoteByProposalVoterResponse();
        if (object.vote !== undefined && object.vote !== null) {
            message.vote = types_js_1.Vote.fromPartial(object.vote);
        }
        return message;
    },
};
...
exports.QueryVotesByProposalResponse = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        for (const v of message.votes) {
            types_js_1.Vote.encode(v, writer.uint32(10).fork()).ldelim();
        }
        if (message.pagination !== undefined) {
            pagination_js_1.PageResponse.encode(message.pagination, writer.uint32(18).fork()).ldelim();
        }
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.votes.push(types_js_1.Vote.decode(reader, reader.uint32()));
                    break;
                case 2:
                    message.pagination = pagination_js_1.PageResponse.decode(reader, reader.uint32());
                    break;
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.votes))
            obj.votes = object.votes.map((e) => types_js_1.Vote.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.pagination))
            obj.pagination = pagination_js_1.PageResponse.fromJSON(object.pagination);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        if (message.votes) {
            obj.votes = message.votes.map((e) => (e ? types_js_1.Vote.toJSON(e) : undefined));
        }
        else {
            obj.votes = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseQueryVotesByProposalResponse();
        message.votes = object.votes?.map((e) => types_js_1.Vote.fromPartial(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_js_1.PageResponse.fromPartial(object.pagination);
        }
        return message;
...
function createBaseQueryTallyResultResponse() {
    return {
        tally: types_js_1.TallyResult.fromPartial({}),
    };
}
exports.QueryTallyResultResponse = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        if (message.tally !== undefined) {
            types_js_1.TallyResult.encode(message.tally, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.tally = types_js_1.TallyResult.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.tally))
            obj.tally = types_js_1.TallyResult.fromJSON(object.tally);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.tally !== undefined &&
            (obj.tally = message.tally ? types_js_1.TallyResult.toJSON(message.tally) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseQueryTallyResultResponse();
        if (object.tally !== undefined && object.tally !== null) {
            message.tally = types_js_1.TallyResult.fromPartial(object.tally);
        }
        return message;
    },
};

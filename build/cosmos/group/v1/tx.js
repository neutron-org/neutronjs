...
exports.MsgCreateGroup = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        for (const v of message.members) {
            types_js_1.MemberRequest.encode(v, writer.uint32(18).fork()).ldelim();
        }
        if (message.metadata !== "") {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.members.push(types_js_1.MemberRequest.decode(reader, reader.uint32()));
                    break;
                case 3:
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.members))
            obj.members = object.members.map((e) => types_js_1.MemberRequest.fromJSON(e));
    ...
    toJSON(message) {
        ...
        if (message.members) {
            obj.members = message.members.map((e) => (e ? types_js_1.MemberRequest.toJSON(e) : undefined));
        }
        else {
            obj.members = [];
        }
    ...
    fromPartial(object) {
        ...
        message.members = object.members?.map((e) => types_js_1.MemberRequest.fromPartial(e)) || [];
...
exports.MsgUpdateGroupMembers = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        for (const v of message.memberUpdates) {
            types_js_1.MemberRequest.encode(v, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.memberUpdates.push(types_js_1.MemberRequest.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.memberUpdates))
            obj.memberUpdates = object.memberUpdates.map((e) => types_js_1.MemberRequest.fromJSON(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.memberUpdates) {
            obj.memberUpdates = message.memberUpdates.map((e) => (e ? types_js_1.MemberRequest.toJSON(e) : undefined));
        }
        else {
            obj.memberUpdates = [];
        }
    ...
    fromPartial(object) {
        ...
        message.memberUpdates = object.memberUpdates?.map((e) => types_js_1.MemberRequest.fromPartial(e)) || [];
        return message;
    },
};
...
exports.MsgCreateGroupPolicy = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.decisionPolicy !== undefined) {
            any_js_1.Any.encode(message.decisionPolicy, writer.uint32(34).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.MsgCreateGroupWithPolicy = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.members))
            obj.members = object.members.map((e) => types_js_1.MemberRequest.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.groupMetadata))
            obj.groupMetadata = String(object.groupMetadata);
        if ((0, helpers_js_1.isSet)(object.groupPolicyMetadata))
            obj.groupPolicyMetadata = String(object.groupPolicyMetadata);
        if ((0, helpers_js_1.isSet)(object.groupPolicyAsAdmin))
...
exports.MsgUpdateGroupPolicyDecisionPolicy = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.decisionPolicy !== undefined) {
            any_js_1.Any.encode(message.decisionPolicy, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.MsgSubmitProposal = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.exec))
...
exports.MsgVote = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.option))
            obj.option = (0, types_js_1.voteOptionFromJSON)(object.option);
        if ((0, helpers_js_1.isSet)(object.metadata))
            obj.metadata = String(object.metadata);
        if ((0, helpers_js_1.isSet)(object.exec))
            obj.exec = execFromJSON(object.exec);
    ...
    toJSON(message) {
        ...
        message.option !== undefined && (obj.option = (0, types_js_1.voteOptionToJSON)(message.option));
        message.metadata !== undefined && (obj.metadata = message.metadata);
        message.exec !== undefined && (obj.exec = execToJSON(message.exec));
        return obj;
    },
...
exports.MsgExec = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.proposalId))
            obj.proposalId = BigInt(object.proposalId.toString());
        if ((0, helpers_js_1.isSet)(object.executor))
...
exports.MsgExecResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.result))
            obj.result = (0, types_js_1.proposalExecutorResultFromJSON)(object.result);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.result !== undefined && (obj.result = (0, types_js_1.proposalExecutorResultToJSON)(message.result));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseMsgExecResponse();

...
exports.EventExec = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.logs))
...
exports.EventProposalPruned = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.tallyResult !== undefined) {
            types_js_1.TallyResult.encode(message.tallyResult, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.tallyResult = types_js_1.TallyResult.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.status))
            obj.status = (0, types_js_1.proposalStatusFromJSON)(object.status);
        if ((0, helpers_js_1.isSet)(object.tallyResult))
            obj.tallyResult = types_js_1.TallyResult.fromJSON(object.tallyResult);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.proposalId !== undefined && (obj.proposalId = (message.proposalId || BigInt(0)).toString());
        message.status !== undefined && (obj.status = (0, types_js_1.proposalStatusToJSON)(message.status));
        message.tallyResult !== undefined &&
            (obj.tallyResult = message.tallyResult ? types_js_1.TallyResult.toJSON(message.tallyResult) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseEventProposalPruned();
        ...
        if (object.tallyResult !== undefined && object.tallyResult !== null) {
            message.tallyResult = types_js_1.TallyResult.fromPartial(object.tallyResult);
        }
        return message;
    },
};
...
exports.EventTallyError = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.proposalId))
            obj.proposalId = BigInt(object.proposalId.toString());
        if ((0, helpers_js_1.isSet)(object.errorMessage))

...
function createBaseGenesisState() {
    return {
        minter: mint_js_1.Minter.fromPartial({}),
...
exports.GenesisState = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.minter))
            obj.minter = mint_js_1.Minter.fromJSON(object.minter);
    ...
    toJSON(message) {
        const obj = {};
        message.minter !== undefined && (obj.minter = message.minter ? mint_js_1.Minter.toJSON(message.minter) : undefined);
    ...
    fromPartial(object) {
        ...
        if (object.minter !== undefined && object.minter !== null) {
            message.minter = mint_js_1.Minter.fromPartial(object.minter);
        }

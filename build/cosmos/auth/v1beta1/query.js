...
exports.QueryAccountResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.account))
            obj.account = any_js_1.Any.fromJSON(object.account);
        return obj;
    },
    toJSON(message) {
        const obj = {};
    ...
    fromPartial(object) {
        ...
        if (object.account !== undefined && object.account !== null) {
            message.account = any_js_1.Any.fromPartial(object.account);
        }
        return message;
    },
};
...
exports.Bech32PrefixResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.bech32Prefix))
...
exports.AddressBytesToStringRequest = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.addressBytes))
            obj.addressBytes = (0, helpers_js_1.bytesFromBase64)(object.addressBytes);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.addressBytes !== undefined &&
            (obj.addressBytes = (0, helpers_js_1.base64FromBytes)(message.addressBytes !== undefined ? message.addressBytes : new Uint8Array()));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseAddressBytesToStringRequest();
...
exports.AddressBytesToStringResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.addressString))
...
exports.QueryAccountAddressByIDRequest = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.accountId))
...
exports.QueryAccountAddressByIDResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.accountAddress))
...
exports.QueryAccountInfoResponse = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        if (message.info !== undefined) {
            auth_js_1.BaseAccount.encode(message.info, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.info = auth_js_1.BaseAccount.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.info))
            obj.info = auth_js_1.BaseAccount.fromJSON(object.info);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.info !== undefined && (obj.info = message.info ? auth_js_1.BaseAccount.toJSON(message.info) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseQueryAccountInfoResponse();
        if (object.info !== undefined && object.info !== null) {
            message.info = auth_js_1.BaseAccount.fromPartial(object.info);
        }
        return message;
    },
};

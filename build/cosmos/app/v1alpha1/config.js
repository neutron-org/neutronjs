...
exports.ModuleConfig = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.config !== undefined) {
            any_js_1.Any.encode(message.config, writer.uint32(18).fork()).ldelim();
        }
        for (const v of message.golangBindings) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.config = any_js_1.Any.decode(reader, reader.uint32());
                    break;
                case 3:
                    message.golangBindings.push(exports.GolangBinding.decode(reader, reader.uint32()));
                    break;
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.config))
            obj.config = any_js_1.Any.fromJSON(object.config);
        if (Array.isArray(object?.golangBindings))
            obj.golangBindings = object.golangBindings.map((e) => exports.GolangBinding.fromJSON(e));
        return obj;
    },
    toJSON(message) {
        ...
        message.config !== undefined && (obj.config = message.config ? any_js_1.Any.toJSON(message.config) : undefined);
        if (message.golangBindings) {
            obj.golangBindings = message.golangBindings.map((e) => (e ? exports.GolangBinding.toJSON(e) : undefined));
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.config !== undefined && object.config !== null) {
            message.config = any_js_1.Any.fromPartial(object.config);
        }
        message.golangBindings = object.golangBindings?.map((e) => exports.GolangBinding.fromPartial(e)) || [];
        return message;
    },
...
exports.GolangBinding = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.interfaceType))
            obj.interfaceType = String(object.interfaceType);
        if ((0, helpers_js_1.isSet)(object.implementation))

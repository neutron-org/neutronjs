...
//@ts-nocheck
/* eslint-disable */
const pagination_js_1 = require("../../query/v1beta1/pagination.js");
...
const types_js_3 = require("../../../../tendermint/p2p/types.js");
...
exports.Validator = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.pubKey))
            obj.pubKey = any_js_1.Any.fromJSON(object.pubKey);
        if ((0, helpers_js_1.isSet)(object.votingPower))
            obj.votingPower = BigInt(object.votingPower.toString());
        if ((0, helpers_js_1.isSet)(object.proposerPriority))
    ...
    toJSON(message) {
        ...
        message.pubKey !== undefined && (obj.pubKey = message.pubKey ? any_js_1.Any.toJSON(message.pubKey) : undefined);
    ...
    fromPartial(object) {
        ...
        if (object.pubKey !== undefined && object.pubKey !== null) {
            message.pubKey = any_js_1.Any.fromPartial(object.pubKey);
        }
...
exports.GetBlockByHeightResponse = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.sdkBlock !== undefined) {
            types_js_2.Block.encode(message.sdkBlock, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.sdkBlock = types_js_2.Block.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.sdkBlock))
            obj.sdkBlock = types_js_2.Block.fromJSON(object.sdkBlock);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.sdkBlock !== undefined &&
            (obj.sdkBlock = message.sdkBlock ? types_js_2.Block.toJSON(message.sdkBlock) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseGetBlockByHeightResponse();
        ...
        if (object.sdkBlock !== undefined && object.sdkBlock !== null) {
            message.sdkBlock = types_js_2.Block.fromPartial(object.sdkBlock);
        }
        return message;
    },
};
...
exports.GetSyncingResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.syncing))
...
exports.GetNodeInfoResponse = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        if (message.defaultNodeInfo !== undefined) {
            types_js_3.DefaultNodeInfo.encode(message.defaultNodeInfo, writer.uint32(10).fork()).ldelim();
        }
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.defaultNodeInfo = types_js_3.DefaultNodeInfo.decode(reader, reader.uint32());
                    break;
                case 2:
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.defaultNodeInfo))
            obj.defaultNodeInfo = types_js_3.DefaultNodeInfo.fromJSON(object.defaultNodeInfo);
        if ((0, helpers_js_1.isSet)(object.applicationVersion))
    ...
    toJSON(message) {
        ...
        message.defaultNodeInfo !== undefined &&
            (obj.defaultNodeInfo = message.defaultNodeInfo
                ? types_js_3.DefaultNodeInfo.toJSON(message.defaultNodeInfo)
                : undefined);
    ...
    fromPartial(object) {
        ...
        if (object.defaultNodeInfo !== undefined && object.defaultNodeInfo !== null) {
            message.defaultNodeInfo = types_js_3.DefaultNodeInfo.fromPartial(object.defaultNodeInfo);
        }
...
exports.VersionInfo = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.cosmosSdkVersion))
...
exports.Module = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.version))
            obj.version = String(object.version);
        if ((0, helpers_js_1.isSet)(object.sum))

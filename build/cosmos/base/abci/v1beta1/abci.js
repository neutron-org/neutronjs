...
exports.TxResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.txhash))
        ...
        if ((0, helpers_js_1.isSet)(object.rawLog))
    ...
    toJSON(message) {
        ...
        message.tx !== undefined && (obj.tx = message.tx ? any_js_1.Any.toJSON(message.tx) : undefined);
        message.timestamp !== undefined && (obj.timestamp = message.timestamp);
        if (message.events) {
            obj.events = message.events.map((e) => (e ? types_js_1.Event.toJSON(e) : undefined));
        }
        else {
            obj.events = [];
        }
    ...
    fromPartial(object) {
        ...
        if (object.tx !== undefined && object.tx !== null) {
            message.tx = any_js_1.Any.fromPartial(object.tx);
        }
        message.timestamp = object.timestamp ?? "";
        message.events = object.events?.map((e) => types_js_1.Event.fromPartial(e)) || [];
        return message;
    },
};
...
exports.ABCIMessageLog = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.msgIndex))
...
exports.Result = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.msgResponses.push(any_js_1.Any.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.msgResponses))
            obj.msgResponses = object.msgResponses.map((e) => any_js_1.Any.fromJSON(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.msgResponses) {
            obj.msgResponses = message.msgResponses.map((e) => (e ? any_js_1.Any.toJSON(e) : undefined));
        }
        else {
            obj.msgResponses = [];
        }
    ...
    fromPartial(object) {
        ...
        message.log = object.log ?? "";
        message.events = object.events?.map((e) => types_js_1.Event.fromPartial(e)) || [];
        message.msgResponses = object.msgResponses?.map((e) => any_js_1.Any.fromPartial(e)) || [];
        return message;
    },
};
...
exports.MsgData = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.msgType))
...
exports.SearchTxsResult = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.pageNumber))
            obj.pageNumber = BigInt(object.pageNumber.toString());
        if ((0, helpers_js_1.isSet)(object.pageTotal))
...
exports.SearchBlocksResult = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        for (const v of message.blocks) {
            block_js_1.Block.encode(v, writer.uint32(50).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    message.blocks.push(block_js_1.Block.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.blocks))
            obj.blocks = object.blocks.map((e) => block_js_1.Block.fromJSON(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.limit !== undefined && (obj.limit = (message.limit || BigInt(0)).toString());
        if (message.blocks) {
            obj.blocks = message.blocks.map((e) => (e ? block_js_1.Block.toJSON(e) : undefined));
        }
        else {
            obj.blocks = [];
        }
    ...
    fromPartial(object) {
        ...
        message.blocks = object.blocks?.map((e) => block_js_1.Block.fromPartial(e)) || [];
        return message;
    },
};

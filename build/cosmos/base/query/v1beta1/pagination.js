...
exports.PageResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.nextKey))
            obj.nextKey = (0, helpers_js_1.bytesFromBase64)(object.nextKey);
    ...
    toJSON(message) {
        ...
        message.nextKey !== undefined &&
            (obj.nextKey = (0, helpers_js_1.base64FromBytes)(message.nextKey !== undefined ? message.nextKey : new Uint8Array()));

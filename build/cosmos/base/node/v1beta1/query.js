...
exports.ConfigResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.minimumGasPrice))
            obj.minimumGasPrice = String(object.minimumGasPrice);
        if ((0, helpers_js_1.isSet)(object.pruningKeepRecent))
            obj.pruningKeepRecent = String(object.pruningKeepRecent);
        if ((0, helpers_js_1.isSet)(object.pruningInterval))
            obj.pruningInterval = String(object.pruningInterval);
        if ((0, helpers_js_1.isSet)(object.haltHeight))
...
exports.StatusResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.earliestStoreHeight))
        ...
        if ((0, helpers_js_1.isSet)(object.validatorHash))
            obj.validatorHash = (0, helpers_js_1.bytesFromBase64)(object.validatorHash);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.validatorHash !== undefined &&
            (obj.validatorHash = (0, helpers_js_1.base64FromBytes)(message.validatorHash !== undefined ? message.validatorHash : new Uint8Array()));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseStatusResponse();

...
export declare const createRPCQueryClient: ({ rpcEndpoint }: {
    ...
    feemarket: {
        feemarket: {
            v1: {
                params(request?: import("./feemarket/v1/query.js").ParamsRequest): Promise<import("./feemarket/v1/query.js").ParamsResponse>;
                state(request?: import("./feemarket/v1/query.js").StateRequest): Promise<import("./feemarket/v1/query.js").StateResponse>;
                gasPrice(request: import("./feemarket/v1/query.js").GasPriceRequest): Promise<import("./feemarket/v1/query.js").GasPriceResponse>;
                gasPrices(request?: import("./feemarket/v1/query.js").GasPricesRequest): Promise<import("./feemarket/v1/query.js").GasPricesResponse>;
            };
        };
    };
}>;

...
exports.NetAddress = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.ip))
            obj.ip = String(object.ip);
        if ((0, helpers_js_1.isSet)(object.port))
...
exports.DefaultNodeInfo = {
    ...
    toJSON(message) {
        ...
        message.channels !== undefined &&
            (obj.channels = (0, helpers_js_1.base64FromBytes)(message.channels !== undefined ? message.channels : new Uint8Array()));
...
exports.DefaultNodeInfoOther = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.rpcAddress))

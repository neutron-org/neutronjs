...
const types_js_1 = require("../version/types.js");
...
exports.PartSetHeader = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.total))
...
function createBasePart() {
    return {
        ...
        proof: proof_js_1.Proof.fromPartial({}),
    };
}
exports.Part = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.bytes))
            obj.bytes = (0, helpers_js_1.bytesFromBase64)(object.bytes);
        if ((0, helpers_js_1.isSet)(object.proof))
            obj.proof = proof_js_1.Proof.fromJSON(object.proof);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.bytes !== undefined &&
            (obj.bytes = (0, helpers_js_1.base64FromBytes)(message.bytes !== undefined ? message.bytes : new Uint8Array()));
        message.proof !== undefined && (obj.proof = message.proof ? proof_js_1.Proof.toJSON(message.proof) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBasePart();
        ...
        if (object.proof !== undefined && object.proof !== null) {
            message.proof = proof_js_1.Proof.fromPartial(object.proof);
        }
        return message;
    },
};
...
exports.BlockID = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.hash))
            obj.hash = (0, helpers_js_1.bytesFromBase64)(object.hash);
        if ((0, helpers_js_1.isSet)(object.partSetHeader))
...
function createBaseHeader() {
    return {
        version: types_js_1.Consensus.fromPartial({}),
        chainId: "",
        height: BigInt(0),
...
exports.Header = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.version))
            obj.version = types_js_1.Consensus.fromJSON(object.version);
        ...
        if ((0, helpers_js_1.isSet)(object.lastBlockId))
            obj.lastBlockId = exports.BlockID.fromJSON(object.lastBlockId);
        if ((0, helpers_js_1.isSet)(object.lastCommitHash))
            obj.lastCommitHash = (0, helpers_js_1.bytesFromBase64)(object.lastCommitHash);
        if ((0, helpers_js_1.isSet)(object.dataHash))
            obj.dataHash = (0, helpers_js_1.bytesFromBase64)(object.dataHash);
        if ((0, helpers_js_1.isSet)(object.validatorsHash))
            obj.validatorsHash = (0, helpers_js_1.bytesFromBase64)(object.validatorsHash);
        ...
        if ((0, helpers_js_1.isSet)(object.consensusHash))
            obj.consensusHash = (0, helpers_js_1.bytesFromBase64)(object.consensusHash);
        if ((0, helpers_js_1.isSet)(object.appHash))
            obj.appHash = (0, helpers_js_1.bytesFromBase64)(object.appHash);
        if ((0, helpers_js_1.isSet)(object.lastResultsHash))
            obj.lastResultsHash = (0, helpers_js_1.bytesFromBase64)(object.lastResultsHash);
    ...
    toJSON(message) {
        ...
        message.version !== undefined &&
            (obj.version = message.version ? types_js_1.Consensus.toJSON(message.version) : undefined);
        ...
        message.lastCommitHash !== undefined &&
            (obj.lastCommitHash = (0, helpers_js_1.base64FromBytes)(message.lastCommitHash !== undefined ? message.lastCommitHash : new Uint8Array()));
        message.dataHash !== undefined &&
            (obj.dataHash = (0, helpers_js_1.base64FromBytes)(message.dataHash !== undefined ? message.dataHash : new Uint8Array()));
        message.validatorsHash !== undefined &&
            (obj.validatorsHash = (0, helpers_js_1.base64FromBytes)(message.validatorsHash !== undefined ? message.validatorsHash : new Uint8Array()));
        ...
        message.consensusHash !== undefined &&
            (obj.consensusHash = (0, helpers_js_1.base64FromBytes)(message.consensusHash !== undefined ? message.consensusHash : new Uint8Array()));
        message.appHash !== undefined &&
            (obj.appHash = (0, helpers_js_1.base64FromBytes)(message.appHash !== undefined ? message.appHash : new Uint8Array()));
        message.lastResultsHash !== undefined &&
            (obj.lastResultsHash = (0, helpers_js_1.base64FromBytes)(message.lastResultsHash !== undefined ? message.lastResultsHash : new Uint8Array()));
    ...
    fromPartial(object) {
        ...
        if (object.version !== undefined && object.version !== null) {
            message.version = types_js_1.Consensus.fromPartial(object.version);
        }
...
exports.Vote = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.timestamp !== undefined) {
            timestamp_js_1.Timestamp.encode(message.timestamp, writer.uint32(42).fork()).ldelim();
        }
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.blockId))
        ...
        if ((0, helpers_js_1.isSet)(object.validatorIndex))
        ...
        if ((0, helpers_js_1.isSet)(object.extension))
            obj.extension = (0, helpers_js_1.bytesFromBase64)(object.extension);
    ...
    toJSON(message) {
        ...
        message.extension !== undefined &&
            (obj.extension = (0, helpers_js_1.base64FromBytes)(message.extension !== undefined ? message.extension : new Uint8Array()));
...
exports.CommitSig = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.timestamp !== undefined) {
            timestamp_js_1.Timestamp.encode(message.timestamp, writer.uint32(26).fork()).ldelim();
        }
        if (message.signature.length !== 0) {
...
exports.Proposal = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.timestamp !== undefined) {
            timestamp_js_1.Timestamp.encode(message.timestamp, writer.uint32(50).fork()).ldelim();
        }
        if (message.signature.length !== 0) {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.round))
            obj.round = Number(object.round);
        if ((0, helpers_js_1.isSet)(object.polRound))
...
exports.LightBlock = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.signedHeader))
            obj.signedHeader = exports.SignedHeader.fromJSON(object.signedHeader);
        if ((0, helpers_js_1.isSet)(object.validatorSet))
            obj.validatorSet = validator_js_1.ValidatorSet.fromJSON(object.validatorSet);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.validatorSet !== undefined &&
            (obj.validatorSet = message.validatorSet ? validator_js_1.ValidatorSet.toJSON(message.validatorSet) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseLightBlock();
        ...
        if (object.validatorSet !== undefined && object.validatorSet !== null) {
            message.validatorSet = validator_js_1.ValidatorSet.fromPartial(object.validatorSet);
        }
        return message;
    },
};
...
exports.BlockMeta = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.header))
            obj.header = exports.Header.fromJSON(object.header);
        if ((0, helpers_js_1.isSet)(object.numTxs))
...
exports.TxProof = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.rootHash))
            obj.rootHash = (0, helpers_js_1.bytesFromBase64)(object.rootHash);
    ...
    toJSON(message) {
        ...
        message.rootHash !== undefined &&
            (obj.rootHash = (0, helpers_js_1.base64FromBytes)(message.rootHash !== undefined ? message.rootHash : new Uint8Array()));

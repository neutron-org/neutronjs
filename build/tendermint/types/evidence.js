...
exports.Evidence = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.duplicateVoteEvidence))
            obj.duplicateVoteEvidence = exports.DuplicateVoteEvidence.fromJSON(object.duplicateVoteEvidence);
        if ((0, helpers_js_1.isSet)(object.lightClientAttackEvidence))
...
exports.DuplicateVoteEvidence = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.voteA))
            obj.voteA = types_js_1.Vote.fromJSON(object.voteA);
        if ((0, helpers_js_1.isSet)(object.voteB))
            obj.voteB = types_js_1.Vote.fromJSON(object.voteB);
        if ((0, helpers_js_1.isSet)(object.totalVotingPower))
            obj.totalVotingPower = BigInt(object.totalVotingPower.toString());
        if ((0, helpers_js_1.isSet)(object.validatorPower))
    ...
    toJSON(message) {
        const obj = {};
        message.voteA !== undefined && (obj.voteA = message.voteA ? types_js_1.Vote.toJSON(message.voteA) : undefined);
        message.voteB !== undefined && (obj.voteB = message.voteB ? types_js_1.Vote.toJSON(message.voteB) : undefined);
    ...
    fromPartial(object) {
        ...
        if (object.voteA !== undefined && object.voteA !== null) {
            message.voteA = types_js_1.Vote.fromPartial(object.voteA);
        }
        if (object.voteB !== undefined && object.voteB !== null) {
            message.voteB = types_js_1.Vote.fromPartial(object.voteB);
        }
...
exports.LightClientAttackEvidence = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.conflictingBlock))
            obj.conflictingBlock = types_js_1.LightBlock.fromJSON(object.conflictingBlock);
        if ((0, helpers_js_1.isSet)(object.commonHeight))
            obj.commonHeight = BigInt(object.commonHeight.toString());
        if (Array.isArray(object?.byzantineValidators))
            obj.byzantineValidators = object.byzantineValidators.map((e) => validator_js_1.Validator.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.totalVotingPower))
            obj.totalVotingPower = BigInt(object.totalVotingPower.toString());
        if ((0, helpers_js_1.isSet)(object.timestamp))
            obj.timestamp = (0, helpers_js_1.fromJsonTimestamp)(object.timestamp);
    ...
    toJSON(message) {
        ...
        if (message.byzantineValidators) {
            obj.byzantineValidators = message.byzantineValidators.map((e) => (e ? validator_js_1.Validator.toJSON(e) : undefined));
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.conflictingBlock !== undefined && object.conflictingBlock !== null) {
            message.conflictingBlock = types_js_1.LightBlock.fromPartial(object.conflictingBlock);
        }
        if (object.commonHeight !== undefined && object.commonHeight !== null) {
            message.commonHeight = BigInt(object.commonHeight.toString());
        }
        message.byzantineValidators = object.byzantineValidators?.map((e) => validator_js_1.Validator.fromPartial(e)) || [];
        if (object.totalVotingPower !== undefined && object.totalVotingPower !== null) {
            message.totalVotingPower = BigInt(object.totalVotingPower.toString());
        }
        if (object.timestamp !== undefined && object.timestamp !== null) {

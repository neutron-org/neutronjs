...
exports.BlockParams = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.maxBytes))
            obj.maxBytes = BigInt(object.maxBytes.toString());
        if ((0, helpers_js_1.isSet)(object.maxGas))
...
function createBaseEvidenceParams() {
    return {
        ...
        maxAgeDuration: duration_js_1.Duration.fromPartial({}),
        maxBytes: BigInt(0),
    };
}
exports.EvidenceParams = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.maxAgeNumBlocks))
            obj.maxAgeNumBlocks = BigInt(object.maxAgeNumBlocks.toString());
        if ((0, helpers_js_1.isSet)(object.maxAgeDuration))
            obj.maxAgeDuration = duration_js_1.Duration.fromJSON(object.maxAgeDuration);
        if ((0, helpers_js_1.isSet)(object.maxBytes))
            obj.maxBytes = BigInt(object.maxBytes.toString());
        return obj;
    },
    toJSON(message) {
        ...
        message.maxAgeDuration !== undefined &&
            (obj.maxAgeDuration = message.maxAgeDuration ? duration_js_1.Duration.toJSON(message.maxAgeDuration) : undefined);
        message.maxBytes !== undefined && (obj.maxBytes = (message.maxBytes || BigInt(0)).toString());
        return obj;
    },
    fromPartial(object) {
        ...
        if (object.maxAgeDuration !== undefined && object.maxAgeDuration !== null) {
            message.maxAgeDuration = duration_js_1.Duration.fromPartial(object.maxAgeDuration);
        }
        if (object.maxBytes !== undefined && object.maxBytes !== null) {
            message.maxBytes = BigInt(object.maxBytes.toString());
        }
...
exports.HashedParams = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.blockMaxBytes))
            obj.blockMaxBytes = BigInt(object.blockMaxBytes.toString());
        if ((0, helpers_js_1.isSet)(object.blockMaxGas))
...
exports.ABCIParams = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.voteExtensionsEnableHeight))

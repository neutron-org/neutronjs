...
exports.Proof = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.leafHash))
            obj.leafHash = (0, helpers_js_1.bytesFromBase64)(object.leafHash);
        if (Array.isArray(object?.aunts))
            obj.aunts = object.aunts.map((e) => (0, helpers_js_1.bytesFromBase64)(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.leafHash !== undefined &&
            (obj.leafHash = (0, helpers_js_1.base64FromBytes)(message.leafHash !== undefined ? message.leafHash : new Uint8Array()));
        if (message.aunts) {
            obj.aunts = message.aunts.map((e) => (0, helpers_js_1.base64FromBytes)(e !== undefined ? e : new Uint8Array()));
        }
        else {
            obj.aunts = [];
        }
...
exports.DominoOp = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.input))
            obj.input = String(object.input);
        if ((0, helpers_js_1.isSet)(object.output))

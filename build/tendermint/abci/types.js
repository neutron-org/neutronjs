...
exports.RequestEcho = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.message))
...
exports.RequestInfo = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.blockVersion))
            obj.blockVersion = BigInt(object.blockVersion.toString());
        if ((0, helpers_js_1.isSet)(object.p2pVersion))
            obj.p2pVersion = BigInt(object.p2pVersion.toString());
        if ((0, helpers_js_1.isSet)(object.abciVersion))
...
function createBaseRequestInitChain() {
    return {
        time: timestamp_js_1.Timestamp.fromPartial({}),
        chainId: "",
...
exports.RequestInitChain = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        if (message.time !== undefined) {
            timestamp_js_1.Timestamp.encode(message.time, writer.uint32(10).fork()).ldelim();
        }
        if (message.chainId !== "") {
            writer.uint32(18).string(message.chainId);
        }
        if (message.consensusParams !== undefined) {
            params_js_1.ConsensusParams.encode(message.consensusParams, writer.uint32(26).fork()).ldelim();
        }
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.time = timestamp_js_1.Timestamp.decode(reader, reader.uint32());
                    break;
                case 2:
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.time))
            obj.time = (0, helpers_js_1.fromJsonTimestamp)(object.time);
        if ((0, helpers_js_1.isSet)(object.chainId))
            obj.chainId = String(object.chainId);
        if ((0, helpers_js_1.isSet)(object.consensusParams))
            obj.consensusParams = params_js_1.ConsensusParams.fromJSON(object.consensusParams);
        if (Array.isArray(object?.validators))
            obj.validators = object.validators.map((e) => exports.ValidatorUpdate.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.appStateBytes))
            obj.appStateBytes = (0, helpers_js_1.bytesFromBase64)(object.appStateBytes);
        if ((0, helpers_js_1.isSet)(object.initialHeight))
            obj.initialHeight = BigInt(object.initialHeight.toString());
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.time !== undefined && (obj.time = (0, helpers_js_1.fromTimestamp)(message.time).toISOString());
        ...
        message.appStateBytes !== undefined &&
            (obj.appStateBytes = (0, helpers_js_1.base64FromBytes)(message.appStateBytes !== undefined ? message.appStateBytes : new Uint8Array()));
    ...
    fromPartial(object) {
        ...
        if (object.time !== undefined && object.time !== null) {
            message.time = timestamp_js_1.Timestamp.fromPartial(object.time);
        }
        message.chainId = object.chainId ?? "";
        if (object.consensusParams !== undefined && object.consensusParams !== null) {
            message.consensusParams = params_js_1.ConsensusParams.fromPartial(object.consensusParams);
        }
...
exports.RequestQuery = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.prove))
...
exports.RequestCheckTx = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.tx))
            obj.tx = (0, helpers_js_1.bytesFromBase64)(object.tx);
    ...
    toJSON(message) {
        ...
        message.tx !== undefined &&
            (obj.tx = (0, helpers_js_1.base64FromBytes)(message.tx !== undefined ? message.tx : new Uint8Array()));
...
exports.RequestOfferSnapshot = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.snapshot))
            obj.snapshot = exports.Snapshot.fromJSON(object.snapshot);
        if ((0, helpers_js_1.isSet)(object.appHash))
            obj.appHash = (0, helpers_js_1.bytesFromBase64)(object.appHash);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.appHash !== undefined &&
            (obj.appHash = (0, helpers_js_1.base64FromBytes)(message.appHash !== undefined ? message.appHash : new Uint8Array()));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseRequestOfferSnapshot();
...
exports.RequestLoadSnapshotChunk = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.height))
            obj.height = BigInt(object.height.toString());
        if ((0, helpers_js_1.isSet)(object.format))
            obj.format = Number(object.format);
        if ((0, helpers_js_1.isSet)(object.chunk))
...
exports.RequestApplySnapshotChunk = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.chunk))
            obj.chunk = (0, helpers_js_1.bytesFromBase64)(object.chunk);
    ...
    toJSON(message) {
        ...
        message.chunk !== undefined &&
            (obj.chunk = (0, helpers_js_1.base64FromBytes)(message.chunk !== undefined ? message.chunk : new Uint8Array()));
...
exports.RequestPrepareProposal = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.time !== undefined) {
            timestamp_js_1.Timestamp.encode(message.time, writer.uint32(50).fork()).ldelim();
        }
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.maxTxBytes))
            obj.maxTxBytes = BigInt(object.maxTxBytes.toString());
        if (Array.isArray(object?.txs))
            obj.txs = object.txs.map((e) => (0, helpers_js_1.bytesFromBase64)(e));
        if ((0, helpers_js_1.isSet)(object.localLastCommit))
        ...
        if ((0, helpers_js_1.isSet)(object.time))
            obj.time = (0, helpers_js_1.fromJsonTimestamp)(object.time);
        if ((0, helpers_js_1.isSet)(object.nextValidatorsHash))
            obj.nextValidatorsHash = (0, helpers_js_1.bytesFromBase64)(object.nextValidatorsHash);
        if ((0, helpers_js_1.isSet)(object.proposerAddress))
            obj.proposerAddress = (0, helpers_js_1.bytesFromBase64)(object.proposerAddress);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.txs) {
            obj.txs = message.txs.map((e) => (0, helpers_js_1.base64FromBytes)(e !== undefined ? e : new Uint8Array()));
        }
        else {
            obj.txs = [];
        }
        ...
        message.nextValidatorsHash !== undefined &&
            (obj.nextValidatorsHash = (0, helpers_js_1.base64FromBytes)(message.nextValidatorsHash !== undefined ? message.nextValidatorsHash : new Uint8Array()));
        message.proposerAddress !== undefined &&
            (obj.proposerAddress = (0, helpers_js_1.base64FromBytes)(message.proposerAddress !== undefined ? message.proposerAddress : new Uint8Array()));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseRequestPrepareProposal();
...
exports.RequestProcessProposal = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.txs))
            obj.txs = object.txs.map((e) => (0, helpers_js_1.bytesFromBase64)(e));
        if ((0, helpers_js_1.isSet)(object.proposedLastCommit))
...
exports.RequestExtendVote = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.time !== undefined) {
            timestamp_js_1.Timestamp.encode(message.time, writer.uint32(26).fork()).ldelim();
        }
        for (const v of message.txs) {
...
exports.RequestVerifyVoteExtension = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.validatorAddress))
            obj.validatorAddress = (0, helpers_js_1.bytesFromBase64)(object.validatorAddress);
        if ((0, helpers_js_1.isSet)(object.height))
            obj.height = BigInt(object.height.toString());
        if ((0, helpers_js_1.isSet)(object.voteExtension))
            obj.voteExtension = (0, helpers_js_1.bytesFromBase64)(object.voteExtension);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.validatorAddress !== undefined &&
            (obj.validatorAddress = (0, helpers_js_1.base64FromBytes)(message.validatorAddress !== undefined ? message.validatorAddress : new Uint8Array()));
        message.height !== undefined && (obj.height = (message.height || BigInt(0)).toString());
        message.voteExtension !== undefined &&
            (obj.voteExtension = (0, helpers_js_1.base64FromBytes)(message.voteExtension !== undefined ? message.voteExtension : new Uint8Array()));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseRequestVerifyVoteExtension();
...
exports.RequestFinalizeBlock = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.txs))
            obj.txs = object.txs.map((e) => (0, helpers_js_1.bytesFromBase64)(e));
        if ((0, helpers_js_1.isSet)(object.decidedLastCommit))
...
exports.Response = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.exception))
...
exports.ResponseInfo = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.version))
            obj.version = String(object.version);
        if ((0, helpers_js_1.isSet)(object.appVersion))
            obj.appVersion = BigInt(object.appVersion.toString());
        if ((0, helpers_js_1.isSet)(object.lastBlockHeight))
            obj.lastBlockHeight = BigInt(object.lastBlockHeight.toString());
        if ((0, helpers_js_1.isSet)(object.lastBlockAppHash))
            obj.lastBlockAppHash = (0, helpers_js_1.bytesFromBase64)(object.lastBlockAppHash);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.lastBlockAppHash !== undefined &&
            (obj.lastBlockAppHash = (0, helpers_js_1.base64FromBytes)(message.lastBlockAppHash !== undefined ? message.lastBlockAppHash : new Uint8Array()));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseResponseInfo();
...
exports.ResponseQuery = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.code))
            obj.code = Number(object.code);
        if ((0, helpers_js_1.isSet)(object.log))
        ...
        if ((0, helpers_js_1.isSet)(object.proofOps))
            obj.proofOps = proof_js_1.ProofOps.fromJSON(object.proofOps);
        if ((0, helpers_js_1.isSet)(object.height))
            obj.height = BigInt(object.height.toString());
        if ((0, helpers_js_1.isSet)(object.codespace))
    ...
    toJSON(message) {
        ...
        message.proofOps !== undefined &&
            (obj.proofOps = message.proofOps ? proof_js_1.ProofOps.toJSON(message.proofOps) : undefined);
        message.height !== undefined && (obj.height = (message.height || BigInt(0)).toString());
    ...
    fromPartial(object) {
        ...
        if (object.proofOps !== undefined && object.proofOps !== null) {
            message.proofOps = proof_js_1.ProofOps.fromPartial(object.proofOps);
        }
        if (object.height !== undefined && object.height !== null) {
            message.height = BigInt(object.height.toString());
        }
...
exports.ResponseCheckTx = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.info))
            obj.info = String(object.info);
        if ((0, helpers_js_1.isSet)(object.gas_wanted))
            obj.gasWanted = BigInt(object.gas_wanted.toString());
        if ((0, helpers_js_1.isSet)(object.gas_used))
...
exports.ResponseCommit = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.retainHeight))
...
exports.ResponseFinalizeBlock = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.consensusParamUpdates !== undefined) {
            params_js_1.ConsensusParams.encode(message.consensusParamUpdates, writer.uint32(34).fork()).ldelim();
        }
        if (message.appHash.length !== 0) {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.consensusParamUpdates))
            obj.consensusParamUpdates = params_js_1.ConsensusParams.fromJSON(object.consensusParamUpdates);
        if ((0, helpers_js_1.isSet)(object.appHash))
            obj.appHash = (0, helpers_js_1.bytesFromBase64)(object.appHash);
        return obj;
    },
    toJSON(message) {
        ...
        message.consensusParamUpdates !== undefined &&
            (obj.consensusParamUpdates = message.consensusParamUpdates
                ? params_js_1.ConsensusParams.toJSON(message.consensusParamUpdates)
                : undefined);
        message.appHash !== undefined &&
            (obj.appHash = (0, helpers_js_1.base64FromBytes)(message.appHash !== undefined ? message.appHash : new Uint8Array()));
        return obj;
    ...
    fromPartial(object) {
        ...
        if (object.consensusParamUpdates !== undefined && object.consensusParamUpdates !== null) {
            message.consensusParamUpdates = params_js_1.ConsensusParams.fromPartial(object.consensusParamUpdates);
        }
        message.appHash = object.appHash ?? new Uint8Array();
        return message;
    },
...
exports.CommitInfo = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.round))
...
exports.Validator = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.address))
            obj.address = (0, helpers_js_1.bytesFromBase64)(object.address);
        if ((0, helpers_js_1.isSet)(object.power))
    ...
    toJSON(message) {
        ...
        message.address !== undefined &&
            (obj.address = (0, helpers_js_1.base64FromBytes)(message.address !== undefined ? message.address : new Uint8Array()));
...
function createBaseValidatorUpdate() {
    return {
        pubKey: keys_js_1.PublicKey.fromPartial({}),
        power: BigInt(0),
    };
}
exports.ValidatorUpdate = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.pubKey))
            obj.pubKey = keys_js_1.PublicKey.fromJSON(object.pubKey);
        if ((0, helpers_js_1.isSet)(object.power))
            obj.power = BigInt(object.power.toString());
        return obj;
    },
    toJSON(message) {
        ...
        message.pubKey !== undefined &&
            (obj.pubKey = message.pubKey ? keys_js_1.PublicKey.toJSON(message.pubKey) : undefined);
        message.power !== undefined && (obj.power = (message.power || BigInt(0)).toString());
        return obj;
    },
    fromPartial(object) {
        ...
        if (object.pubKey !== undefined && object.pubKey !== null) {
            message.pubKey = keys_js_1.PublicKey.fromPartial(object.pubKey);
        }
        if (object.power !== undefined && object.power !== null) {
            message.power = BigInt(object.power.toString());
        }
...
exports.VoteInfo = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.blockIdFlag))
            obj.blockIdFlag = (0, validator_js_1.blockIDFlagFromJSON)(object.blockIdFlag);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.blockIdFlag !== undefined && (obj.blockIdFlag = (0, validator_js_1.blockIDFlagToJSON)(message.blockIdFlag));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseVoteInfo();
...
exports.ExtendedVoteInfo = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.voteExtension))
            obj.voteExtension = (0, helpers_js_1.bytesFromBase64)(object.voteExtension);
        if ((0, helpers_js_1.isSet)(object.extensionSignature))
            obj.extensionSignature = (0, helpers_js_1.bytesFromBase64)(object.extensionSignature);
        if ((0, helpers_js_1.isSet)(object.blockIdFlag))
            obj.blockIdFlag = (0, validator_js_1.blockIDFlagFromJSON)(object.blockIdFlag);
        return obj;
    },
    toJSON(message) {
        ...
        message.extensionSignature !== undefined &&
            (obj.extensionSignature = (0, helpers_js_1.base64FromBytes)(message.extensionSignature !== undefined ? message.extensionSignature : new Uint8Array()));
        message.blockIdFlag !== undefined && (obj.blockIdFlag = (0, validator_js_1.blockIDFlagToJSON)(message.blockIdFlag));
        return obj;
    },
    fromPartial(object) {
...
exports.Misbehavior = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.time !== undefined) {
            timestamp_js_1.Timestamp.encode(message.time, writer.uint32(34).fork()).ldelim();
        }
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.time))
            obj.time = (0, helpers_js_1.fromJsonTimestamp)(object.time);
        if ((0, helpers_js_1.isSet)(object.totalVotingPower))
...
exports.Snapshot = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.format))
            obj.format = Number(object.format);
        if ((0, helpers_js_1.isSet)(object.chunks))
            obj.chunks = Number(object.chunks);
        if ((0, helpers_js_1.isSet)(object.hash))
            obj.hash = (0, helpers_js_1.bytesFromBase64)(object.hash);
        if ((0, helpers_js_1.isSet)(object.metadata))
            obj.metadata = (0, helpers_js_1.bytesFromBase64)(object.metadata);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.metadata !== undefined &&
            (obj.metadata = (0, helpers_js_1.base64FromBytes)(message.metadata !== undefined ? message.metadata : new Uint8Array()));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseSnapshot();

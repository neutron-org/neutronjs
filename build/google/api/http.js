...
exports.Http = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.fullyDecodeReservedExpansion))
...
exports.HttpRule = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.selector))
            obj.selector = String(object.selector);
        if ((0, helpers_js_1.isSet)(object.get))
            obj.get = String(object.get);
        if ((0, helpers_js_1.isSet)(object.put))
            obj.put = String(object.put);
        if ((0, helpers_js_1.isSet)(object.post))
            obj.post = String(object.post);
        if ((0, helpers_js_1.isSet)(object.delete))
            obj.delete = String(object.delete);
        if ((0, helpers_js_1.isSet)(object.patch))
            obj.patch = String(object.patch);
        if ((0, helpers_js_1.isSet)(object.custom))
        ...
        if ((0, helpers_js_1.isSet)(object.responseBody))
...
exports.CustomHttpPattern = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.kind))

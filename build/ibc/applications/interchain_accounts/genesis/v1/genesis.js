...
//@ts-nocheck
/* eslint-disable */
const controller_js_1 = require("../../controller/v1/controller.js");
const host_js_1 = require("../../host/v1/host.js");
...
exports.GenesisState = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.controllerGenesisState))
            obj.controllerGenesisState = exports.ControllerGenesisState.fromJSON(object.controllerGenesisState);
        if ((0, helpers_js_1.isSet)(object.hostGenesisState))
...
exports.ActiveChannel = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.isMiddlewareEnabled))

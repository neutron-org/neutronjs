...
exports.MsgModuleQuerySafeResponse = exports.MsgModuleQuerySafe = exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = exports.protobufPackage = void 0;
//@ts-nocheck
/* eslint-disable */
...
function createBaseMsgUpdateParams() {
    return {
        signer: "",
        params: host_js_1.Params.fromPartial({}),
    };
}
exports.MsgUpdateParams = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.params !== undefined) {
            host_js_1.Params.encode(message.params, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.MsgModuleQuerySafe = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        for (const v of message.requests) {
            host_js_1.QueryRequest.encode(v, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.requests.push(host_js_1.QueryRequest.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.requests))
            obj.requests = object.requests.map((e) => host_js_1.QueryRequest.fromJSON(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.signer !== undefined && (obj.signer = message.signer);
        if (message.requests) {
            obj.requests = message.requests.map((e) => (e ? host_js_1.QueryRequest.toJSON(e) : undefined));
        }
        else {
            obj.requests = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseMsgModuleQuerySafe();
        message.signer = object.signer ?? "";
        message.requests = object.requests?.map((e) => host_js_1.QueryRequest.fromPartial(e)) || [];
        return message;
    },
};
...
exports.MsgModuleQuerySafeResponse = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.responses))
            obj.responses = object.responses.map((e) => (0, helpers_js_1.bytesFromBase64)(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.responses) {
            obj.responses = message.responses.map((e) => (0, helpers_js_1.base64FromBytes)(e !== undefined ? e : new Uint8Array()));
        }
        else {
            obj.responses = [];
        }

...
function createBaseMsgSendTx() {
    return {
        owner: "",
        connectionId: "",
        packetData: packet_js_1.InterchainAccountPacketData.fromPartial({}),
...
exports.MsgSendTx = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.packetData !== undefined) {
            packet_js_1.InterchainAccountPacketData.encode(message.packetData, writer.uint32(26).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.packetData = packet_js_1.InterchainAccountPacketData.decode(reader, reader.uint32());
                    break;
                case 4:
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.connectionId))
            obj.connectionId = String(object.connectionId);
        if ((0, helpers_js_1.isSet)(object.packetData))
            obj.packetData = packet_js_1.InterchainAccountPacketData.fromJSON(object.packetData);
        if ((0, helpers_js_1.isSet)(object.relativeTimeout))
    ...
    toJSON(message) {
        ...
        message.packetData !== undefined &&
            (obj.packetData = message.packetData
                ? packet_js_1.InterchainAccountPacketData.toJSON(message.packetData)
                : undefined);
    ...
    fromPartial(object) {
        ...
        if (object.packetData !== undefined && object.packetData !== null) {
            message.packetData = packet_js_1.InterchainAccountPacketData.fromPartial(object.packetData);
        }
...
function createBaseMsgUpdateParams() {
    return {
        signer: "",
        params: controller_js_1.Params.fromPartial({}),
    };
}
exports.MsgUpdateParams = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.params !== undefined) {
            controller_js_1.Params.encode(message.params, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {

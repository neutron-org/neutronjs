...
const client_js_1 = require("../../../core/client/v1/client.js");
const proofs_js_1 = require("../../../../cosmos/ics23/v1/proofs.js");
const timestamp_js_1 = require("../../../../google/protobuf/timestamp.js");
const commitment_js_1 = require("../../../core/commitment/v1/commitment.js");
const types_js_1 = require("../../../../tendermint/types/types.js");
const validator_js_1 = require("../../../../tendermint/types/validator.js");
...
function createBaseClientState() {
    return {
        ...
        trustingPeriod: duration_js_1.Duration.fromPartial({}),
        unbondingPeriod: duration_js_1.Duration.fromPartial({}),
        maxClockDrift: duration_js_1.Duration.fromPartial({}),
        frozenHeight: client_js_1.Height.fromPartial({}),
        latestHeight: client_js_1.Height.fromPartial({}),
        proofSpecs: [],
        upgradePath: [],
...
exports.ClientState = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.trustLevel))
            obj.trustLevel = exports.Fraction.fromJSON(object.trustLevel);
        if ((0, helpers_js_1.isSet)(object.trustingPeriod))
            obj.trustingPeriod = duration_js_1.Duration.fromJSON(object.trustingPeriod);
        if ((0, helpers_js_1.isSet)(object.unbondingPeriod))
            obj.unbondingPeriod = duration_js_1.Duration.fromJSON(object.unbondingPeriod);
        if ((0, helpers_js_1.isSet)(object.maxClockDrift))
            obj.maxClockDrift = duration_js_1.Duration.fromJSON(object.maxClockDrift);
        if ((0, helpers_js_1.isSet)(object.frozenHeight))
            obj.frozenHeight = client_js_1.Height.fromJSON(object.frozenHeight);
        if ((0, helpers_js_1.isSet)(object.latestHeight))
            obj.latestHeight = client_js_1.Height.fromJSON(object.latestHeight);
        if (Array.isArray(object?.proofSpecs))
            obj.proofSpecs = object.proofSpecs.map((e) => proofs_js_1.ProofSpec.fromJSON(e));
        if (Array.isArray(object?.upgradePath))
            obj.upgradePath = object.upgradePath.map((e) => String(e));
        if ((0, helpers_js_1.isSet)(object.allowUpdateAfterExpiry))
            obj.allowUpdateAfterExpiry = Boolean(object.allowUpdateAfterExpiry);
        if ((0, helpers_js_1.isSet)(object.allowUpdateAfterMisbehaviour))
    ...
    toJSON(message) {
        ...
        message.trustingPeriod !== undefined &&
            (obj.trustingPeriod = message.trustingPeriod ? duration_js_1.Duration.toJSON(message.trustingPeriod) : undefined);
        message.unbondingPeriod !== undefined &&
            (obj.unbondingPeriod = message.unbondingPeriod ? duration_js_1.Duration.toJSON(message.unbondingPeriod) : undefined);
        message.maxClockDrift !== undefined &&
            (obj.maxClockDrift = message.maxClockDrift ? duration_js_1.Duration.toJSON(message.maxClockDrift) : undefined);
        message.frozenHeight !== undefined &&
            (obj.frozenHeight = message.frozenHeight ? client_js_1.Height.toJSON(message.frozenHeight) : undefined);
        message.latestHeight !== undefined &&
            (obj.latestHeight = message.latestHeight ? client_js_1.Height.toJSON(message.latestHeight) : undefined);
        if (message.proofSpecs) {
            obj.proofSpecs = message.proofSpecs.map((e) => (e ? proofs_js_1.ProofSpec.toJSON(e) : undefined));
        }
        else {
            obj.proofSpecs = [];
        }
    ...
    fromPartial(object) {
        ...
        if (object.trustingPeriod !== undefined && object.trustingPeriod !== null) {
            message.trustingPeriod = duration_js_1.Duration.fromPartial(object.trustingPeriod);
        }
        if (object.unbondingPeriod !== undefined && object.unbondingPeriod !== null) {
            message.unbondingPeriod = duration_js_1.Duration.fromPartial(object.unbondingPeriod);
        }
        if (object.maxClockDrift !== undefined && object.maxClockDrift !== null) {
            message.maxClockDrift = duration_js_1.Duration.fromPartial(object.maxClockDrift);
        }
        if (object.frozenHeight !== undefined && object.frozenHeight !== null) {
            message.frozenHeight = client_js_1.Height.fromPartial(object.frozenHeight);
        }
        if (object.latestHeight !== undefined && object.latestHeight !== null) {
            message.latestHeight = client_js_1.Height.fromPartial(object.latestHeight);
        }
        message.proofSpecs = object.proofSpecs?.map((e) => proofs_js_1.ProofSpec.fromPartial(e)) || [];
...
function createBaseConsensusState() {
    return {
        ...
        root: commitment_js_1.MerkleRoot.fromPartial({}),
...
exports.ConsensusState = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        if (message.timestamp !== undefined) {
            timestamp_js_1.Timestamp.encode(message.timestamp, writer.uint32(10).fork()).ldelim();
        }
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.root))
            obj.root = commitment_js_1.MerkleRoot.fromJSON(object.root);
    ...
    toJSON(message) {
        ...
        message.root !== undefined && (obj.root = message.root ? commitment_js_1.MerkleRoot.toJSON(message.root) : undefined);
    ...
    fromPartial(object) {
        ...
        if (object.root !== undefined && object.root !== null) {
            message.root = commitment_js_1.MerkleRoot.fromPartial(object.root);
        }
...
exports.Misbehaviour = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.header1))
            obj.header1 = exports.Header.fromJSON(object.header1);
        if ((0, helpers_js_1.isSet)(object.header2))
...
function createBaseHeader() {
    return {
        ...
        trustedHeight: client_js_1.Height.fromPartial({}),
...
exports.Header = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.signedHeader))
            obj.signedHeader = types_js_1.SignedHeader.fromJSON(object.signedHeader);
        if ((0, helpers_js_1.isSet)(object.validatorSet))
            obj.validatorSet = validator_js_1.ValidatorSet.fromJSON(object.validatorSet);
        if ((0, helpers_js_1.isSet)(object.trustedHeight))
            obj.trustedHeight = client_js_1.Height.fromJSON(object.trustedHeight);
        if ((0, helpers_js_1.isSet)(object.trustedValidators))
            obj.trustedValidators = validator_js_1.ValidatorSet.fromJSON(object.trustedValidators);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.signedHeader !== undefined &&
            (obj.signedHeader = message.signedHeader ? types_js_1.SignedHeader.toJSON(message.signedHeader) : undefined);
        ...
        message.trustedHeight !== undefined &&
            (obj.trustedHeight = message.trustedHeight ? client_js_1.Height.toJSON(message.trustedHeight) : undefined);
    ...
    fromPartial(object) {
        ...
        if (object.signedHeader !== undefined && object.signedHeader !== null) {
            message.signedHeader = types_js_1.SignedHeader.fromPartial(object.signedHeader);
        }
        ...
        if (object.trustedHeight !== undefined && object.trustedHeight !== null) {
            message.trustedHeight = client_js_1.Height.fromPartial(object.trustedHeight);
        }
        if (object.trustedValidators !== undefined && object.trustedValidators !== null) {
            message.trustedValidators = validator_js_1.ValidatorSet.fromPartial(object.trustedValidators);
        }
        return message;
    },
};
...
exports.Fraction = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.numerator))
            obj.numerator = BigInt(object.numerator.toString());
        if ((0, helpers_js_1.isSet)(object.denominator))

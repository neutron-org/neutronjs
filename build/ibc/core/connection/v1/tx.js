...
function createBaseMsgConnectionOpenInit() {
    return {
        clientId: "",
        counterparty: connection_js_1.Counterparty.fromPartial({}),
        version: undefined,
...
exports.MsgConnectionOpenInit = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.counterparty))
            obj.counterparty = connection_js_1.Counterparty.fromJSON(object.counterparty);
        if ((0, helpers_js_1.isSet)(object.version))
            obj.version = connection_js_1.Version.fromJSON(object.version);
        if ((0, helpers_js_1.isSet)(object.delayPeriod))
    ...
    toJSON(message) {
        ...
        message.counterparty !== undefined &&
            (obj.counterparty = message.counterparty ? connection_js_1.Counterparty.toJSON(message.counterparty) : undefined);
        message.version !== undefined &&
            (obj.version = message.version ? connection_js_1.Version.toJSON(message.version) : undefined);
    ...
    fromPartial(object) {
        ...
        if (object.counterparty !== undefined && object.counterparty !== null) {
            message.counterparty = connection_js_1.Counterparty.fromPartial(object.counterparty);
        }
        if (object.version !== undefined && object.version !== null) {
            message.version = connection_js_1.Version.fromPartial(object.version);
        }
...
function createBaseMsgConnectionOpenTry() {
    return {
        ...
        consensusHeight: client_js_1.Height.fromPartial({}),
        signer: "",
...
exports.MsgConnectionOpenTry = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.clientId))
            obj.clientId = String(object.clientId);
        if ((0, helpers_js_1.isSet)(object.previousConnectionId))
        ...
        if (Array.isArray(object?.counterpartyVersions))
            obj.counterpartyVersions = object.counterpartyVersions.map((e) => connection_js_1.Version.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.proofHeight))
            obj.proofHeight = client_js_1.Height.fromJSON(object.proofHeight);
        if ((0, helpers_js_1.isSet)(object.proofInit))
            obj.proofInit = (0, helpers_js_1.bytesFromBase64)(object.proofInit);
        if ((0, helpers_js_1.isSet)(object.proofClient))
            obj.proofClient = (0, helpers_js_1.bytesFromBase64)(object.proofClient);
        if ((0, helpers_js_1.isSet)(object.proofConsensus))
            obj.proofConsensus = (0, helpers_js_1.bytesFromBase64)(object.proofConsensus);
        if ((0, helpers_js_1.isSet)(object.consensusHeight))
            obj.consensusHeight = client_js_1.Height.fromJSON(object.consensusHeight);
        if ((0, helpers_js_1.isSet)(object.signer))
            obj.signer = String(object.signer);
        if ((0, helpers_js_1.isSet)(object.hostConsensusStateProof))
            obj.hostConsensusStateProof = (0, helpers_js_1.bytesFromBase64)(object.hostConsensusStateProof);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.counterpartyVersions) {
            obj.counterpartyVersions = message.counterpartyVersions.map((e) => (e ? connection_js_1.Version.toJSON(e) : undefined));
        }
        else {
        ...
        message.proofInit !== undefined &&
            (obj.proofInit = (0, helpers_js_1.base64FromBytes)(message.proofInit !== undefined ? message.proofInit : new Uint8Array()));
        message.proofClient !== undefined &&
            (obj.proofClient = (0, helpers_js_1.base64FromBytes)(message.proofClient !== undefined ? message.proofClient : new Uint8Array()));
        message.proofConsensus !== undefined &&
            (obj.proofConsensus = (0, helpers_js_1.base64FromBytes)(message.proofConsensus !== undefined ? message.proofConsensus : new Uint8Array()));
        message.consensusHeight !== undefined &&
            (obj.consensusHeight = message.consensusHeight ? client_js_1.Height.toJSON(message.consensusHeight) : undefined);
        message.signer !== undefined && (obj.signer = message.signer);
        message.hostConsensusStateProof !== undefined &&
            (obj.hostConsensusStateProof = (0, helpers_js_1.base64FromBytes)(message.hostConsensusStateProof !== undefined ? message.hostConsensusStateProof : new Uint8Array()));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseMsgConnectionOpenTry();
        ...
        message.counterpartyVersions = object.counterpartyVersions?.map((e) => connection_js_1.Version.fromPartial(e)) || [];
        ...
        if (object.consensusHeight !== undefined && object.consensusHeight !== null) {
            message.consensusHeight = client_js_1.Height.fromPartial(object.consensusHeight);
        }
        message.signer = object.signer ?? "";
...
exports.MsgConnectionOpenAck = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.counterpartyConnectionId))
        ...
        if ((0, helpers_js_1.isSet)(object.proofHeight))
            obj.proofHeight = client_js_1.Height.fromJSON(object.proofHeight);
        if ((0, helpers_js_1.isSet)(object.proofTry))
            obj.proofTry = (0, helpers_js_1.bytesFromBase64)(object.proofTry);
        if ((0, helpers_js_1.isSet)(object.proofClient))
            obj.proofClient = (0, helpers_js_1.bytesFromBase64)(object.proofClient);
        if ((0, helpers_js_1.isSet)(object.proofConsensus))
            obj.proofConsensus = (0, helpers_js_1.bytesFromBase64)(object.proofConsensus);
    ...
    toJSON(message) {
        ...
        message.proofTry !== undefined &&
            (obj.proofTry = (0, helpers_js_1.base64FromBytes)(message.proofTry !== undefined ? message.proofTry : new Uint8Array()));
        message.proofClient !== undefined &&
            (obj.proofClient = (0, helpers_js_1.base64FromBytes)(message.proofClient !== undefined ? message.proofClient : new Uint8Array()));
        message.proofConsensus !== undefined &&
            (obj.proofConsensus = (0, helpers_js_1.base64FromBytes)(message.proofConsensus !== undefined ? message.proofConsensus : new Uint8Array()));
...
exports.MsgConnectionOpenConfirm = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.connectionId))
            obj.connectionId = String(object.connectionId);
        if ((0, helpers_js_1.isSet)(object.proofAck))
            obj.proofAck = (0, helpers_js_1.bytesFromBase64)(object.proofAck);
        if ((0, helpers_js_1.isSet)(object.proofHeight))
            obj.proofHeight = client_js_1.Height.fromJSON(object.proofHeight);
        if ((0, helpers_js_1.isSet)(object.signer))
            obj.signer = String(object.signer);
    ...
    toJSON(message) {
        ...
        message.proofAck !== undefined &&
            (obj.proofAck = (0, helpers_js_1.base64FromBytes)(message.proofAck !== undefined ? message.proofAck : new Uint8Array()));
        message.proofHeight !== undefined &&
            (obj.proofHeight = message.proofHeight ? client_js_1.Height.toJSON(message.proofHeight) : undefined);
        message.signer !== undefined && (obj.signer = message.signer);
        return obj;

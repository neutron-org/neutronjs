...
function createBaseGenesisState() {
    return {
        ...
        params: connection_js_1.Params.fromPartial({}),
    };
}
exports.GenesisState = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.connections))
            obj.connections = object.connections.map((e) => connection_js_1.IdentifiedConnection.fromJSON(e));
        if (Array.isArray(object?.clientConnectionPaths))
            obj.clientConnectionPaths = object.clientConnectionPaths.map((e) => connection_js_1.ConnectionPaths.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.nextConnectionSequence))
            obj.nextConnectionSequence = BigInt(object.nextConnectionSequence.toString());
        if ((0, helpers_js_1.isSet)(object.params))
            obj.params = connection_js_1.Params.fromJSON(object.params);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        if (message.connections) {
            obj.connections = message.connections.map((e) => (e ? connection_js_1.IdentifiedConnection.toJSON(e) : undefined));
        }
        else {
            obj.connections = [];
        }
        if (message.clientConnectionPaths) {
            obj.clientConnectionPaths = message.clientConnectionPaths.map((e) => e ? connection_js_1.ConnectionPaths.toJSON(e) : undefined);
        }
        else {
        ...
        message.params !== undefined && (obj.params = message.params ? connection_js_1.Params.toJSON(message.params) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseGenesisState();
        message.connections = object.connections?.map((e) => connection_js_1.IdentifiedConnection.fromPartial(e)) || [];
        message.clientConnectionPaths =
            object.clientConnectionPaths?.map((e) => connection_js_1.ConnectionPaths.fromPartial(e)) || [];
        ...
        if (object.params !== undefined && object.params !== null) {
            message.params = connection_js_1.Params.fromPartial(object.params);
        }
        return message;
    },
};

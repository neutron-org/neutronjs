...
//@ts-nocheck
/* eslint-disable */
const commitment_js_1 = require("../../commitment/v1/commitment.js");
...
function createBaseCounterparty() {
    return {
        clientId: "",
        connectionId: "",
        prefix: commitment_js_1.MerklePrefix.fromPartial({}),
    };
}
exports.Counterparty = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.prefix))
            obj.prefix = commitment_js_1.MerklePrefix.fromJSON(object.prefix);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.prefix !== undefined &&
            (obj.prefix = message.prefix ? commitment_js_1.MerklePrefix.toJSON(message.prefix) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseCounterparty();
        ...
        if (object.prefix !== undefined && object.prefix !== null) {
            message.prefix = commitment_js_1.MerklePrefix.fromPartial(object.prefix);
        }
        return message;
    },
};
...
exports.Params = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.maxExpectedTimePerBlock))

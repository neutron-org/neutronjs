...
const commitment_js_1 = require("../../commitment/v2/commitment.js");
...
exports.QueryClientStatesResponse = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.clientStates))
            obj.clientStates = object.clientStates.map((e) => client_js_1.IdentifiedClientState.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.pagination))
    ...
    toJSON(message) {
        ...
        if (message.clientStates) {
            obj.clientStates = message.clientStates.map((e) => (e ? client_js_1.IdentifiedClientState.toJSON(e) : undefined));
        }
        else {
            obj.clientStates = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseQueryClientStatesResponse();
        message.clientStates = object.clientStates?.map((e) => client_js_1.IdentifiedClientState.fromPartial(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
...
exports.QueryConsensusStatesResponse = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.consensusStates))
            obj.consensusStates = object.consensusStates.map((e) => client_js_1.ConsensusStateWithHeight.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.pagination))
            obj.pagination = pagination_js_1.PageResponse.fromJSON(object.pagination);
        return obj;
    },
    toJSON(message) {
        ...
        if (message.consensusStates) {
            obj.consensusStates = message.consensusStates.map((e) => e ? client_js_1.ConsensusStateWithHeight.toJSON(e) : undefined);
        }
        else {
            obj.consensusStates = [];
        }
    ...
    fromPartial(object) {
        ...
        message.consensusStates =
            object.consensusStates?.map((e) => client_js_1.ConsensusStateWithHeight.fromPartial(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_js_1.PageResponse.fromPartial(object.pagination);
        }
        return message;
...
exports.QueryConsensusStateHeightsResponse = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        for (const v of message.consensusStateHeights) {
            client_js_1.Height.encode(v, writer.uint32(10).fork()).ldelim();
        }
        if (message.pagination !== undefined) {
            pagination_js_1.PageResponse.encode(message.pagination, writer.uint32(18).fork()).ldelim();
        }
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.consensusStateHeights.push(client_js_1.Height.decode(reader, reader.uint32()));
                    break;
                case 2:
                    message.pagination = pagination_js_1.PageResponse.decode(reader, reader.uint32());
                    break;
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.consensusStateHeights))
            obj.consensusStateHeights = object.consensusStateHeights.map((e) => client_js_1.Height.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.pagination))
            obj.pagination = pagination_js_1.PageResponse.fromJSON(object.pagination);
        return obj;
    },
    toJSON(message) {
        ...
        if (message.consensusStateHeights) {
            obj.consensusStateHeights = message.consensusStateHeights.map((e) => e ? client_js_1.Height.toJSON(e) : undefined);
        }
        else {
    ...
    fromPartial(object) {
        const message = createBaseQueryConsensusStateHeightsResponse();
        message.consensusStateHeights = object.consensusStateHeights?.map((e) => client_js_1.Height.fromPartial(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_js_1.PageResponse.fromPartial(object.pagination);
        }
        return message;
...
exports.QueryUpgradedConsensusStateResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.upgradedConsensusState))
            obj.upgradedConsensusState = any_js_1.Any.fromJSON(object.upgradedConsensusState);
        return obj;
    },
    toJSON(message) {
        const obj = {};
    ...
    fromPartial(object) {
        ...
        if (object.upgradedConsensusState !== undefined && object.upgradedConsensusState !== null) {
            message.upgradedConsensusState = any_js_1.Any.fromPartial(object.upgradedConsensusState);
        }
        return message;
    },
};
function createBaseQueryVerifyMembershipRequest() {
    return {
        ...
        timeDelay: BigInt(0),
        blockDelay: BigInt(0),
        merklePath: commitment_js_1.MerklePath.fromPartial({}),
    };
}
exports.QueryVerifyMembershipRequest = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.merklePath !== undefined) {
            commitment_js_1.MerklePath.encode(message.merklePath, writer.uint32(66).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    message.merklePath = commitment_js_1.MerklePath.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.timeDelay))
            obj.timeDelay = BigInt(object.timeDelay.toString());
        if ((0, helpers_js_1.isSet)(object.blockDelay))
            obj.blockDelay = BigInt(object.blockDelay.toString());
        if ((0, helpers_js_1.isSet)(object.merklePath))
            obj.merklePath = commitment_js_1.MerklePath.fromJSON(object.merklePath);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.merklePath !== undefined &&
            (obj.merklePath = message.merklePath ? commitment_js_1.MerklePath.toJSON(message.merklePath) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseQueryVerifyMembershipRequest();
        ...
        if (object.merklePath !== undefined && object.merklePath !== null) {
            message.merklePath = commitment_js_1.MerklePath.fromPartial(object.merklePath);
        }
        return message;
    },
};
...
exports.QueryVerifyMembershipResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.success))

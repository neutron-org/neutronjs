...
exports.GenesisState = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.clients))
            obj.clients = object.clients.map((e) => client_js_1.IdentifiedClientState.fromJSON(e));
        if (Array.isArray(object?.clientsConsensus))
            obj.clientsConsensus = object.clientsConsensus.map((e) => client_js_1.ClientConsensusStates.fromJSON(e));
        ...
        if ((0, helpers_js_1.isSet)(object.createLocalhost))
            obj.createLocalhost = Boolean(object.createLocalhost);
        if ((0, helpers_js_1.isSet)(object.nextClientSequence))
    ...
    toJSON(message) {
        const obj = {};
        if (message.clients) {
            obj.clients = message.clients.map((e) => (e ? client_js_1.IdentifiedClientState.toJSON(e) : undefined));
        }
        else {
            obj.clients = [];
        }
        if (message.clientsConsensus) {
            obj.clientsConsensus = message.clientsConsensus.map((e) => e ? client_js_1.ClientConsensusStates.toJSON(e) : undefined);
        }
        else {
    ...
    fromPartial(object) {
        const message = createBaseGenesisState();
        message.clients = object.clients?.map((e) => client_js_1.IdentifiedClientState.fromPartial(e)) || [];
        message.clientsConsensus =
            object.clientsConsensus?.map((e) => client_js_1.ClientConsensusStates.fromPartial(e)) || [];

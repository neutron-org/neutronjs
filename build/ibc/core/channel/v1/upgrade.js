...
function createBaseUpgrade() {
    return {
        ...
        timeout: channel_js_1.Timeout.fromPartial({}),
...
exports.Upgrade = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.timeout !== undefined) {
            channel_js_1.Timeout.encode(message.timeout, writer.uint32(18).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.timeout = channel_js_1.Timeout.decode(reader, reader.uint32());
                    break;
                case 3:
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.fields))
            obj.fields = exports.UpgradeFields.fromJSON(object.fields);
        if ((0, helpers_js_1.isSet)(object.timeout))
            obj.timeout = channel_js_1.Timeout.fromJSON(object.timeout);
    ...
    toJSON(message) {
        ...
        message.timeout !== undefined &&
            (obj.timeout = message.timeout ? channel_js_1.Timeout.toJSON(message.timeout) : undefined);
    ...
    fromPartial(object) {
        ...
        if (object.timeout !== undefined && object.timeout !== null) {
            message.timeout = channel_js_1.Timeout.fromPartial(object.timeout);
        }

...
class QueryClientImpl {
    ...
    channel(request) {
        const data = query_js_1.QueryChannelRequest.encode(request).finish();
        const promise = this.rpc.request("ibc.core.channel.v1.Query", "Channel", data);
        return promise.then((data) => query_js_1.QueryChannelResponse.decode(new binary_js_1.BinaryReader(data)));
    }
    channels(request = {
        pagination: pagination_js_1.PageRequest.fromPartial({}),
    }) {
        const data = query_js_1.QueryChannelsRequest.encode(request).finish();
        const promise = this.rpc.request("ibc.core.channel.v1.Query", "Channels", data);
        return promise.then((data) => query_js_1.QueryChannelsResponse.decode(new binary_js_1.BinaryReader(data)));
    }
    connectionChannels(request) {
        const data = query_js_1.QueryConnectionChannelsRequest.encode(request).finish();
        const promise = this.rpc.request("ibc.core.channel.v1.Query", "ConnectionChannels", data);
        return promise.then((data) => query_js_1.QueryConnectionChannelsResponse.decode(new binary_js_1.BinaryReader(data)));
    }
    channelClientState(request) {
        const data = query_js_1.QueryChannelClientStateRequest.encode(request).finish();
        const promise = this.rpc.request("ibc.core.channel.v1.Query", "ChannelClientState", data);
        return promise.then((data) => query_js_1.QueryChannelClientStateResponse.decode(new binary_js_1.BinaryReader(data)));
    }
    channelConsensusState(request) {
        const data = query_js_1.QueryChannelConsensusStateRequest.encode(request).finish();
        const promise = this.rpc.request("ibc.core.channel.v1.Query", "ChannelConsensusState", data);
        return promise.then((data) => query_js_1.QueryChannelConsensusStateResponse.decode(new binary_js_1.BinaryReader(data)));
    }
    ...
    nextSequenceReceive(request) {
        const data = query_js_1.QueryNextSequenceReceiveRequest.encode(request).finish();
        const promise = this.rpc.request("ibc.core.channel.v1.Query", "NextSequenceReceive", data);
        return promise.then((data) => query_js_1.QueryNextSequenceReceiveResponse.decode(new binary_js_1.BinaryReader(data)));
    }

...
exports.Packet = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.destinationChannel))
...
exports.Acknowledgement = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.result))
            obj.result = (0, helpers_js_1.bytesFromBase64)(object.result);
    ...
    toJSON(message) {
        ...
        message.result !== undefined &&
            (obj.result = message.result !== undefined ? (0, helpers_js_1.base64FromBytes)(message.result) : undefined);
...
exports.Timeout = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        if (message.height !== undefined) {
            client_js_1.Height.encode(message.height, writer.uint32(10).fork()).ldelim();
        }

...
function createBaseMsgChannelOpenInit() {
    return {
        portId: "",
        channel: channel_js_1.Channel.fromPartial({}),
        signer: "",
    };
}
...
exports.MsgChannelOpenTry = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.portId))
            obj.portId = String(object.portId);
        if ((0, helpers_js_1.isSet)(object.previousChannelId))
            obj.previousChannelId = String(object.previousChannelId);
        if ((0, helpers_js_1.isSet)(object.channel))
            obj.channel = channel_js_1.Channel.fromJSON(object.channel);
        if ((0, helpers_js_1.isSet)(object.counterpartyVersion))
...
exports.MsgChannelOpenAck = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.channelId))
            obj.channelId = String(object.channelId);
        if ((0, helpers_js_1.isSet)(object.counterpartyChannelId))
...
function createBaseMsgRecvPacket() {
    return {
        packet: channel_js_1.Packet.fromPartial({}),
...
exports.MsgRecvPacket = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.packet))
            obj.packet = channel_js_1.Packet.fromJSON(object.packet);
    ...
    toJSON(message) {
        const obj = {};
        message.packet !== undefined && (obj.packet = message.packet ? channel_js_1.Packet.toJSON(message.packet) : undefined);
    ...
    fromPartial(object) {
        ...
        if (object.packet !== undefined && object.packet !== null) {
            message.packet = channel_js_1.Packet.fromPartial(object.packet);
        }
...
exports.MsgTimeout = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.proofHeight))
            obj.proofHeight = client_js_1.Height.fromJSON(object.proofHeight);
        if ((0, helpers_js_1.isSet)(object.nextSequenceRecv))
...
exports.MsgTimeoutOnClose = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.proofUnreceived))
            obj.proofUnreceived = (0, helpers_js_1.bytesFromBase64)(object.proofUnreceived);
        if ((0, helpers_js_1.isSet)(object.proofClose))
            obj.proofClose = (0, helpers_js_1.bytesFromBase64)(object.proofClose);
        if ((0, helpers_js_1.isSet)(object.proofHeight))
            obj.proofHeight = client_js_1.Height.fromJSON(object.proofHeight);
        if ((0, helpers_js_1.isSet)(object.nextSequenceRecv))
            obj.nextSequenceRecv = BigInt(object.nextSequenceRecv.toString());
    ...
    toJSON(message) {
        ...
        message.proofClose !== undefined &&
            (obj.proofClose = (0, helpers_js_1.base64FromBytes)(message.proofClose !== undefined ? message.proofClose : new Uint8Array()));
        message.proofHeight !== undefined &&
            (obj.proofHeight = message.proofHeight ? client_js_1.Height.toJSON(message.proofHeight) : undefined);
        message.nextSequenceRecv !== undefined &&
            (obj.nextSequenceRecv = (message.nextSequenceRecv || BigInt(0)).toString());

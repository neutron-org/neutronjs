...
exports.QueryChannelsResponse = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.channels))
            obj.channels = object.channels.map((e) => channel_js_1.IdentifiedChannel.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.pagination))
    ...
    toJSON(message) {
        const obj = {};
        if (message.channels) {
            obj.channels = message.channels.map((e) => (e ? channel_js_1.IdentifiedChannel.toJSON(e) : undefined));
        }
        else {
            obj.channels = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseQueryChannelsResponse();
        message.channels = object.channels?.map((e) => channel_js_1.IdentifiedChannel.fromPartial(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
...
exports.QueryChannelClientStateResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.identifiedClientState))
            obj.identifiedClientState = client_js_1.IdentifiedClientState.fromJSON(object.identifiedClientState);
        if ((0, helpers_js_1.isSet)(object.proof))
            obj.proof = (0, helpers_js_1.bytesFromBase64)(object.proof);
        if ((0, helpers_js_1.isSet)(object.proofHeight))
            obj.proofHeight = client_js_1.Height.fromJSON(object.proofHeight);
    ...
    fromPartial(object) {
        ...
        if (object.identifiedClientState !== undefined && object.identifiedClientState !== null) {
            message.identifiedClientState = client_js_1.IdentifiedClientState.fromPartial(object.identifiedClientState);
        }
        message.proof = object.proof ?? new Uint8Array();
        if (object.proofHeight !== undefined && object.proofHeight !== null) {
            message.proofHeight = client_js_1.Height.fromPartial(object.proofHeight);
...
exports.QueryPacketCommitmentsResponse = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.commitments))
            obj.commitments = object.commitments.map((e) => channel_js_1.PacketState.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.pagination))
            obj.pagination = pagination_js_1.PageResponse.fromJSON(object.pagination);
        if ((0, helpers_js_1.isSet)(object.height))
            obj.height = client_js_1.Height.fromJSON(object.height);
    ...
    toJSON(message) {
        ...
        if (message.commitments) {
            obj.commitments = message.commitments.map((e) => (e ? channel_js_1.PacketState.toJSON(e) : undefined));
        }
        else {
            obj.commitments = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseQueryPacketCommitmentsResponse();
        message.commitments = object.commitments?.map((e) => channel_js_1.PacketState.fromPartial(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_js_1.PageResponse.fromPartial(object.pagination);
        }
        if (object.height !== undefined && object.height !== null) {
...
exports.QueryPacketAcknowledgementsResponse = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.acknowledgements))
            obj.acknowledgements = object.acknowledgements.map((e) => channel_js_1.PacketState.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.pagination))
            obj.pagination = pagination_js_1.PageResponse.fromJSON(object.pagination);
        if ((0, helpers_js_1.isSet)(object.height))
            obj.height = client_js_1.Height.fromJSON(object.height);
    ...
    toJSON(message) {
        ...
        if (message.acknowledgements) {
            obj.acknowledgements = message.acknowledgements.map((e) => (e ? channel_js_1.PacketState.toJSON(e) : undefined));
        }
        else {
    ...
    fromPartial(object) {
        const message = createBaseQueryPacketAcknowledgementsResponse();
        message.acknowledgements = object.acknowledgements?.map((e) => channel_js_1.PacketState.fromPartial(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_js_1.PageResponse.fromPartial(object.pagination);
        }
        if (object.height !== undefined && object.height !== null) {
...
exports.QueryNextSequenceReceiveResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.nextSequenceReceive))

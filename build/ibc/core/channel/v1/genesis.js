...
exports.GenesisState = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.receipts))
            obj.receipts = object.receipts.map((e) => channel_js_1.PacketState.fromJSON(e));
        ...
        if ((0, helpers_js_1.isSet)(object.nextChannelSequence))
    ...
    toJSON(message) {
        ...
        if (message.receipts) {
            obj.receipts = message.receipts.map((e) => (e ? channel_js_1.PacketState.toJSON(e) : undefined));
        }
        else {
            obj.receipts = [];
        }
    ...
    fromPartial(object) {
        ...
        message.receipts = object.receipts?.map((e) => channel_js_1.PacketState.fromPartial(e)) || [];

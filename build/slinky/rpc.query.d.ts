...
export declare const createRPCQueryClient: ({ rpcEndpoint }: {
    ...
    slinky: {
        marketmap: {
            v1: {
                marketMap(request?: import("./marketmap/v1/query.js").MarketMapRequest): Promise<import("./marketmap/v1/query.js").MarketMapResponse>;
                markets(request?: import("./marketmap/v1/query.js").MarketsRequest): Promise<import("./marketmap/v1/query.js").MarketsResponse>;
                market(request: import("./marketmap/v1/query.js").MarketRequest): Promise<import("./marketmap/v1/query.js").MarketResponse>;
                lastUpdated(request?: import("./marketmap/v1/query.js").LastUpdatedRequest): Promise<import("./marketmap/v1/query.js").LastUpdatedResponse>;
                params(request?: import("./marketmap/v1/query.js").ParamsRequest): Promise<import("./marketmap/v1/query.js").ParamsResponse>;
            };
        };
        oracle: {
            v1: {
                getAllCurrencyPairs(request?: import("./oracle/v1/query.js").GetAllCurrencyPairsRequest): Promise<import("./oracle/v1/query.js").GetAllCurrencyPairsResponse>;
                getPrice(request: import("./oracle/v1/query.js").GetPriceRequest): Promise<import("./oracle/v1/query.js").GetPriceResponse>;
                getPrices(request: import("./oracle/v1/query.js").GetPricesRequest): Promise<import("./oracle/v1/query.js").GetPricesResponse>;
                getCurrencyPairMapping(request?: import("./oracle/v1/query.js").GetCurrencyPairMappingRequest): Promise<import("./oracle/v1/query.js").GetCurrencyPairMappingResponse>;
                getCurrencyPairMappingList(request?: import("./oracle/v1/query.js").GetCurrencyPairMappingListRequest): Promise<import("./oracle/v1/query.js").GetCurrencyPairMappingListResponse>;
            };
        };
    };
}>;

...
export declare const createRPCQueryClient: ({ rpcEndpoint }: {
    ...
    sdk: {
        auction: {
            v1: {
                params(request?: import("./auction/v1/query.js").QueryParamsRequest): Promise<import("./auction/v1/query.js").QueryParamsResponse>;
            };
        };
        mempool: {
            v1: {
                getTxDistribution(request?: import("./mempool/v1/query.js").GetTxDistributionRequest): Promise<import("./mempool/v1/query.js").GetTxDistributionResponse>;
            };
        };
    };
}>;

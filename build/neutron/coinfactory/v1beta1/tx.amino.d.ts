...
export declare const AminoConverter: {
    ...
    "/neutron.coinfactory.v1beta1.MsgSetBeforeSendHook": {
        aminoType: string;
        toAmino: ({ sender, denom, contractAddr, }: MsgSetBeforeSendHook) => MsgSetBeforeSendHookAminoType["value"];
        fromAmino: ({ sender, denom, contract_addr, }: MsgSetBeforeSendHookAminoType["value"]) => MsgSetBeforeSendHook;
    };

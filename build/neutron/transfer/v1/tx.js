...
const transfer_js_1 = require("../../../ibc/applications/transfer/v1/transfer.js");
const binary_js_1 = require("../../../binary.js");
const helpers_js_1 = require("../../../helpers.js");
exports.protobufPackage = "neutron.transfer";
function createBaseMsgTransfer() {
    return {
        sourcePort: "",
        sourceChannel: "",
        token: coin_js_1.Coin.fromPartial({}),
        sender: "",
        receiver: "",
        timeoutHeight: client_js_1.Height.fromPartial({}),
...
exports.MsgTransfer = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.fee !== undefined) {
            fee_js_1.Fee.encode(message.fee, writer.uint32(74).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.sourceChannel))
            obj.sourceChannel = String(object.sourceChannel);
        if ((0, helpers_js_1.isSet)(object.token))
            obj.token = coin_js_1.Coin.fromJSON(object.token);
        ...
        if ((0, helpers_js_1.isSet)(object.timeoutHeight))
            obj.timeoutHeight = client_js_1.Height.fromJSON(object.timeoutHeight);
    ...
    toJSON(message) {
        ...
        message.token !== undefined && (obj.token = message.token ? coin_js_1.Coin.toJSON(message.token) : undefined);
        message.sender !== undefined && (obj.sender = message.sender);
        message.receiver !== undefined && (obj.receiver = message.receiver);
        message.timeoutHeight !== undefined &&
            (obj.timeoutHeight = message.timeoutHeight ? client_js_1.Height.toJSON(message.timeoutHeight) : undefined);
    ...
    fromPartial(object) {
        ...
        if (object.token !== undefined && object.token !== null) {
            message.token = coin_js_1.Coin.fromPartial(object.token);
        }
        message.sender = object.sender ?? "";
        message.receiver = object.receiver ?? "";
        if (object.timeoutHeight !== undefined && object.timeoutHeight !== null) {
            message.timeoutHeight = client_js_1.Height.fromPartial(object.timeoutHeight);
        }
...
exports.MsgUpdateParams = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.params !== undefined) {
            transfer_js_1.Params.encode(message.params, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {

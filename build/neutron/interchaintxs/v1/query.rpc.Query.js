...
class QueryClientImpl {
    ...
    interchainAccountAddress(request) {
        const data = query_js_1.QueryInterchainAccountAddressRequest.encode(request).finish();
        const promise = this.rpc.request("neutron.interchaintxs.v1.Query", "InterchainAccountAddress", data);
        return promise.then((data) => query_js_1.QueryInterchainAccountAddressResponse.decode(new binary_js_1.BinaryReader(data)));
    }
}

...
class QueryClientImpl {
    ...
    totalBurnedNeutronsAmount(request = {}) {
        const data = query_js_1.QueryTotalBurnedNeutronsAmountRequest.encode(request).finish();
        const promise = this.rpc.request("neutron.feeburner.Query", "TotalBurnedNeutronsAmount", data);
        return promise.then((data) => query_js_1.QueryTotalBurnedNeutronsAmountResponse.decode(new binary_js_1.BinaryReader(data)));
    }
}

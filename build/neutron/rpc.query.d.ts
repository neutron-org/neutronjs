...
export declare const createRPCQueryClient: ({ rpcEndpoint }: {
    ...
    neutron: {
        coinfactory: {
            v1beta1: {
                params(request?: import("./coinfactory/v1beta1/query.js").QueryParamsRequest): Promise<import("./coinfactory/v1beta1/query.js").QueryParamsResponse>;
                denomAuthorityMetadata(request: import("./coinfactory/v1beta1/query.js").QueryDenomAuthorityMetadataRequest): Promise<import("./coinfactory/v1beta1/query.js").QueryDenomAuthorityMetadataResponse>;
                denomsFromCreator(request: import("./coinfactory/v1beta1/query.js").QueryDenomsFromCreatorRequest): Promise<import("./coinfactory/v1beta1/query.js").QueryDenomsFromCreatorResponse>;
                beforeSendHookAddress(request: import("./coinfactory/v1beta1/query.js").QueryBeforeSendHookAddressRequest): Promise<import("./coinfactory/v1beta1/query.js").QueryBeforeSendHookAddressResponse>;
                fullDenom(request: import("./coinfactory/v1beta1/query.js").QueryFullDenomRequest): Promise<import("./coinfactory/v1beta1/query.js").QueryFullDenomResponse>;
            };
        };
        contractmanager: {
            params(request?: import("./contractmanager/query.js").QueryParamsRequest): Promise<import("./contractmanager/query.js").QueryParamsResponse>;
            addressFailure(request: import("./contractmanager/query.js").QueryFailureRequest): Promise<import("./contractmanager/query.js").QueryFailureResponse>;
            addressFailures(request: import("./contractmanager/query.js").QueryFailuresRequest): Promise<import("./contractmanager/query.js").QueryFailuresResponse>;
            failures(request: import("./contractmanager/query.js").QueryFailuresRequest): Promise<import("./contractmanager/query.js").QueryFailuresResponse>;
        };
        cron: {
            params(request?: import("./cron/query.js").QueryParamsRequest): Promise<import("./cron/query.js").QueryParamsResponse>;
            schedule(request: import("./cron/query.js").QueryGetScheduleRequest): Promise<import("./cron/query.js").QueryGetScheduleResponse>;
            schedules(request?: import("./cron/query.js").QuerySchedulesRequest): Promise<import("./cron/query.js").QuerySchedulesResponse>;
        };
        dex: {
            params(request?: import("./dex/query.js").QueryParamsRequest): Promise<import("./dex/query.js").QueryParamsResponse>;
            limitOrderTrancheUser(request: import("./dex/query.js").QueryGetLimitOrderTrancheUserRequest): Promise<import("./dex/query.js").QueryGetLimitOrderTrancheUserResponse>;
            limitOrderTrancheUserAll(request?: import("./dex/query.js").QueryAllLimitOrderTrancheUserRequest): Promise<import("./dex/query.js").QueryAllLimitOrderTrancheUserResponse>;
            limitOrderTrancheUserAllByAddress(request: import("./dex/query.js").QueryAllLimitOrderTrancheUserByAddressRequest): Promise<import("./dex/query.js").QueryAllLimitOrderTrancheUserByAddressResponse>;
            limitOrderTranche(request: import("./dex/query.js").QueryGetLimitOrderTrancheRequest): Promise<import("./dex/query.js").QueryGetLimitOrderTrancheResponse>;
            limitOrderTrancheAll(request: import("./dex/query.js").QueryAllLimitOrderTrancheRequest): Promise<import("./dex/query.js").QueryAllLimitOrderTrancheResponse>;
            userDepositsAll(request: import("./dex/query.js").QueryAllUserDepositsRequest): Promise<import("./dex/query.js").QueryAllUserDepositsResponse>;
            tickLiquidityAll(request: import("./dex/query.js").QueryAllTickLiquidityRequest): Promise<import("./dex/query.js").QueryAllTickLiquidityResponse>;
            inactiveLimitOrderTranche(request: import("./dex/query.js").QueryGetInactiveLimitOrderTrancheRequest): Promise<import("./dex/query.js").QueryGetInactiveLimitOrderTrancheResponse>;
            inactiveLimitOrderTrancheAll(request?: import("./dex/query.js").QueryAllInactiveLimitOrderTrancheRequest): Promise<import("./dex/query.js").QueryAllInactiveLimitOrderTrancheResponse>;
            poolReservesAll(request: import("./dex/query.js").QueryAllPoolReservesRequest): Promise<import("./dex/query.js").QueryAllPoolReservesResponse>;
            poolReserves(request: import("./dex/query.js").QueryGetPoolReservesRequest): Promise<import("./dex/query.js").QueryGetPoolReservesResponse>;
            estimateMultiHopSwap(request: import("./dex/query.js").QueryEstimateMultiHopSwapRequest): Promise<import("./dex/query.js").QueryEstimateMultiHopSwapResponse>;
            estimatePlaceLimitOrder(request: import("./dex/query.js").QueryEstimatePlaceLimitOrderRequest): Promise<import("./dex/query.js").QueryEstimatePlaceLimitOrderResponse>;
            pool(request: import("./dex/query.js").QueryPoolRequest): Promise<import("./dex/query.js").QueryPoolResponse>;
            poolByID(request: import("./dex/query.js").QueryPoolByIDRequest): Promise<import("./dex/query.js").QueryPoolResponse>;
            poolMetadata(request: import("./dex/query.js").QueryGetPoolMetadataRequest): Promise<import("./dex/query.js").QueryGetPoolMetadataResponse>;
            poolMetadataAll(request?: import("./dex/query.js").QueryAllPoolMetadataRequest): Promise<import("./dex/query.js").QueryAllPoolMetadataResponse>;
            simulateDeposit(request: import("./dex/query.js").QuerySimulateDepositRequest): Promise<import("./dex/query.js").QuerySimulateDepositResponse>;
            simulateWithdrawal(request: import("./dex/query.js").QuerySimulateWithdrawalRequest): Promise<import("./dex/query.js").QuerySimulateWithdrawalResponse>;
            simulateWithdrawalWithShares(request: import("./dex/query.js").QuerySimulateWithdrawalWithSharesRequest): Promise<import("./dex/query.js").QuerySimulateWithdrawalResponse>;
            simulatePlaceLimitOrder(request: import("./dex/query.js").QuerySimulatePlaceLimitOrderRequest): Promise<import("./dex/query.js").QuerySimulatePlaceLimitOrderResponse>;
            simulateWithdrawFilledLimitOrder(request: import("./dex/query.js").QuerySimulateWithdrawFilledLimitOrderRequest): Promise<import("./dex/query.js").QuerySimulateWithdrawFilledLimitOrderResponse>;
            simulateCancelLimitOrder(request: import("./dex/query.js").QuerySimulateCancelLimitOrderRequest): Promise<import("./dex/query.js").QuerySimulateCancelLimitOrderResponse>;
            simulateMultiHopSwap(request: import("./dex/query.js").QuerySimulateMultiHopSwapRequest): Promise<import("./dex/query.js").QuerySimulateMultiHopSwapResponse>;
        };
        dynamicfees: {
            v1: {
                params(request?: import("./dynamicfees/v1/query.js").QueryParamsRequest): Promise<import("./dynamicfees/v1/query.js").QueryParamsResponse>;
            };
        };
        feeburner: {
            params(request?: import("./feeburner/query.js").QueryParamsRequest): Promise<import("./feeburner/query.js").QueryParamsResponse>;
            totalBurnedNeutronsAmount(request?: import("./feeburner/query.js").QueryTotalBurnedNeutronsAmountRequest): Promise<import("./feeburner/query.js").QueryTotalBurnedNeutronsAmountResponse>;
        };
        feerefunder: {
            params(request?: import("./feerefunder/query.js").QueryParamsRequest): Promise<import("./feerefunder/query.js").QueryParamsResponse>;
            feeInfo(request: import("./feerefunder/query.js").FeeInfoRequest): Promise<import("./feerefunder/query.js").FeeInfoResponse>;
        };
        harpoon: {
            subscribedContracts(request: import("./harpoon/query.js").QuerySubscribedContractsRequest): Promise<import("./harpoon/query.js").QuerySubscribedContractsResponse>;
        };
        ibcratelimit: {
            v1beta1: {
                params(request?: import("./ibcratelimit/v1beta1/query.js").QueryParamsRequest): Promise<import("./ibcratelimit/v1beta1/query.js").QueryParamsResponse>;
            };
        };
        interchainqueries: {
            params(request?: import("./interchainqueries/query.js").QueryParamsRequest): Promise<import("./interchainqueries/query.js").QueryParamsResponse>;
            registeredQueries(request: import("./interchainqueries/query.js").QueryRegisteredQueriesRequest): Promise<import("./interchainqueries/query.js").QueryRegisteredQueriesResponse>;
            registeredQuery(request: import("./interchainqueries/query.js").QueryRegisteredQueryRequest): Promise<import("./interchainqueries/query.js").QueryRegisteredQueryResponse>;
            queryResult(request: import("./interchainqueries/query.js").QueryRegisteredQueryResultRequest): Promise<import("./interchainqueries/query.js").QueryRegisteredQueryResultResponse>;
            lastRemoteHeight(request: import("./interchainqueries/query.js").QueryLastRemoteHeight): Promise<import("./interchainqueries/query.js").QueryLastRemoteHeightResponse>;
        };
        interchaintxs: {
            v1: {
                params(request?: import("./interchaintxs/v1/query.js").QueryParamsRequest): Promise<import("./interchaintxs/v1/query.js").QueryParamsResponse>;
                interchainAccountAddress(request: import("./interchaintxs/v1/query.js").QueryInterchainAccountAddressRequest): Promise<import("./interchaintxs/v1/query.js").QueryInterchainAccountAddressResponse>;
            };
        };
        revenue: {
            params(request?: import("./revenue/query.js").QueryParamsRequest): Promise<import("./revenue/query.js").QueryParamsResponse>;
            paymentInfo(request?: import("./revenue/query.js").QueryPaymentInfoRequest): Promise<import("./revenue/query.js").QueryPaymentInfoResponse>;
            validatorStats(request: import("./revenue/query.js").QueryValidatorStatsRequest): Promise<import("./revenue/query.js").QueryValidatorStatsResponse>;
            validatorsStats(request?: import("./revenue/query.js").QueryValidatorsStatsRequest): Promise<import("./revenue/query.js").QueryValidatorsStatsResponse>;
        };
        state_verifier: {
            v1: {
                verifyStateValues(request: import("./state_verifier/v1/query.js").QueryVerifyStateValuesRequest): Promise<import("./state_verifier/v1/query.js").QueryVerifyStateValuesResponse>;
                queryConsensusState(request: import("./state_verifier/v1/query.js").QueryConsensusStateRequest): Promise<import("./state_verifier/v1/query.js").QueryConsensusStateResponse>;
            };
        };
    };
}>;

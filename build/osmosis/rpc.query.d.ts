...
export declare const createRPCQueryClient: ({ rpcEndpoint }: {
    ...
    osmosis: {
        tokenfactory: {
            v1beta1: {
                params(request?: import("./tokenfactory/v1beta1/query.js").QueryParamsRequest): Promise<import("./tokenfactory/v1beta1/query.js").QueryParamsResponse>;
                denomAuthorityMetadata(request: import("./tokenfactory/v1beta1/query.js").QueryDenomAuthorityMetadataRequest): Promise<import("./tokenfactory/v1beta1/query.js").QueryDenomAuthorityMetadataResponse>;
                denomsFromCreator(request: import("./tokenfactory/v1beta1/query.js").QueryDenomsFromCreatorRequest): Promise<import("./tokenfactory/v1beta1/query.js").QueryDenomsFromCreatorResponse>;
                beforeSendHookAddress(request: import("./tokenfactory/v1beta1/query.js").QueryBeforeSendHookAddressRequest): Promise<import("./tokenfactory/v1beta1/query.js").QueryBeforeSendHookAddressResponse>;
                fullDenom(request: import("./tokenfactory/v1beta1/query.js").QueryFullDenomRequest): Promise<import("./tokenfactory/v1beta1/query.js").QueryFullDenomResponse>;
            };
        };
    };
}>;

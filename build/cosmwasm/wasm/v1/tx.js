...
exports.MsgStoreCode = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.wasmByteCode))
            obj.wasmByteCode = (0, helpers_js_1.bytesFromBase64)(object.wasmByteCode);
        if ((0, helpers_js_1.isSet)(object.instantiatePermission))
            obj.instantiatePermission = types_js_1.AccessConfig.fromJSON(object.instantiatePermission);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.wasmByteCode !== undefined &&
            (obj.wasmByteCode = (0, helpers_js_1.base64FromBytes)(message.wasmByteCode !== undefined ? message.wasmByteCode : new Uint8Array()));
    ...
    fromPartial(object) {
        ...
        if (object.instantiatePermission !== undefined && object.instantiatePermission !== null) {
            message.instantiatePermission = types_js_1.AccessConfig.fromPartial(object.instantiatePermission);
        }
        return message;
    },
};
...
exports.MsgStoreCodeResponse = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.checksum))
            obj.checksum = (0, helpers_js_1.bytesFromBase64)(object.checksum);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.checksum !== undefined &&
            (obj.checksum = (0, helpers_js_1.base64FromBytes)(message.checksum !== undefined ? message.checksum : new Uint8Array()));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseMsgStoreCodeResponse();
...
exports.MsgInstantiateContract = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.msg))
            obj.msg = (0, helpers_js_1.bytesFromBase64)(object.msg);
        if (Array.isArray(object?.funds))
            obj.funds = object.funds.map((e) => coin_js_1.Coin.fromJSON(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.msg !== undefined &&
            (obj.msg = (0, helpers_js_1.base64FromBytes)(message.msg !== undefined ? message.msg : new Uint8Array()));
        if (message.funds) {
            obj.funds = message.funds.map((e) => (e ? coin_js_1.Coin.toJSON(e) : undefined));
        }
        else {
            obj.funds = [];
        }
    ...
    fromPartial(object) {
        ...
        message.funds = object.funds?.map((e) => coin_js_1.Coin.fromPartial(e)) || [];
        return message;
    },
};
...
exports.MsgInstantiateContract2 = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.funds))
            obj.funds = object.funds.map((e) => coin_js_1.Coin.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.salt))
            obj.salt = (0, helpers_js_1.bytesFromBase64)(object.salt);
        if ((0, helpers_js_1.isSet)(object.fixMsg))
    ...
    toJSON(message) {
        ...
        message.salt !== undefined &&
            (obj.salt = (0, helpers_js_1.base64FromBytes)(message.salt !== undefined ? message.salt : new Uint8Array()));
...
exports.MsgUpdateInstantiateConfig = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.newInstantiatePermission !== undefined) {
            types_js_1.AccessConfig.encode(message.newInstantiatePermission, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.newInstantiatePermission = types_js_1.AccessConfig.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.codeId))
            obj.codeId = BigInt(object.codeId.toString());
        if ((0, helpers_js_1.isSet)(object.newInstantiatePermission))
            obj.newInstantiatePermission = types_js_1.AccessConfig.fromJSON(object.newInstantiatePermission);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.newInstantiatePermission !== undefined &&
            (obj.newInstantiatePermission = message.newInstantiatePermission
                ? types_js_1.AccessConfig.toJSON(message.newInstantiatePermission)
                : undefined);
        return obj;
    },
    fromPartial(object) {
        ...
        if (object.newInstantiatePermission !== undefined && object.newInstantiatePermission !== null) {
            message.newInstantiatePermission = types_js_1.AccessConfig.fromPartial(object.newInstantiatePermission);
        }
        return message;
    },
};
...
exports.MsgStoreAndInstantiateContract = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.instantiatePermission !== undefined) {
            types_js_1.AccessConfig.encode(message.instantiatePermission, writer.uint32(34).fork()).ldelim();
        }
        ...
        for (const v of message.funds) {
            coin_js_1.Coin.encode(v, writer.uint32(74).fork()).ldelim();
        }
        if (message.source !== "") {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.instantiatePermission))
            obj.instantiatePermission = types_js_1.AccessConfig.fromJSON(object.instantiatePermission);
        if ((0, helpers_js_1.isSet)(object.unpinCode))
        ...
        if (Array.isArray(object?.funds))
            obj.funds = object.funds.map((e) => coin_js_1.Coin.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.source))
            obj.source = String(object.source);
        if ((0, helpers_js_1.isSet)(object.builder))
            obj.builder = String(object.builder);
        if ((0, helpers_js_1.isSet)(object.codeHash))
            obj.codeHash = (0, helpers_js_1.bytesFromBase64)(object.codeHash);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.codeHash !== undefined &&
            (obj.codeHash = (0, helpers_js_1.base64FromBytes)(message.codeHash !== undefined ? message.codeHash : new Uint8Array()));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseMsgStoreAndInstantiateContract();
...
exports.MsgStoreAndMigrateContract = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.instantiatePermission !== undefined) {
            types_js_1.AccessConfig.encode(message.instantiatePermission, writer.uint32(26).fork()).ldelim();
        }
        if (message.contract !== "") {
...
exports.MsgUpdateContractLabel = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.sender))
            obj.sender = String(object.sender);
        if ((0, helpers_js_1.isSet)(object.newLabel))

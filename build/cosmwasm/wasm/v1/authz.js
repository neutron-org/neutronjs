...
exports.ContractGrant = {
    ...
    encode(message, writer = binary_js_1.BinaryWriter.create()) {
        ...
        if (message.limit !== undefined) {
            any_js_1.Any.encode(message.limit, writer.uint32(18).fork()).ldelim();
        }
        if (message.filter !== undefined) {
            any_js_1.Any.encode(message.filter, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.limit = any_js_1.Any.decode(reader, reader.uint32());
                    break;
                case 3:
                    message.filter = any_js_1.Any.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.limit))
            obj.limit = any_js_1.Any.fromJSON(object.limit);
        if ((0, helpers_js_1.isSet)(object.filter))
            obj.filter = any_js_1.Any.fromJSON(object.filter);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        message.contract !== undefined && (obj.contract = message.contract);
        message.limit !== undefined && (obj.limit = message.limit ? any_js_1.Any.toJSON(message.limit) : undefined);
        message.filter !== undefined && (obj.filter = message.filter ? any_js_1.Any.toJSON(message.filter) : undefined);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseContractGrant();
        ...
        if (object.limit !== undefined && object.limit !== null) {
            message.limit = any_js_1.Any.fromPartial(object.limit);
        }
        if (object.filter !== undefined && object.filter !== null) {
            message.filter = any_js_1.Any.fromPartial(object.filter);
        }
        return message;
    },
};
...
exports.MaxCallsLimit = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.remaining))
...
exports.MaxFundsLimit = {
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.amounts.push(coin_js_1.Coin.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.amounts))
            obj.amounts = object.amounts.map((e) => coin_js_1.Coin.fromJSON(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
        if (message.amounts) {
            obj.amounts = message.amounts.map((e) => (e ? coin_js_1.Coin.toJSON(e) : undefined));
        }
        else {
            obj.amounts = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseMaxFundsLimit();
        message.amounts = object.amounts?.map((e) => coin_js_1.Coin.fromPartial(e)) || [];
        return message;
    },
};
...
exports.CombinedLimit = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.callsRemaining))
...
exports.AcceptedMessagesFilter = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.messages))
            obj.messages = object.messages.map((e) => (0, helpers_js_1.bytesFromBase64)(e));
        return obj;
    },
    toJSON(message) {
        const obj = {};
        if (message.messages) {
            obj.messages = message.messages.map((e) => (0, helpers_js_1.base64FromBytes)(e !== undefined ? e : new Uint8Array()));
        }
        else {
            obj.messages = [];
        }

...
exports.QueryContractHistoryResponse = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.entries))
            obj.entries = object.entries.map((e) => types_js_1.ContractCodeHistoryEntry.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.pagination))
    ...
    toJSON(message) {
        const obj = {};
        if (message.entries) {
            obj.entries = message.entries.map((e) => (e ? types_js_1.ContractCodeHistoryEntry.toJSON(e) : undefined));
        }
        else {
            obj.entries = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseQueryContractHistoryResponse();
        message.entries = object.entries?.map((e) => types_js_1.ContractCodeHistoryEntry.fromPartial(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
...
exports.QueryAllContractStateResponse = {
    ...
    fromJSON(object) {
        ...
        if (Array.isArray(object?.models))
            obj.models = object.models.map((e) => types_js_1.Model.fromJSON(e));
        if ((0, helpers_js_1.isSet)(object.pagination))
            obj.pagination = pagination_js_1.PageResponse.fromJSON(object.pagination);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        if (message.models) {
            obj.models = message.models.map((e) => (e ? types_js_1.Model.toJSON(e) : undefined));
        }
        else {
            obj.models = [];
        }
    ...
    fromPartial(object) {
        const message = createBaseQueryAllContractStateResponse();
        message.models = object.models?.map((e) => types_js_1.Model.fromPartial(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_js_1.PageResponse.fromPartial(object.pagination);
        }
        return message;
...
exports.QueryRawContractStateRequest = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.address))
            obj.address = String(object.address);
        if ((0, helpers_js_1.isSet)(object.queryData))
            obj.queryData = (0, helpers_js_1.bytesFromBase64)(object.queryData);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.queryData !== undefined &&
            (obj.queryData = (0, helpers_js_1.base64FromBytes)(message.queryData !== undefined ? message.queryData : new Uint8Array()));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseQueryRawContractStateRequest();
...
function createBaseQueryCodeInfoResponse() {
    return {
        ...
        instantiatePermission: types_js_1.AccessConfig.fromPartial({}),
    };
}
...
exports.QueryContractsByCreatorRequest = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.creatorAddress))
...
exports.QueryBuildAddressRequest = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.initArgs))
            obj.initArgs = (0, helpers_js_1.bytesFromBase64)(object.initArgs);
        return obj;
    },
    toJSON(message) {
        const obj = {};
        ...
        message.initArgs !== undefined &&
            (obj.initArgs = (0, helpers_js_1.base64FromBytes)(message.initArgs !== undefined ? message.initArgs : new Uint8Array()));
        return obj;
    },
    fromPartial(object) {
        const message = createBaseQueryBuildAddressRequest();

...
export declare const AminoConverter: {
    ...
    "/cosmwasm.wasm.v1.MsgStoreAndMigrateContract": {
        aminoType: string;
        toAmino: ({ authority, wasmByteCode, instantiatePermission, contract, msg, }: MsgStoreAndMigrateContract) => MsgStoreAndMigrateContractAminoType["value"];
    ...
    "/cosmwasm.wasm.v1.MsgUpdateContractLabel": {
        aminoType: string;
        toAmino: ({ sender, newLabel, contract, }: MsgUpdateContractLabel) => MsgUpdateContractLabelAminoType["value"];

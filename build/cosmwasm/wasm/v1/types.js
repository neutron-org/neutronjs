...
exports.AccessConfig = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.permission))
...
exports.Params = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.codeUploadAccess))
            obj.codeUploadAccess = exports.AccessConfig.fromJSON(object.codeUploadAccess);
        if ((0, helpers_js_1.isSet)(object.instantiateDefaultPermission))
...
exports.CodeInfo = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.instantiateConfig))
...
exports.ContractInfo = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.created))
            obj.created = exports.AbsoluteTxPosition.fromJSON(object.created);
        if ((0, helpers_js_1.isSet)(object.ibcPortId))
            obj.ibcPortId = String(object.ibcPortId);
        if ((0, helpers_js_1.isSet)(object.extension))
            obj.extension = any_js_1.Any.fromJSON(object.extension);
        if ((0, helpers_js_1.isSet)(object.ibc2PortId))
    ...
    toJSON(message) {
        ...
        message.extension !== undefined &&
            (obj.extension = message.extension ? any_js_1.Any.toJSON(message.extension) : undefined);
    ...
    fromPartial(object) {
        ...
        if (object.extension !== undefined && object.extension !== null) {
            message.extension = any_js_1.Any.fromPartial(object.extension);
        }
...
exports.ContractCodeHistoryEntry = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.operation))
            obj.operation = contractCodeHistoryOperationTypeFromJSON(object.operation);
        if ((0, helpers_js_1.isSet)(object.codeId))
            obj.codeId = BigInt(object.codeId.toString());
        if ((0, helpers_js_1.isSet)(object.updated))
...
exports.AbsoluteTxPosition = {
    ...
    fromJSON(object) {
        ...
        if ((0, helpers_js_1.isSet)(object.txIndex))
